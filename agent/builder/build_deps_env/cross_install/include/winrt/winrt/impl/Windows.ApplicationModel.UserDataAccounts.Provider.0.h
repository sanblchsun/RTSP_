...
{
    enum class UserDataAccountProviderOperationKind : std::int32_t
    {
        AddAccount = 0,
        Settings = 1,
        ResolveErrors = 2,
    };
    enum class UserDataAccountProviderPartnerAccountKind : std::int32_t
    {
        Exchange = 0,
        PopOrImap = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::Provider::IUserDataAccountPartnerAccountInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Priority(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AccountKind(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::Provider::IUserDataAccountProviderAddAccountOperation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ContentKinds(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PartnerAccountInfos(void**) noexcept = 0;
