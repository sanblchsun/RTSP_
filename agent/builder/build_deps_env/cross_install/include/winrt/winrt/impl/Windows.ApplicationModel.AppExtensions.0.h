...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::AppExtensions::IAppExtension>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetExtensionPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPublicFolderAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall RequestRemovePackageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_PackageInstalled(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PackageInstalled(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_PackageUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PackageUpdated(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::AppExtensions::IAppExtensionCatalogStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Open(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppExtensions::IAppExtensionPackageInstalledEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AppExtensionName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Package(void**) noexcept = 0;
