...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Printers::IPrint3DDevice>
    {
        ...
        {
            virtual std::int32_t __stdcall get_PrintSchema(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Printers::IPrintSchema>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDefaultPrintTicketAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCapabilitiesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MergeAndValidateWithDefaultPrintTicketAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
