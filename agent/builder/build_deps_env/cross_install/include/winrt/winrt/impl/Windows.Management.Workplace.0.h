...
{
    enum class MessagingSyncPolicy : std::int32_t
    {
        Disallowed = 0,
        Allowed = 1,
        Required = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall IsBrowserAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsCameraAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsMicrosoftAccountAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsStoreAllowed(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::Workplace::IMdmPolicyStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetMessagingSyncPolicy(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::Workplace::IWorkplaceSettingsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsMicrosoftAccountOptional(bool*) noexcept = 0;
        };
    };
    template <typename D>
