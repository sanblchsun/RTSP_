...
{
    enum class GameListCategory : std::int32_t
    {
        Candidate = 0,
        ConfirmedBySystem = 1,
        ConfirmedByUser = 2,
    };
    enum class GameListEntryLaunchableState : std::int32_t
    {
        NotLaunchable = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Gaming::Preview::GamesEnumeration::IGameListEntry>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SetCategoryAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Preview::GamesEnumeration::IGameListEntry2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LaunchableState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LauncherExecutable(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LaunchParameters(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetLauncherExecutableFileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetLauncherExecutableFileWithParamsAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TitleId(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetTitleIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_GameModeConfiguration(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Preview::GamesEnumeration::IGameListStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall FindAllAsyncPackageFamilyName(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_GameAdded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GameAdded(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_GameRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GameRemoved(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_GameUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GameUpdated(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Preview::GamesEnumeration::IGameListStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall MergeEntriesAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UnmergeEntryAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Preview::GamesEnumeration::IGameModeConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_RelatedProcessNames(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PercentGpuTimeAllocatedToGame(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PercentGpuTimeAllocatedToGame(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PercentGpuMemoryAllocatedToGame(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PercentGpuMemoryAllocatedToGame(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PercentGpuMemoryAllocatedToSystemCompositor(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PercentGpuMemoryAllocatedToSystemCompositor(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxCpuCount(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxCpuCount(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CpuExclusivityMaskLow(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CpuExclusivityMaskLow(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CpuExclusivityMaskHigh(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CpuExclusivityMaskHigh(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AffinitizeToExclusiveCpus(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AffinitizeToExclusiveCpus(bool) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Gaming::Preview::GamesEnumeration::IGameModeUserConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_GamingRelatedProcessNames(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAsync(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Gaming_Preview_GamesEnumeration_IGameModeConfiguration
    {
        ...
        auto PercentGpuTimeAllocatedToGame(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto PercentGpuMemoryAllocatedToGame() const;
        auto PercentGpuMemoryAllocatedToGame(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto PercentGpuMemoryAllocatedToSystemCompositor() const;
        auto PercentGpuMemoryAllocatedToSystemCompositor(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto MaxCpuCount() const;
        auto MaxCpuCount(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto CpuExclusivityMaskLow() const;
        auto CpuExclusivityMaskLow(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto CpuExclusivityMaskHigh() const;
        auto CpuExclusivityMaskHigh(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
