...
WINRT_EXPORT namespace winrt::Windows::Foundation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MemoryBuffer : winrt::Windows::Foundation::IMemoryBuffer
    {
        ...
        explicit MemoryBuffer(std::uint32_t capacity);
    };
    struct PropertyValue
    {
        PropertyValue() = delete;
        static auto CreateEmpty();
        static auto CreateUInt8(std::uint8_t value);
        static auto CreateInt16(std::int16_t value);
        static auto CreateUInt16(std::uint16_t value);
        static auto CreateInt32(std::int32_t value);
        static auto CreateUInt32(std::uint32_t value);
        static auto CreateInt64(std::int64_t value);
        static auto CreateUInt64(std::uint64_t value);
        ...
        static auto CreateUInt8Array(array_view<std::uint8_t const> value);
        static auto CreateInt16Array(array_view<std::int16_t const> value);
        static auto CreateUInt16Array(array_view<std::uint16_t const> value);
        static auto CreateInt32Array(array_view<std::int32_t const> value);
        static auto CreateUInt32Array(array_view<std::uint32_t const> value);
        static auto CreateInt64Array(array_view<std::int64_t const> value);
        static auto CreateUInt64Array(array_view<std::uint64_t const> value);
