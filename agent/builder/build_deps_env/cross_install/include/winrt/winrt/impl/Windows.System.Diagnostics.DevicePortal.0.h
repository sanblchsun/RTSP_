...
{
    enum class DevicePortalConnectionClosedReason : std::int32_t
    {
        Unknown = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Diagnostics::DevicePortal::IDevicePortalConnectionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetForAppServiceConnection(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Diagnostics::DevicePortal::IDevicePortalWebSocketConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetServerMessageWebSocketForRequest(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetServerMessageWebSocketForRequest2(void*, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetServerMessageWebSocketForRequest3(void*, std::int32_t, void*, std::uint32_t, std::uint32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetServerStreamWebSocketForRequest(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetServerStreamWebSocketForRequest2(void*, void*, std::uint32_t, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Diagnostics::DevicePortal::IDevicePortalWebSocketConnectionRequestReceivedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsWebSocketUpgradeRequest(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_WebSocketProtocolsRequested(void**) noexcept = 0;
    ...
    struct consume_Windows_System_Diagnostics_DevicePortal_IDevicePortalWebSocketConnection
    {
        ...
        auto GetServerStreamWebSocketForRequest(winrt::Windows::Web::Http::HttpRequestMessage const& request, param::hstring const& protocol, std::uint32_t outboundBufferSizeInBytes, bool noDelay) const;
    };
