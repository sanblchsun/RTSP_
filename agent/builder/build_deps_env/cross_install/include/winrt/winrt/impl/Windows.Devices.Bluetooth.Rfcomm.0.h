...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceService>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ConnectionHostName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ConnectionServiceName(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_MaxProtectionLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetSdpRawAttributesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSdpRawAttributesWithCacheModeAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceServiceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetDeviceSelector(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceServiceStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDevice(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceWithCacheMode(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceAndServiceId(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode(void*, void*, std::int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceId>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall AsShortId(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall AsString(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceIdStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromUuid(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall FromShortId(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SerialPort(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ObexObjectPush(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ObexFileTransfer(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneBookAccessPce(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneBookAccessPse(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_GenericFileTransfer(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ServiceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SdpRawAttributes(void**) noexcept = 0;
            virtual std::int32_t __stdcall StartAdvertising(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceProvider2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall StartAdvertisingWithRadioDiscoverability(void*, bool) noexcept = 0;
        };
    };
