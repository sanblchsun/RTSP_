...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::AppBroadcasting::IAppBroadcastingMonitor>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsCurrentAppBroadcasting(bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_IsCurrentAppBroadcastingChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsCurrentAppBroadcastingChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::AppBroadcasting::IAppBroadcastingStatus>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanStartBroadcast(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::AppBroadcasting::IAppBroadcastingUI>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ShowBroadcastUI() noexcept = 0;
        };
    };
