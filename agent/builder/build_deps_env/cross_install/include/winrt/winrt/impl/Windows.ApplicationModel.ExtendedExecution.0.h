...
{
    enum class ExtendedExecutionReason : std::int32_t
    {
        Unspecified = 0,
        LocationTracking = 1,
        SavingData = 2,
    };
    enum class ExtendedExecutionResult : std::int32_t
    {
        Allowed = 0,
        Denied = 1,
    };
    enum class ExtendedExecutionRevokedReason : std::int32_t
    {
        Resumed = 0,
        SystemPolicy = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Reason(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Reason(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_PercentProgress(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PercentProgress(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall add_Revoked(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_Revoked(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall RequestExtensionAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionSession
    {
        ...
        auto PercentProgress(std::uint32_t value) const;
