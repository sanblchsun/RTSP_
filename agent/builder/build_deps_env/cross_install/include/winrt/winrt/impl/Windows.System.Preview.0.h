...
{
    enum class HingeState : std::int32_t
    {
        Unknown = 0,
        Closed = 1,
        Concave = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Preview::ITwoPanelHingedDevicePosturePreview>
    {
        ...
        {
            virtual std::int32_t __stdcall GetCurrentPostureAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_PostureChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PostureChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Preview::ITwoPanelHingedDevicePosturePreviewReading>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HingeState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Panel1Orientation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Panel1Id(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Panel2Orientation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Panel2Id(void**) noexcept = 0;
        };
    };
