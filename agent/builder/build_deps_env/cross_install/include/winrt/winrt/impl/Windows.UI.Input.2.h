...
WINRT_EXPORT namespace winrt::Windows::UI::Input
{
    ...
    struct WINRT_IMPL_EMPTY_BASES PointerPoint : winrt::Windows::UI::Input::IPointerPoint
    {
        ...
        static auto GetCurrentPoint(std::uint32_t pointerId);
        static auto GetIntermediatePoints(std::uint32_t pointerId);
        static auto GetCurrentPoint(std::uint32_t pointerId, winrt::Windows::UI::Input::IPointerPointTransform const& transform);
        static auto GetIntermediatePoints(std::uint32_t pointerId, winrt::Windows::UI::Input::IPointerPointTransform const& transform);
    };
