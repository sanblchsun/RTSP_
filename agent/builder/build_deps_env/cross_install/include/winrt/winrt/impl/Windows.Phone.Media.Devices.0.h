...
{
    enum class AudioRoutingEndpoint : std::int32_t
    {
        Default = 0,
        Earpiece = 1,
        Speakerphone = 2,
    ...
    enum class AvailableAudioRoutingEndpoints : std::uint32_t
    {
        None = 0,
        Earpiece = 0x1,
        Speakerphone = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::Media::Devices::IAudioRoutingManager>
    {
        ...
        {
            virtual std::int32_t __stdcall GetAudioEndpoint(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetAudioEndpoint(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall add_AudioEndpointChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AudioEndpointChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_AvailableAudioEndpoints(std::uint32_t*) noexcept = 0;
        };
    };
