...
{
    enum class GameChatMessageOrigin : std::int32_t
    {
        Voice = 0,
        Text = 1,
    };
    enum class GameChatOverlayPosition : std::int32_t
    {
        BottomCenter = 0,
        BottomLeft = 1,
        BottomRight = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Gaming::UI::IGameBarStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_IsInputRedirectedChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsInputRedirectedChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_Visible(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInputRedirected(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Gaming::UI::IGameChatOverlay>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DesiredPosition(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DesiredPosition(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall AddMessage(void*, void*, std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::UI::IGameChatOverlayMessageSource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SetDelayBeforeClosingAfterMessageReceived(std::int64_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Gaming::UI::IGameUIProviderActivatedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_GameUIArgs(void**) noexcept = 0;
