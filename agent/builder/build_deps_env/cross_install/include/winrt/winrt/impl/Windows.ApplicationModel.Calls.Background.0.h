...
{
    enum class PhoneCallBlockedReason : std::int32_t
    {
        InCallBlockingList = 0,
        PrivateNumber = 1,
        UnknownNumber = 2,
    };
    enum class PhoneIncomingCallDismissedReason : std::int32_t
    {
        Unknown = 0,
        CallRejected = 1,
        TextReply = 2,
    ...
    enum class PhoneLineChangeKind : std::int32_t
    {
        Added = 0,
        Removed = 1,
        PropertiesChanged = 2,
    };
    enum class PhoneLineProperties : std::uint32_t
    {
        None = 0,
        BrandingOptions = 0x1,
        CanDial = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::Background::IPhoneCallBlockedTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CallBlockedReason(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::Background::IPhoneCallOriginDataRequestTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RequestId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneNumber(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::Background::IPhoneIncomingCallDismissedTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DismissalTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TextReplyMessage(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::Background::IPhoneLineChangedTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall HasLinePropertyChanged(std::uint32_t, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::Background::IPhoneNewVoicemailMessageTriggerDetails>
    {
        ...
        {
            virtual std::int32_t __stdcall get_LineId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_VoicemailCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_OperatorMessage(void**) noexcept = 0;
        };
    };
    template <typename D>
