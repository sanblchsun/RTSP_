...
{
    enum class JsonErrorStatus : std::int32_t
    {
        Unknown = 0,
        InvalidJsonString = 1,
        InvalidJsonNumber = 2,
    ...
    enum class JsonValueType : std::int32_t
    {
        Null = 0,
        Boolean = 1,
        Number = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Data::Json::IJsonArray>
    {
        ...
        {
            virtual std::int32_t __stdcall GetObjectAt(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetArrayAt(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStringAt(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumberAt(std::uint32_t, double*) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanAt(std::uint32_t, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Data::Json::IJsonErrorStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetJsonStatus(std::int32_t, std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Json::IJsonObject>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetNamedValue(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetNamedValue(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedObject(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedArray(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedString(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedNumber(void*, double*) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedBoolean(void*, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Data::Json::IJsonObjectWithDefaultValues>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetNamedValueOrDefault(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedObjectOrDefault(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedStringOrDefault(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedArrayOrDefault(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedNumberOrDefault(void*, double, double*) noexcept = 0;
            virtual std::int32_t __stdcall GetNamedBooleanOrDefault(void*, bool, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Json::IJsonValue>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ValueType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Stringify(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetString(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumber(double*) noexcept = 0;
            virtual std::int32_t __stdcall GetBoolean(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetArray(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetObject(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Json::IJsonValueStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Parse(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryParse(void*, void**, bool*) noexcept = 0;
            virtual std::int32_t __stdcall CreateBooleanValue(bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateNumberValue(double, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateStringValue(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Json::IJsonValueStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateNullValue(void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Data_Json_IJsonArray
    {
        auto GetObjectAt(std::uint32_t index) const;
        auto GetArrayAt(std::uint32_t index) const;
        auto GetStringAt(std::uint32_t index) const;
        auto GetNumberAt(std::uint32_t index) const;
        auto GetBooleanAt(std::uint32_t index) const;
    };
    ...
    {
        auto GetJsonStatus(std::int32_t hresult) const;
    };
