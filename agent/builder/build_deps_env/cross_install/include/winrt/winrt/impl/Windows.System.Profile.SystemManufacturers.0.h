...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Profile::SystemManufacturers::IOemSupportInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_SupportLink(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportAppLink(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportProvider(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::Profile::SystemManufacturers::ISystemSupportInfoStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LocalSystemEdition(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OemSupportInfo(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Profile::SystemManufacturers::ISystemSupportInfoStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LocalDeviceInfo(void**) noexcept = 0;
        };
    };
    template <typename D>
