...
{
    enum class SearchSuggestionKind : std::int32_t
    {
        Query = 0,
        Result = 1,
        Separator = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Search::Core::ISearchSuggestion>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DetailText(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Image(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ImageAlternateText(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Search::Core::ISearchSuggestionManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SetQuery(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetQueryWithLanguage(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetQueryWithSearchQueryLinguisticDetails(void*, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Suggestions(void**) noexcept = 0;
            virtual std::int32_t __stdcall AddToHistory(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddToHistoryWithLanguage(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall ClearHistory() noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_RequestingFocusOnKeyboardInput(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RequestingFocusOnKeyboardInput(winrt::event_token) noexcept = 0;
        };
    };
