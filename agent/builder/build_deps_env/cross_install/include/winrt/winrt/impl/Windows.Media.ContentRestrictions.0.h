...
{
    enum class ContentAccessRestrictionLevel : std::int32_t
    {
        Allow = 0,
        Warn = 1,
        Block = 2,
    ...
    enum class RatedContentCategory : std::int32_t
    {
        General = 0,
        Application = 1,
        Game = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::ContentRestrictions::IContentRestrictionsBrowsePolicy>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MaxBrowsableAgeRating(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredAgeRating(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::ContentRestrictions::IRatedContentDescription>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Category(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Ratings(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Ratings(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::ContentRestrictions::IRatedContentRestrictions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetBrowsePolicyAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetRestrictionLevelAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestContentAccessAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_RestrictionsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RestrictionsChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::ContentRestrictions::IRatedContentRestrictionsFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithMaxAgeRating(std::uint32_t, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto CreateWithMaxAgeRating(std::uint32_t maxAgeRating) const;
    };
