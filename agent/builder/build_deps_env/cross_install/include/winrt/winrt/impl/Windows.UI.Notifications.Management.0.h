...
{
    enum class UserNotificationListenerAccessStatus : std::int32_t
    {
        Unspecified = 0,
        Allowed = 1,
        Denied = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_NotificationChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NotificationChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetNotificationsAsync(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNotification(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ClearNotifications() noexcept = 0;
            virtual std::int32_t __stdcall RemoveNotification(std::uint32_t) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Notifications_Management_IUserNotificationListener
    {
        ...
        auto GetNotification(std::uint32_t notificationId) const;
        auto ClearNotifications() const;
        auto RemoveNotification(std::uint32_t notificationId) const;
    };
