...
{
    enum class PdfPageRotation : std::int32_t
    {
        Normal = 0,
        Rotate90 = 1,
        Rotate180 = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Data::Pdf::IPdfDocument>
    {
        ...
        {
            virtual std::int32_t __stdcall GetPage(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PageCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPasswordProtected(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Pdf::IPdfDocumentStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall LoadFromFileWithPasswordAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall LoadFromStreamAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall LoadFromStreamWithPasswordAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Pdf::IPdfPage>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RenderToStreamAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RenderWithOptionsToStreamAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall PreparePageAsync(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Dimensions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Rotation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredZoom(float*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Pdf::IPdfPageDimensions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MediaBox(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall get_CropBox(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall get_BleedBox(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrimBox(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall get_ArtBox(winrt::Windows::Foundation::Rect*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Data::Pdf::IPdfPageRenderOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SourceRect(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall put_SourceRect(winrt::Windows::Foundation::Rect) noexcept = 0;
            virtual std::int32_t __stdcall get_DestinationWidth(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DestinationWidth(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DestinationHeight(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DestinationHeight(std::uint32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsIgnoringHighContrast(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsIgnoringHighContrast(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_BitmapEncoderId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall put_BitmapEncoderId(winrt::guid) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Data_Pdf_IPdfDocument
    {
        auto GetPage(std::uint32_t pageIndex) const;
    ...
    struct consume_Windows_Data_Pdf_IPdfPageRenderOptions
    {
        ...
        auto DestinationWidth(std::uint32_t value) const;
        [[nodiscard]] auto DestinationHeight() const;
        auto DestinationHeight(std::uint32_t value) const;
