...
WINRT_EXPORT namespace winrt::Windows::Devices::Sms
{
    ...
    struct WINRT_IMPL_EMPTY_BASES GetSmsMessagesOperation : winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::Sms::ISmsMessage>, std::int32_t>
    {
        GetSmsMessagesOperation(std::nullptr_t) noexcept {}
        GetSmsMessagesOperation(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::Sms::ISmsMessage>, std::int32_t>(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES SmsTextMessage : winrt::Windows::Devices::Sms::ISmsTextMessage
    {
        ...
        static auto FromBinaryData(winrt::Windows::Devices::Sms::SmsDataFormat const& format, array_view<std::uint8_t const> value);
    };
