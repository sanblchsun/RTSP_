...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ILocalContentSuggestionSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_AqsFilter(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AqsFilter(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PropertiesToMatch(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ISearchPane>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_SearchHistoryEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_SearchHistoryEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_SearchHistoryContext(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SearchHistoryContext(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_QueryChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_QueryChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SuggestionsRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SuggestionsRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_QuerySubmitted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_QuerySubmitted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ResultSuggestionChosen(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ResultSuggestionChosen(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall SetLocalContentSuggestionSettings(void*) noexcept = 0;
            virtual std::int32_t __stdcall ShowOverloadDefault() noexcept = 0;
            virtual std::int32_t __stdcall ShowOverloadWithQuery(void*) noexcept = 0;
            virtual std::int32_t __stdcall put_ShowOnKeyboardInput(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ShowOnKeyboardInput(bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySetQueryText(void*, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ISearchPaneQueryLinguisticDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_QueryTextAlternatives(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_QueryTextCompositionStart(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_QueryTextCompositionLength(std::uint32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ISearchPaneStaticsWithHideThisApplication>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall HideThisApplication() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SearchSuggestionCollection(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ISearchQueryLinguisticDetailsFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(void*, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Search::ISearchSuggestionCollection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall AppendQuerySuggestion(void*) noexcept = 0;
            virtual std::int32_t __stdcall AppendQuerySuggestions(void*) noexcept = 0;
            virtual std::int32_t __stdcall AppendResultSuggestion(void*, void*, void*, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall AppendSearchSeparator(void*) noexcept = 0;
        };
    };
    ...
    {
        auto CreateInstance(param::iterable<hstring> const& queryTextAlternatives, std::uint32_t queryTextCompositionStart, std::uint32_t queryTextCompositionLength) const;
    };
