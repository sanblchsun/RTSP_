...
{
    enum class SecurityAppKind : std::int32_t
    {
        WebProtection = 0,
    };
    enum class SecurityAppState : std::int32_t
    {
        Disabled = 0,
        Enabled = 1,
    };
    enum class SecurityAppSubstatus : std::int32_t
    {
        Undetermined = 0,
        NoActionNeeded = 1,
        ActionRecommended = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IAdaptiveCardBuilderStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateAdaptiveCardFromJson(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::ISecurityAppManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Register(std::int32_t, void*, void*, bool, winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall Unregister(std::int32_t, winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall UpdateState(std::int32_t, winrt::guid, std::int32_t, std::int32_t, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::ITaskbarManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsPinningAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsCurrentAppPinnedAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall IsAppListEntryPinnedAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPinCurrentAppAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPinAppListEntryAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::ITaskbarManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsSecondaryTilePinnedAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPinSecondaryTileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryUnpinSecondaryTileAsync(void*, void**) noexcept = 0;
        };
    };
