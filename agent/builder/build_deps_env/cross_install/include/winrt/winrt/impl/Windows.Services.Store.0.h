...
{
    enum class HttpStatusCode : std::int32_t;
}
WINRT_EXPORT namespace winrt::Windows::Services::Store
{
    enum class StoreCanLicenseStatus : std::int32_t
    {
    ...
    enum class StoreConsumableStatus : std::int32_t
    {
        Succeeded = 0,
    ...
    enum class StoreDurationUnit : std::int32_t
    {
        Minute = 0,
        Hour = 1,
        Day = 2,
    ...
    enum class StorePackageUpdateState : std::int32_t
    {
        Pending = 0,
        Downloading = 1,
        Deploying = 2,
    ...
    enum class StorePurchaseStatus : std::int32_t
    {
        Succeeded = 0,
        AlreadyPurchased = 1,
        NotPurchased = 2,
    ...
    enum class StoreQueueItemExtendedState : std::int32_t
    {
        ActivePending = 0,
        ActiveStarting = 1,
    ...
    enum class StoreQueueItemKind : std::int32_t
    {
        Install = 0,
        Update = 1,
        Repair = 2,
    };
    enum class StoreQueueItemState : std::int32_t
    {
        Active = 0,
        Completed = 1,
        Canceled = 2,
    ...
    enum class StoreRateAndReviewStatus : std::int32_t
    {
        Succeeded = 0,
        CanceledByUser = 1,
        NetworkError = 2,
    ...
    enum class StoreUninstallStorePackageStatus : std::int32_t
    {
        Succeeded = 0,
        CanceledByUser = 1,
        NetworkError = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Services::Store::StorePackageUpdateStatus>{ using type = struct_category<hstring, std::uint64_t, std::uint64_t, double, double, winrt::Windows::Services::Store::StorePackageUpdateState>; };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreAcquireLicenseResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_StorePackageLicense(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreAppLicense>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SkuStoreId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsTrial(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExpirationDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AddOnLicenses(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TrialTimeRemaining(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsTrialOwnedByThisUser(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrialUniqueId(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreAppLicense2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsDiscLicense(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreAvailability>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_StoreId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EndDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Price(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseWithPurchasePropertiesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreCanAcquireLicenseResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall get_LicensableSku(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreCollectionData>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsTrial(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CampaignId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DeveloperOfferId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AcquiredDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_StartDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EndDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrialTimeRemaining(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
        };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreConsumableResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrackingId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BalanceRemaining(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreContext>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_OfflineLicensesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_OfflineLicensesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetCustomerPurchaseIdAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCustomerCollectionsIdAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppLicenseAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStoreProductForCurrentAppAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStoreProductsAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAssociatedStoreProductsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAssociatedStoreProductsWithPagingAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetUserCollectionAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetUserCollectionWithPagingAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportConsumableFulfillmentAsync(void*, std::uint32_t, winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConsumableBalanceRemainingAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AcquireStoreLicenseForOptionalPackageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseWithPurchasePropertiesAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppAndOptionalStorePackageUpdatesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestDownloadStorePackageUpdatesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestDownloadAndInstallStorePackageUpdatesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestDownloadAndInstallStorePackagesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreContext2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindStoreProductForPackageAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreContext3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanSilentlyDownloadStorePackageUpdates(bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySilentDownloadStorePackageUpdatesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySilentDownloadAndInstallStorePackageUpdatesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CanAcquireStoreLicenseForOptionalPackageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CanAcquireStoreLicenseAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStoreProductsWithOptionsAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAssociatedStoreQueueItemsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStoreQueueItemsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestDownloadAndInstallStorePackagesWithInstallOptionsAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DownloadAndInstallStorePackagesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestUninstallStorePackageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestUninstallStorePackageByStoreIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UninstallStorePackageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UninstallStorePackageByStoreIdAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreContext4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestRateAndReviewAppAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetInstallOrderForAssociatedStoreQueueItemsAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreImage>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ImagePurposeTag(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreLicense>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ExpirationDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InAppOfferToken(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePackageInstallOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AllowForcedAppRestart(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowForcedAppRestart(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePackageLicense>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_LicenseLost(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_LicenseLost(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_Package(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsValid(bool*) noexcept = 0;
            virtual std::int32_t __stdcall ReleaseLicense() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePackageUpdate>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Package(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Mandatory(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePackageUpdateResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_OverallState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_StorePackageUpdateStatuses(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePackageUpdateResult2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_StoreQueueItems(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePrice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_FormattedBasePrice(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FormattedPrice(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOnSale(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SaleEndDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrencyCode(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FormattedRecurrencePrice(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreProduct>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ProductKind(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HasDigitalDownload(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Keywords(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Images(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Videos(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Skus(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInUserCollection(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Price(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LinkUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIsAnySkuInstalledAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseWithPurchasePropertiesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InAppOfferToken(void**) noexcept = 0;
        };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreProductOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ActionFilters(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreProductPagedQueryResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Products(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HasMoreResults(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall GetNextAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreProductResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Product(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStorePurchaseProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ExtendedJsonData(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreQueueItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ProductId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PackageFamilyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InstallKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentStatus(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_StatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_StatusChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreQueueItem2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CancelInstallAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall PauseInstallAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ResumeInstallAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreQueueItemStatus>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PackageInstallState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PackageInstallExtendedState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UpdateStatus(struct struct_Windows_Services_Store_StorePackageUpdateStatus*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreRateAndReviewResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WasUpdated(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreRequestHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SendRequestAsync(void*, std::uint32_t, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreSku>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Description(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsTrial(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomDeveloperData(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Images(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Videos(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Availabilities(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Price(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedJsonData(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInUserCollection(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_BundledSkus(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CollectionData(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIsInstalledAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseWithPurchasePropertiesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSubscription(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SubscriptionInfo(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Store::IStoreSubscriptionInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BillingPeriod(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BillingPeriodUnit(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasTrialPeriod(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrialPeriod(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrialPeriodUnit(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreVideo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Uri(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_VideoPurposeTag(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Width(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Height(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Caption(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PreviewImage(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Services_Store_IStoreContext
    {
        ...
        auto GetAssociatedStoreProductsWithPagingAsync(param::async_iterable<hstring> const& productKinds, std::uint32_t maxItemsToRetrievePerPage) const;
        auto GetUserCollectionAsync(param::async_iterable<hstring> const& productKinds) const;
        auto GetUserCollectionWithPagingAsync(param::async_iterable<hstring> const& productKinds, std::uint32_t maxItemsToRetrievePerPage) const;
        auto ReportConsumableFulfillmentAsync(param::hstring const& productStoreId, std::uint32_t quantity, winrt::guid const& trackingId) const;
    ...
    {
        auto SendRequestAsync(winrt::Windows::Services::Store::StoreContext const& context, std::uint32_t requestKind, param::hstring const& parametersAsJson) const;
    };
    ...
    struct struct_Windows_Services_Store_StorePackageUpdateStatus
    {
        ...
        std::uint64_t PackageDownloadSizeInBytes;
        std::uint64_t PackageBytesDownloaded;
        double PackageDownloadProgress;
        double TotalDownloadProgress;
        std::int32_t PackageUpdateState;
    };
