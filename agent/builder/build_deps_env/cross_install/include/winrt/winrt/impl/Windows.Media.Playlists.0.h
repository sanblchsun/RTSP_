...
{
    enum class PlaylistFormat : std::int32_t
    {
        WindowsMedia = 0,
        Zune = 1,
        M3u = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Playlists::IPlaylist>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SaveAsAsync(void*, void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAsWithFormatAsync(void*, void*, std::int32_t, std::int32_t, void**) noexcept = 0;
        };
    };
