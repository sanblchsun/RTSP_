...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::CommunicationBlocking::ICommunicationBlockingAccessManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsBlockingActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsBlockedNumberAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowBlockNumbersUI(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall ShowUnblockNumbersUI(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall ShowBlockedCallsUI() noexcept = 0;
            virtual std::int32_t __stdcall ShowBlockedMessagesUI() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::CommunicationBlocking::ICommunicationBlockingAppManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsCurrentAppActiveBlockingApp(bool*) noexcept = 0;
            virtual std::int32_t __stdcall ShowCommunicationBlockingSettingsUI() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::CommunicationBlocking::ICommunicationBlockingAppManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestSetAsActiveBlockingAppAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
