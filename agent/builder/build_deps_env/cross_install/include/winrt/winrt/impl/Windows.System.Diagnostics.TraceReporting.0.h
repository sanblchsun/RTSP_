...
{
    enum class PlatformDiagnosticActionState : std::int32_t
    {
        Success = 0,
        FreeNetworkNotAvailable = 1,
        ACPowerNotAvailable = 2,
    };
    enum class PlatformDiagnosticEscalationType : std::int32_t
    {
        OnCompletion = 0,
        OnFailure = 1,
    };
    enum class PlatformDiagnosticEventBufferLatencies : std::uint32_t
    {
        Normal = 0x1,
        CostDeferred = 0x2,
        Realtime = 0x4,
    };
    enum class PlatformDiagnosticTracePriority : std::int32_t
    {
        Normal = 0,
        UserElevated = 1,
    };
    enum class PlatformDiagnosticTraceSlotState : std::int32_t
    {
        NotRunning = 0,
        Running = 1,
        Throttled = 2,
    };
    enum class PlatformDiagnosticTraceSlotType : std::int32_t
    {
        Alternative = 0,
        AlwaysOn = 1,
        Mini = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Diagnostics::TraceReporting::IPlatformDiagnosticActionsStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall IsScenarioEnabled(winrt::guid, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TryEscalateScenario(winrt::guid, std::int32_t, void*, bool, bool, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall DownloadLatestSettingsForNamespace(void*, void*, bool, bool, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetActiveScenarioList(void**) noexcept = 0;
            virtual std::int32_t __stdcall ForceUpload(std::uint32_t, bool, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall IsTraceRunning(std::int32_t, winrt::guid, std::uint64_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetActiveTraceRuntime(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetKnownTraceList(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Diagnostics::TraceReporting::IPlatformDiagnosticTraceInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ScenarioId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProfileHash(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsExclusive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsAutoLogger(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxTraceDurationFileTime(std::int64_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::System::Diagnostics::TraceReporting::IPlatformDiagnosticTraceRuntimeInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RuntimeFileTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EtwRuntimeFileTime(std::int64_t*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_System_Diagnostics_TraceReporting_IPlatformDiagnosticActionsStatics
    {
        ...
        auto IsTraceRunning(winrt::Windows::System::Diagnostics::TraceReporting::PlatformDiagnosticTraceSlotType const& slotType, winrt::guid const& scenarioId, std::uint64_t traceProfileHash) const;
