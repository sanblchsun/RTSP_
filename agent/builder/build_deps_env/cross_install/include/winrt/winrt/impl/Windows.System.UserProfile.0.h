...
{
    enum class AccountPictureKind : std::int32_t
    {
        SmallImage = 0,
        LargeImage = 1,
        Video = 2,
    };
    enum class SetAccountPictureResult : std::int32_t
    {
        Success = 0,
        ChangeDisabled = 1,
    ...
    enum class SetImageFeedResult : std::int32_t
    {
        Success = 0,
        ChangeDisabled = 1,
        UserCanceled = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::UserProfile::IAdvertisingManagerForUser>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AdvertisingId(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::System::UserProfile::IAssignedAccessSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsSingleAppKioskMode(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_User(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::UserProfile::IDiagnosticsSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanUseDiagnosticsToTailorExperiences(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_User(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::UserProfile::IGlobalizationPreferencesForUser>
    {
        ...
        {
            virtual std::int32_t __stdcall get_User(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Calendars(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Clocks(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Currencies(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Languages(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HomeGeographicRegion(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WeekStartsOn(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::UserProfile::IGlobalizationPreferencesStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TrySetHomeGeographicRegion(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySetLanguages(void*, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::UserProfile::ILockScreenImageFeedStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestSetImageFeedAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryRemoveImageFeed(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::UserProfile::ILockScreenStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_OriginalImageFile(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetImageStream(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetImageFileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetImageStreamAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::UserProfile::IUserInformationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AccountPictureChangeEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_NameAccessAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetAccountPicture(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetAccountPictureAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetAccountPicturesAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetAccountPictureFromStreamAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetAccountPicturesFromStreamsAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_AccountPictureChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AccountPictureChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetDisplayNameAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFirstNameAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLastNameAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPrincipalNameAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSessionInitiationProtocolUriAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDomainNameAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::UserProfile::IUserProfilePersonalizationSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TrySetLockScreenImageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySetWallpaperImageAsync(void*, void**) noexcept = 0;
        };
    };
