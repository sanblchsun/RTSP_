...
{
    enum class PnpObjectType : std::int32_t
    {
        Unknown = 0,
        DeviceInterface = 1,
        DeviceContainer = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Enumeration::Pnp::IPnpObjectStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromIdAsync(std::int32_t, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAllAsync(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAllAsyncAqsFilter(std::int32_t, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWatcher(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWatcherAqsFilter(std::int32_t, void*, void*, void**) noexcept = 0;
        };
    };
