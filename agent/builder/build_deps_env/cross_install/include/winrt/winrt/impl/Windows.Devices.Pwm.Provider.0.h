...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Pwm::Provider::IPwmControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall AcquirePin(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReleasePin(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall EnablePin(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall DisablePin(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetPulseParameters(std::int32_t, double, bool) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Pwm_Provider_IPwmControllerProvider
    {
        ...
        auto AcquirePin(std::int32_t pin) const;
        auto ReleasePin(std::int32_t pin) const;
        auto EnablePin(std::int32_t pin) const;
        auto DisablePin(std::int32_t pin) const;
        auto SetPulseParameters(std::int32_t pin, double dutyCycle, bool invertPolarity) const;
    };
