...
{
    enum class SystemUpdateAttentionRequiredReason : std::int32_t
    {
        None = 0,
        NetworkRequired = 1,
    ...
    enum class SystemUpdateItemState : std::int32_t
    {
        NotStarted = 0,
        Initializing = 1,
        Preparing = 2,
    ...
    enum class SystemUpdateManagerState : std::int32_t
    {
        Idle = 0,
        Detecting = 1,
        ReadyToDownload = 2,
    ...
    enum class SystemUpdateStartInstallAction : std::int32_t
    {
        UpToReboot = 0,
        AllowReboot = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Update::ISystemUpdateItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_InstallProgress(double*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::System::Update::ISystemUpdateLastErrorInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_State(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInteractive(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Update::ISystemUpdateManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DownloadProgress(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_InstallProgress(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_UserActiveHoursStart(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UserActiveHoursEnd(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UserActiveHoursMax(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall TrySetUserActiveHours(std::int64_t, std::int64_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_LastUpdateCheckTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LastUpdateInstallTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LastErrorInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAutomaticRebootBlockIds(void**) noexcept = 0;
            virtual std::int32_t __stdcall BlockAutomaticRebootAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UnblockAutomaticRebootAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall GetUpdateItems(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AttentionRequiredReason(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetFlightRing(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetFlightRing(void**) noexcept = 0;
            virtual std::int32_t __stdcall StartInstall(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall RebootToCompleteInstall() noexcept = 0;
            virtual std::int32_t __stdcall StartCancelUpdates() noexcept = 0;
        };
    };
    template <typename D>
