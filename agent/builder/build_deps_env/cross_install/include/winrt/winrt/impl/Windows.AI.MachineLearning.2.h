...
WINRT_EXPORT namespace winrt::Windows::AI::MachineLearning
{
        ...
        impl::require<TensorBoolean, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<bool const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<bool> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<bool const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorDouble, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<double const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<double> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<double const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorFloat, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<float const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<float> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<float const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorInt16Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::int16_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::int16_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::int16_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorInt32Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::int32_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::int32_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::int32_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorInt64Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::int64_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::int64_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::int64_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorInt8Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::uint8_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::uint8_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::uint8_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorString, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<hstring const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<hstring> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<hstring const> data);
    };
        ...
        impl::require<TensorUInt16Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::uint16_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::uint16_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::uint16_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorUInt32Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::uint32_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::uint32_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::uint32_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
        ...
        impl::require<TensorUInt64Bit, winrt::Windows::AI::MachineLearning::ILearningModelFeatureValue, winrt::Windows::AI::MachineLearning::ITensor, winrt::Windows::Foundation::IClosable, winrt::Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto Create();
        static auto Create(param::iterable<std::int64_t> const& shape);
        static auto CreateFromArray(param::iterable<std::int64_t> const& shape, array_view<std::uint64_t const> data);
        static auto CreateFromIterable(param::iterable<std::int64_t> const& shape, param::iterable<std::uint64_t> const& data);
        static auto CreateFromShapeArrayAndDataArray(array_view<std::int64_t const> shape, array_view<std::uint64_t const> data);
        static auto CreateFromBuffer(array_view<std::int64_t const> shape, winrt::Windows::Storage::Streams::IBuffer const& buffer);
    };
