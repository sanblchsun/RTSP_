...
WINRT_EXPORT namespace winrt::Windows::Devices::PointOfService
{
    ...
    struct WINRT_IMPL_EMPTY_BASES BarcodeScannerReport : winrt::Windows::Devices::PointOfService::IBarcodeScannerReport
    {
        ...
        BarcodeScannerReport(std::uint32_t scanDataType, winrt::Windows::Storage::Streams::IBuffer const& scanData, winrt::Windows::Storage::Streams::IBuffer const& scanDataLabel);
    };
    ...
    struct BarcodeSymbologies
    {
        ...
        static auto GetName(std::uint32_t scanDataType);
    ...
    struct WINRT_IMPL_EMPTY_BASES UnifiedPosErrorData : winrt::Windows::Devices::PointOfService::IUnifiedPosErrorData
    {
        ...
        UnifiedPosErrorData(param::hstring const& message, winrt::Windows::Devices::PointOfService::UnifiedPosErrorSeverity const& severity, winrt::Windows::Devices::PointOfService::UnifiedPosErrorReason const& reason, std::uint32_t extendedReason);
    };
}
#endif
