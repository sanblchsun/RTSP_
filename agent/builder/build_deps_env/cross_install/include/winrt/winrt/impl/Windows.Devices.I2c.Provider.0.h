...
{
    enum class ProviderI2cBusSpeed : std::int32_t
    {
        StandardMode = 0,
        FastMode = 1,
    };
    enum class ProviderI2cSharingMode : std::int32_t
    {
        Exclusive = 0,
        Shared = 1,
    };
    enum class ProviderI2cTransferStatus : std::int32_t
    {
        FullTransfer = 0,
        PartialTransfer = 1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferResult>{ using type = struct_category<winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferStatus, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Windows::Devices::I2c::Provider::II2cControllerProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall GetDeviceProvider(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::I2c::Provider::II2cDeviceProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall WritePartial(std::uint32_t, std::uint8_t*, struct struct_Windows_Devices_I2c_Provider_ProviderI2cTransferResult*) noexcept = 0;
            virtual std::int32_t __stdcall Read(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadPartial(std::uint32_t, std::uint8_t*, struct struct_Windows_Devices_I2c_Provider_ProviderI2cTransferResult*) noexcept = 0;
            virtual std::int32_t __stdcall WriteRead(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall WriteReadPartial(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*, struct struct_Windows_Devices_I2c_Provider_ProviderI2cTransferResult*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::I2c::Provider::II2cProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetControllersAsync(void**) noexcept = 0;
        };
    };
