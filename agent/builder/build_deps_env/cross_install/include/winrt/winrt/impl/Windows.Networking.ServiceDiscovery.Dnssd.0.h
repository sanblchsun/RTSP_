...
{
    enum class DnssdRegistrationStatus : std::int32_t
    {
        Success = 0,
    ...
    enum class DnssdServiceWatcherStatus : std::int32_t
    {
        Created = 0,
        Started = 1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdRegistrationResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HasInstanceNameChanged(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceInstance>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DnssdServiceInstanceName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DnssdServiceInstanceName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_HostName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_HostName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Port(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Port(std::uint16_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Priority(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Priority(std::uint16_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Weight(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Weight(std::uint16_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TextAttributes(void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterStreamSocketListenerAsync1(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterStreamSocketListenerAsync2(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterDatagramSocketAsync1(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterDatagramSocketAsync2(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Networking_ServiceDiscovery_Dnssd_IDnssdServiceInstance
    {
        ...
        auto Port(std::uint16_t value) const;
        [[nodiscard]] auto Priority() const;
        auto Priority(std::uint16_t value) const;
        [[nodiscard]] auto Weight() const;
        auto Weight(std::uint16_t value) const;
    ...
    {
        auto Create(param::hstring const& dnssdServiceInstanceName, winrt::Windows::Networking::HostName const& hostName, std::uint16_t port) const;
    };
