...
WINRT_EXPORT namespace winrt::Windows::Phone::Notification::Management
{
    struct AccessoryManager
    {
        ...
        static auto AcceptPhoneCall(std::uint32_t phoneCallId);
        static auto AcceptPhoneCall(std::uint32_t phoneCallId, winrt::Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint);
        static auto AcceptPhoneCallWithVideo(std::uint32_t phoneCallId);
        static auto AcceptPhoneCallWithVideo(std::uint32_t phoneCallId, winrt::Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint);
        static auto RejectPhoneCall(std::uint32_t phoneCallId);
        static auto RejectPhoneCall(std::uint32_t phoneCallId, std::uint32_t textResponseID);
        ...
        static auto SwapPhoneCalls(std::uint32_t phoneCallIdToHold, std::uint32_t phoneCallIdOnHold);
        static auto HoldPhoneCall(std::uint32_t phoneCallId, bool holdCall);
        static auto EndPhoneCall(std::uint32_t phoneCallId);
        ...
        static auto EnableAccessoryNotificationTypes(std::int32_t accessoryNotificationTypes);
        ...
        static auto IncreaseVolume(std::int32_t step);
        static auto DecreaseVolume(std::int32_t step);
