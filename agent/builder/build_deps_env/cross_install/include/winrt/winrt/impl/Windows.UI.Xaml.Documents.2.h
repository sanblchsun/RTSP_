...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Documents
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Typography : winrt::Windows::UI::Xaml::Documents::ITypography
    {
        ...
        static auto SetAnnotationAlternates(winrt::Windows::UI::Xaml::DependencyObject const& element, std::int32_t value);
        ...
        static auto SetStandardSwashes(winrt::Windows::UI::Xaml::DependencyObject const& element, std::int32_t value);
        ...
        static auto SetContextualSwashes(winrt::Windows::UI::Xaml::DependencyObject const& element, std::int32_t value);
        ...
        static auto SetStylisticAlternates(winrt::Windows::UI::Xaml::DependencyObject const& element, std::int32_t value);
