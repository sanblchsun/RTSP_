...
{
    enum class HidCollectionType : std::int32_t
    {
        Physical = 0,
        Application = 1,
        Logical = 2,
    ...
    enum class HidReportType : std::int32_t
    {
        Input = 0,
        Output = 1,
        Feature = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidBooleanControl>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UsagePage(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsActive(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ControlDescription(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidBooleanControlDescription>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Id(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReportId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReportType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsagePage(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ParentCollections(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidBooleanControlDescription2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsAbsolute(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidCollection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UsagePage(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageId(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UsagePage(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetInputReportAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetInputReportByIdAsync(std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFeatureReportAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFeatureReportByIdAsync(std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateOutputReport(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateOutputReportById(std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFeatureReport(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFeatureReportById(std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SendOutputReportAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SendFeatureReportAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanControlDescriptions(std::int32_t, std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumericControlDescriptions(std::int32_t, std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_InputReportReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_InputReportReceived(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDeviceSelector(std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorVidPid(std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FromIdAsync(void*, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidFeatureReport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Id(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Data(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Data(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanControl(std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanControlByDescription(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumericControl(std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumericControlByDescription(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidInputReport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Id(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Data(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ActivatedBooleanControls(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TransitionedBooleanControls(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanControl(std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanControlByDescription(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumericControl(std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumericControlByDescription(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidNumericControl>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Id(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsGrouped(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsagePage(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Value(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Value(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ScaledValue(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ScaledValue(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ControlDescription(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::HumanInterfaceDevice::IHidNumericControlDescription>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ReportId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReportType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReportSize(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReportCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsagePage(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LogicalMinimum(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LogicalMaximum(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhysicalMinimum(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhysicalMaximum(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UnitExponent(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Unit(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsAbsolute(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNull(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ParentCollections(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_HumanInterfaceDevice_IHidDevice
    {
        ...
        auto GetInputReportAsync(std::uint16_t reportId) const;
        auto GetFeatureReportAsync() const;
        auto GetFeatureReportAsync(std::uint16_t reportId) const;
        auto CreateOutputReport() const;
        auto CreateOutputReport(std::uint16_t reportId) const;
        auto CreateFeatureReport() const;
        auto CreateFeatureReport(std::uint16_t reportId) const;
        ...
        auto GetBooleanControlDescriptions(winrt::Windows::Devices::HumanInterfaceDevice::HidReportType const& reportType, std::uint16_t usagePage, std::uint16_t usageId) const;
        auto GetNumericControlDescriptions(winrt::Windows::Devices::HumanInterfaceDevice::HidReportType const& reportType, std::uint16_t usagePage, std::uint16_t usageId) const;
    ...
    {
        auto GetDeviceSelector(std::uint16_t usagePage, std::uint16_t usageId) const;
        auto GetDeviceSelector(std::uint16_t usagePage, std::uint16_t usageId, std::uint16_t vendorId, std::uint16_t productId) const;
    ...
    struct consume_Windows_Devices_HumanInterfaceDevice_IHidFeatureReport
    {
        ...
        auto GetBooleanControl(std::uint16_t usagePage, std::uint16_t usageId) const;
        ...
        auto GetNumericControl(std::uint16_t usagePage, std::uint16_t usageId) const;
    ...
    struct consume_Windows_Devices_HumanInterfaceDevice_IHidNumericControl
    {
        ...
        auto Value(std::int64_t value) const;
        [[nodiscard]] auto ScaledValue() const;
        auto ScaledValue(std::int64_t value) const;
        [[nodiscard]] auto ControlDescription() const;
    };
