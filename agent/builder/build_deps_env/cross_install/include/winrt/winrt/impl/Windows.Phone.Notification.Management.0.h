...
{
    enum class AccessoryNotificationType : std::uint32_t
    {
        None = 0,
        Phone = 0x1,
        Email = 0x2,
    ...
    enum class CalendarChangedEvent : std::int32_t
    {
        LostEvents = 0,
        AppointmentAdded = 1,
    ...
    enum class PhoneCallAudioEndpoint : std::int32_t
    {
        Default = 0,
        Speaker = 1,
        Handsfree = 2,
    };
    enum class PhoneCallDirection : std::int32_t
    {
        Incoming = 0,
        Outgoing = 1,
    };
    enum class PhoneCallState : std::int32_t
    {
        Unknown = 0,
        Ringing = 1,
        Talking = 2,
    ...
    enum class PhoneCallTransport : std::int32_t
    {
        Cellular = 0,
        Voip = 1,
    };
    enum class PhoneLineRegistrationState : std::int32_t
    {
        Disconnected = 0,
        Home = 1,
        Roaming = 2,
    };
    enum class PhoneMediaType : std::int32_t
    {
        AudioOnly = 0,
        AudioVideo = 1,
    };
    enum class PhoneNotificationType : std::int32_t
    {
        NewCall = 0,
        CallChanged = 1,
        LineChanged = 2,
    ...
    enum class PlaybackCommand : std::int32_t
    {
        Play = 0,
        Pause = 1,
        Stop = 2,
    ...
    enum class PlaybackStatus : std::int32_t
    {
        None = 0,
        TrackChanged = 1,
        Stopped = 2,
    ...
    enum class ReminderState : std::int32_t
    {
        Active = 0,
        Snoozed = 1,
        Dismissed = 2,
    };
    enum class VibrateState : std::int32_t
    {
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IAccessoryManager>
    {
        ...
        {
            virtual std::int32_t __stdcall RegisterAccessoryApp(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNextTriggerDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall ProcessTriggerDetails(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneLineDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPhoneLineDetails(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall AcceptPhoneCall(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall AcceptPhoneCallOnEndpoint(std::uint32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall AcceptPhoneCallWithVideo(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall AcceptPhoneCallWithVideoOnAudioEndpoint(std::uint32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall RejectPhoneCall(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall RejectPhoneCallWithText(std::uint32_t, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall MakePhoneCall(winrt::guid, void*) noexcept = 0;
            virtual std::int32_t __stdcall MakePhoneCallOnAudioEndpoint(winrt::guid, void*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall MakePhoneCallWithVideo(winrt::guid, void*) noexcept = 0;
            virtual std::int32_t __stdcall MakePhoneCallWithVideoOnAudioEndpoint(winrt::guid, void*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SwapPhoneCalls(std::uint32_t, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall HoldPhoneCall(std::uint32_t, bool) noexcept = 0;
            virtual std::int32_t __stdcall EndPhoneCall(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall put_PhoneMute(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneMute(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_PhoneCallAudioEndpoint(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneCallAudioEndpoint(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SnoozeAlarm(winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall SnoozeAlarmForSpecifiedTime(winrt::guid, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall DismissAlarm(winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall SnoozeReminder(winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall SnoozeReminderForSpecifiedTime(winrt::guid, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall DismissReminder(winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall GetMediaMetadata(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MediaPlaybackCapabilities(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MediaPlaybackStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall PerformMediaPlaybackCommand(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DoNotDisturbEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_DrivingModeEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_BatterySaverState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetApps(void**) noexcept = 0;
            virtual std::int32_t __stdcall EnableNotificationsForApplication(void*) noexcept = 0;
            virtual std::int32_t __stdcall DisableNotificationsForApplication(void*) noexcept = 0;
            virtual std::int32_t __stdcall IsNotificationEnabledForApplication(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetEnabledAccessoryNotificationTypes(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall EnableAccessoryNotificationTypes(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall DisableAllAccessoryNotificationTypes() noexcept = 0;
            virtual std::int32_t __stdcall GetUserConsent(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetAppIcon(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IAccessoryManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RingDevice() noexcept = 0;
            virtual std::int32_t __stdcall get_SpeedDialList(void**) noexcept = 0;
            virtual std::int32_t __stdcall ClearToast(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPhonePinLocked(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IncreaseVolume(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall DecreaseVolume(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetMute(bool) noexcept = 0;
            virtual std::int32_t __stdcall SetRingerVibrate(bool, bool) noexcept = 0;
            virtual std::int32_t __stdcall get_VolumeInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAllEmailAccounts(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFolders(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall EnableEmailNotificationEmailAccount(void*) noexcept = 0;
            virtual std::int32_t __stdcall DisableEmailNotificationEmailAccount(void*) noexcept = 0;
            virtual std::int32_t __stdcall EnableEmailNotificationFolderFilter(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateEmailReadStatus(void*, bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IAccessoryManager3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SnoozeAlarmByInstanceId(void*) noexcept = 0;
            virtual std::int32_t __stdcall DismissAlarmByInstanceId(void*) noexcept = 0;
            virtual std::int32_t __stdcall SnoozeReminderByInstanceId(void*) noexcept = 0;
            virtual std::int32_t __stdcall DismissReminderByInstanceId(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IAccessoryNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_TimeCreated(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AppDisplayName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AppId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AccessoryNotificationType(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_StartedProcessing(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_StartedProcessing(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IAlarmNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AlarmId(winrt::guid*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_ReminderState(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IAlarmNotificationTriggerDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InstanceId(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IBinaryId>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Id(std::uint8_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::ICalendarChangedNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EventType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ItemId(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::ICortanaTileNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_TileId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Content(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LargeContent1(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LargeContent2(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EmphasizedText(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NonWrappedSmallContent1(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NonWrappedSmallContent2(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NonWrappedSmallContent3(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NonWrappedSmallContent4(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IEmailAccountInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsNotificationEnabled(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IEmailNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ParentFolderName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SenderName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SenderAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EmailMessage(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Timestamp(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IEmailNotificationTriggerDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MessageEntryId(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IMediaControlsTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MediaMetadata(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IMediaMetadata>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Album(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Track(std::uint32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IPhoneCallDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PhoneLine(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CallId(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CallTransport(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CallMediaType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CallDirection(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_State(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ConferenceCallId(std::uint32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_PresetTextResponses(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IPhoneLineDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DisplayName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LineNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultOutgoingLine(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_VoicemailCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RegistrationState(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IPhoneLineDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MissedCallCount(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IPhoneNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PhoneNotificationType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CallDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneLineChangedId(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IReminderNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ReminderId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_Title(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::ISpeedDialEntry>
    {
        ...
        {
            virtual std::int32_t __stdcall get_PhoneNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NumberType(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ContactName(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IToastNotificationTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Text1(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Text2(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Text3(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Text4(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SuppressPopup(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Phone::Notification::Management::IVolumeInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SystemVolume(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CallVolume(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MediaVolume(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsMuted(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsVibrateEnabled(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Phone_Notification_Management_IAccessoryManager
    {
        ...
        auto AcceptPhoneCall(std::uint32_t phoneCallId) const;
        auto AcceptPhoneCall(std::uint32_t phoneCallId, winrt::Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint) const;
        auto AcceptPhoneCallWithVideo(std::uint32_t phoneCallId) const;
        auto AcceptPhoneCallWithVideo(std::uint32_t phoneCallId, winrt::Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint) const;
        auto RejectPhoneCall(std::uint32_t phoneCallId) const;
        auto RejectPhoneCall(std::uint32_t phoneCallId, std::uint32_t textResponseID) const;
        ...
        auto SwapPhoneCalls(std::uint32_t phoneCallIdToHold, std::uint32_t phoneCallIdOnHold) const;
        auto HoldPhoneCall(std::uint32_t phoneCallId, bool holdCall) const;
        auto EndPhoneCall(std::uint32_t phoneCallId) const;
        ...
        auto EnableAccessoryNotificationTypes(std::int32_t accessoryNotificationTypes) const;
    ...
    struct consume_Windows_Phone_Notification_Management_IAccessoryManager2
    {
        ...
        auto IncreaseVolume(std::int32_t step) const;
        auto DecreaseVolume(std::int32_t step) const;
