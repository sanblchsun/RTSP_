...
WINRT_EXPORT namespace winrt::Windows::Devices::Bluetooth::Advertisement
{
    ...
    struct WINRT_IMPL_EMPTY_BASES BluetoothLEAdvertisementBytePattern : winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementBytePattern
    {
        ...
        BluetoothLEAdvertisementBytePattern(std::uint8_t dataType, std::int16_t offset, winrt::Windows::Storage::Streams::IBuffer const& data);
    };
    struct WINRT_IMPL_EMPTY_BASES BluetoothLEAdvertisementDataSection : winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementDataSection
    {
        ...
        BluetoothLEAdvertisementDataSection(std::uint8_t dataType, winrt::Windows::Storage::Streams::IBuffer const& data);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES BluetoothLEManufacturerData : winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEManufacturerData
    {
        ...
        BluetoothLEManufacturerData(std::uint16_t companyId, winrt::Windows::Storage::Streams::IBuffer const& data);
    };
}
#endif
