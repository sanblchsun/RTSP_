...
{
    enum class CellularDtmfMode : std::int32_t
    {
        Continuous = 0,
        Burst = 1,
    };
    enum class PhoneAudioRoutingEndpoint : std::int32_t
    {
        Default = 0,
        Bluetooth = 1,
        Speakerphone = 2,
    };
    enum class PhoneCallHistoryEntryMedia : std::int32_t
    {
        Audio = 0,
        Video = 1,
    };
    enum class PhoneCallHistoryEntryOtherAppReadAccess : std::int32_t
    {
        Full = 0,
        SystemOnly = 1,
    };
    enum class PhoneCallHistoryEntryQueryDesiredMedia : std::uint32_t
    {
        None = 0,
        Audio = 0x1,
        Video = 0x2,
    ...
    enum class PhoneCallHistoryEntryRawAddressKind : std::int32_t
    {
        PhoneNumber = 0,
        Custom = 1,
    };
    enum class PhoneCallHistorySourceIdKind : std::int32_t
    {
        CellularPhoneLineId = 0,
        PackageFamilyName = 1,
    };
    enum class PhoneCallHistoryStoreAccessType : std::int32_t
    {
        AppEntriesReadWrite = 0,
        AllEntriesLimitedReadWrite = 1,
        AllEntriesReadWrite = 2,
    };
    enum class PhoneCallMedia : std::int32_t
    {
        Audio = 0,
        AudioAndVideo = 1,
        AudioAndRealTimeText = 2,
    };
    enum class PhoneLineNetworkOperatorDisplayTextLocation : std::int32_t
    {
        Default = 0,
        Tile = 1,
        Dialer = 2,
    ...
    enum class PhoneLineTransport : std::int32_t
    {
        Cellular = 0,
        VoipApp = 1,
        Bluetooth = 2,
    };
    enum class PhoneLineWatcherStatus : std::int32_t
    {
        Created = 0,
        Started = 1,
    ...
    enum class PhoneNetworkState : std::int32_t
    {
        Unknown = 0,
        NoSignal = 1,
        Deregistered = 2,
    ...
    enum class PhoneSimState : std::int32_t
    {
        Unknown = 0,
        PinNotRequired = 1,
        PinUnlocked = 2,
    ...
    enum class PhoneVoicemailType : std::int32_t
    {
        None = 0,
        Traditional = 1,
        Visual = 2,
    };
    enum class VoipPhoneCallMedia : std::uint32_t
    {
        None = 0,
        Audio = 0x1,
        Video = 0x2,
    };
    enum class VoipPhoneCallRejectReason : std::int32_t
    {
        UserIgnored = 0,
        TimedOut = 1,
        OtherIncomingCall = 2,
    ...
    enum class VoipPhoneCallResourceReservationStatus : std::int32_t
    {
        Success = 0,
        ResourcesNotAvailable = 1,
    };
    enum class VoipPhoneCallState : std::int32_t
    {
        Ended = 0,
        Held = 1,
        Active = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::ICallAnswerEventArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AcceptedMedia(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::ICallRejectEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RejectReason(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::ILockScreenCallUI>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Dismiss() noexcept = 0;
            virtual std::int32_t __stdcall add_EndRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_EndRequested(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_CallTitle(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CallTitle(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallBlockingStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BlockUnknownNumbers(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_BlockUnknownNumbers(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_BlockPrivateNumbers(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_BlockPrivateNumbers(bool) noexcept = 0;
            virtual std::int32_t __stdcall SetCallBlockingListAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallHistoryEntry>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsCallerIdBlocked(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsCallerIdBlocked(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsEmergency(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsEmergency(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsIncoming(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsIncoming(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsMissed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsMissed(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsRinging(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsRinging(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSeen(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSeen(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSuppressed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSuppressed(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsVoicemail(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsVoicemail(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Media(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Media(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_SourceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SourceId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SourceIdKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SourceIdKind(std::int32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallHistoryEntryAddress>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_RawAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RawAddress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_RawAddressKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RawAddressKind(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallHistoryEntryAddressFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Create(void*, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallHistoryEntryQueryOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DesiredMedia(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DesiredMedia(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SourceIds(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallHistoryStore>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetEntryAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetEntryReader(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetEntryReaderWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveEntryAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteEntryAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteEntriesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkEntryAsSeenAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkEntriesAsSeenAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetUnseenCountAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkAllAsSeenAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSourcesUnseenCountAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkSourcesAsSeenAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ShowPhoneCallUI(void*, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_CallStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CallStateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_IsCallActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsCallIncoming(bool*) noexcept = 0;
            virtual std::int32_t __stdcall ShowPhoneCallSettingsUI() noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallStore>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsEmergencyPhoneNumberAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDefaultLineAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestLineWatcher(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallVideoCapabilities>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsVideoCallingCapable(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneCallVideoCapabilitiesManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetCapabilitiesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneDialOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Contact(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ContactPhone(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ContactPhone(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Media(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Media(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioEndpoint(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioEndpoint(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLine>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_LineChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_LineChanged(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_NetworkState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Voicemail(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CellularDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Transport(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanDial(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportsTile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_VideoCallingCapabilities(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LineConfiguration(void**) noexcept = 0;
            virtual std::int32_t __stdcall IsImmediateDialNumberAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall Dial(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall DialWithOptions(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLine2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall EnableTextReply(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_TransportDeviceId(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineCellularDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SimState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SimSlotIndex(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsModemOn(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_RegistrationRejectCode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetNetworkOperatorDisplayText(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsVideoCallingEnabled(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromIdAsync(winrt::guid, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineTransportDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall RegisterApp() noexcept = 0;
            virtual std::int32_t __stdcall RegisterAppForUser(void*) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterApp() noexcept = 0;
            virtual std::int32_t __stdcall UnregisterAppForUser(void*) noexcept = 0;
            virtual std::int32_t __stdcall IsRegistered(bool*) noexcept = 0;
            virtual std::int32_t __stdcall Connect(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineTransportDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetDeviceSelectorForPhoneLineTransport(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineWatcher>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_LineAdded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_LineAdded(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_LineRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_LineRemoved(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_LineUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_LineUpdated(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneLineWatcherEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LineId(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IPhoneVoicemail>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Number(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MessageCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Type(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall DialVoicemailAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipCallCoordinator>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReserveCallResourcesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_MuteStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MuteStateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall RequestNewIncomingCall(void*, void*, void*, void*, void*, void*, void*, void*, std::uint32_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestNewOutgoingCall(void*, void*, void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall NotifyMuted() noexcept = 0;
            virtual std::int32_t __stdcall NotifyUnmuted() noexcept = 0;
            virtual std::int32_t __stdcall RequestOutgoingUpgradeToVideoCall(winrt::guid, void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestIncomingUpgradeToVideoCall(void*, void*, void*, void*, void*, void*, void*, void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall TerminateCellularCall(winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall CancelUpgrade(winrt::guid) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipCallCoordinator2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetupNewAcceptedCall(void*, void*, void*, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipCallCoordinator3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestNewAppInitiatedCall(void*, void*, void*, void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestNewIncomingCallWithContactRemoteId(void*, void*, void*, void*, void*, void*, void*, void*, std::uint32_t, std::int64_t, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipCallCoordinator4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReserveOneProcessCallResourcesAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_EndRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_EndRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_HoldRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_HoldRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ResumeRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ResumeRequested(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_RejectRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RejectRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall NotifyCallHeld() noexcept = 0;
            virtual std::int32_t __stdcall NotifyCallActive() noexcept = 0;
            virtual std::int32_t __stdcall NotifyCallEnded() noexcept = 0;
            virtual std::int32_t __stdcall get_ContactName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ContactName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_StartTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StartTime(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CallMedia(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CallMedia(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall NotifyCallReady() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryShowAppUI() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall NotifyCallAccepted(std::uint32_t) noexcept = 0;
        };
    };
    template <typename D>
