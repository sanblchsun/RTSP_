...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::AppointmentsProvider::IAddAppointmentOperation>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AppointmentInformation(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SourcePackageFamilyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportCompleted(void*) noexcept = 0;
            virtual std::int32_t __stdcall ReportCanceled() noexcept = 0;
            virtual std::int32_t __stdcall ReportError(void*) noexcept = 0;
            virtual std::int32_t __stdcall DismissUI() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::AppointmentsProvider::IAppointmentsProviderLaunchActionVerbsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AddAppointment(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ReplaceAppointment(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoveAppointment(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ShowTimeFrame(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::AppointmentsProvider::IAppointmentsProviderLaunchActionVerbsStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ShowAppointmentDetails(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::AppointmentsProvider::IRemoveAppointmentOperation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AppointmentId(void**) noexcept = 0;
