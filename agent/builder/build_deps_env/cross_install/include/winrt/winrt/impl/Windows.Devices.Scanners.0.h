...
{
    enum class ImageScannerAutoCroppingMode : std::int32_t
    {
        Disabled = 0,
        SingleRegion = 1,
        MultipleRegion = 2,
    };
    enum class ImageScannerColorMode : std::int32_t
    {
        Color = 0,
        Grayscale = 1,
        Monochrome = 2,
    ...
    enum class ImageScannerFormat : std::int32_t
    {
        Jpeg = 0,
        Png = 1,
    ...
    enum class ImageScannerScanSource : std::int32_t
    {
        Default = 0,
        Flatbed = 1,
        Feeder = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Scanners::IImageScanner>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DefaultScanSource(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall IsScanSourceSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_FlatbedConfiguration(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FeederConfiguration(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoConfiguration(void**) noexcept = 0;
            virtual std::int32_t __stdcall IsPreviewSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall ScanPreviewToStreamAsync(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ScanFilesToFolderAsync(std::int32_t, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Scanners::IImageScannerFeederConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanAutoDetectPageSize(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoDetectPageSize(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoDetectPageSize(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_PageSize(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PageSize(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PageOrientation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PageOrientation(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PageSizeDimensions(winrt::Windows::Foundation::Size*) noexcept = 0;
            virtual std::int32_t __stdcall IsPageSizeSupported(std::int32_t, std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxNumberOfPages(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxNumberOfPages(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CanScanDuplex(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Duplex(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_Duplex(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanScanAhead(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ScanAhead(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ScanAhead(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Scanners::IImageScannerFormatConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DefaultFormat(std::int32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall IsFormatSupported(std::int32_t, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Scanners::IImageScannerScanResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ScannedFiles(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Scanners::IImageScannerSourceConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MinScanArea(winrt::Windows::Foundation::Size*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxScanArea(winrt::Windows::Foundation::Size*) noexcept = 0;
            virtual std::int32_t __stdcall get_SelectedScanRegion(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall put_SelectedScanRegion(winrt::Windows::Foundation::Rect) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoCroppingMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoCroppingMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall IsAutoCroppingModeSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual std::int32_t __stdcall get_OpticalResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual std::int32_t __stdcall get_DesiredResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual std::int32_t __stdcall put_DesiredResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution) noexcept = 0;
            virtual std::int32_t __stdcall get_ActualResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultColorMode(std::int32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall IsColorModeSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinBrightness(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxBrightness(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BrightnessStep(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultBrightness(std::int32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_MinContrast(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxContrast(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ContrastStep(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultContrast(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Contrast(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Contrast(std::int32_t) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Scanners_IImageScannerFeederConfiguration
    {
        ...
        auto MaxNumberOfPages(std::uint32_t value) const;
    ...
    struct consume_Windows_Devices_Scanners_IImageScannerSourceConfiguration
    {
        ...
        auto Contrast(std::int32_t value) const;
    };
