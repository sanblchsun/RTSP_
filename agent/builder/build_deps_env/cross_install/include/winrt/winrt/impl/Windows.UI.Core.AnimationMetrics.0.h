...
{
    enum class AnimationEffect : std::int32_t
    {
        Expand = 0,
        Collapse = 1,
        Reposition = 2,
    ...
    enum class AnimationEffectTarget : std::int32_t
    {
        Primary = 0,
        Added = 1,
        Affected = 2,
    ...
    enum class PropertyAnimationType : std::int32_t
    {
        Scale = 0,
        Translation = 1,
        Opacity = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Core::AnimationMetrics::IAnimationDescription>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Animations(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_StaggerDelay(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_StaggerDelayFactor(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_DelayLimit(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ZOrder(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Core::AnimationMetrics::IOpacityAnimation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InitialOpacity(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FinalOpacity(float*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Core::AnimationMetrics::IPropertyAnimation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Control1(winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall get_Control2(winrt::Windows::Foundation::Point*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Core::AnimationMetrics::IScaleAnimation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InitialScaleX(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InitialScaleY(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FinalScaleX(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_FinalScaleY(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_NormalizedOrigin(winrt::Windows::Foundation::Point*) noexcept = 0;
        };
    };
    template <typename D>
