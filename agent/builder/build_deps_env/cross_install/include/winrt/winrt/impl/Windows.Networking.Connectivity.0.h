...
{
    enum class DomainNameType : std::int32_t;
    struct EndpointPair;
    struct HostName;
...
{
    enum class CellularApnAuthenticationType : std::int32_t
    {
        None = 0,
        Pap = 1,
        Chap = 2,
    ...
    enum class ConnectionProfileDeleteStatus : std::int32_t
    {
        Success = 0,
        DeniedByUser = 1,
        DeniedBySystem = 2,
    ...
    enum class DataUsageGranularity : std::int32_t
    {
        PerMinute = 0,
        PerHour = 1,
        PerDay = 2,
    ...
    enum class DomainConnectivityLevel : std::int32_t
    {
        None = 0,
        Unauthenticated = 1,
        Authenticated = 2,
    };
    enum class NetworkAuthenticationType : std::int32_t
    {
        None = 0,
        Unknown = 1,
        Open80211 = 2,
    ...
    enum class NetworkConnectivityLevel : std::int32_t
    {
        None = 0,
        LocalAccess = 1,
    ...
    enum class NetworkEncryptionType : std::int32_t
    {
        None = 0,
        Unknown = 1,
        Wep = 2,
    ...
    enum class NetworkTypes : std::uint32_t
    {
        None = 0,
        Internet = 0x1,
        PrivateNetwork = 0x2,
    };
    enum class RoamingStates : std::uint32_t
    {
        None = 0,
        NotRoaming = 0x1,
        Roaming = 0x2,
    };
    enum class TriStates : std::int32_t
    {
        DoNotCare = 0,
        No = 1,
        Yes = 2,
    };
    enum class WwanDataClass : std::uint32_t
    {
        None = 0,
        Gprs = 0x1,
        Edge = 0x2,
    ...
    enum class WwanNetworkIPKind : std::int32_t
    {
        None = 0,
        Ipv4 = 1,
        Ipv6 = 2,
    ...
    enum class WwanNetworkRegistrationState : std::int32_t
    {
        None = 0,
        Deregistered = 1,
        Searching = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::IAttributedNetworkUsage>
    {
        ...
        {
            virtual std::int32_t __stdcall get_BytesSent(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BytesReceived(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AttributionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AttributionName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AttributionThumbnail(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::ICellularApnContext>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_ProviderId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AccessPointName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AccessPointName(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsCompressionEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsCompressionEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AuthenticationType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AuthenticationType(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionCost>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NetworkCostType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Roaming(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_OverDataLimit(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ApproachingDataLimit(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionCost2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BackgroundDataUsageRestricted(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfile>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ProfileName(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNetworkConnectivityLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetNetworkNames(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConnectionCost(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDataPlanStatus(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkAdapter(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLocalUsage(std::int64_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLocalUsagePerRoamingStates(std::int64_t, std::int64_t, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkSecuritySettings(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfile2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsWwanConnectionProfile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsWlanConnectionProfile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_WwanConnectionProfileDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WlanConnectionProfileDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceProviderGuid(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSignalBars(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDomainConnectivityLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetNetworkUsageAsync(std::int64_t, std::int64_t, std::int32_t, struct struct_Windows_Networking_Connectivity_NetworkUsageStates, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConnectivityIntervalsAsync(std::int64_t, std::int64_t, struct struct_Windows_Networking_Connectivity_NetworkUsageStates, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfile3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAttributedNetworkUsageAsync(std::int64_t, std::int64_t, struct struct_Windows_Networking_Connectivity_NetworkUsageStates, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfile4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetProviderNetworkUsageAsync(std::int64_t, std::int64_t, struct struct_Windows_Networking_Connectivity_NetworkUsageStates, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfileFilter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_IsConnected(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsConnected(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsWwanConnectionProfile(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsWwanConnectionProfile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsWlanConnectionProfile(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsWlanConnectionProfile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_NetworkCostType(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkCostType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ServiceProviderGuid(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceProviderGuid(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfileFilter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_IsRoaming(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsRoaming(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IsOverDataLimit(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOverDataLimit(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IsBackgroundDataUsageRestricted(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsBackgroundDataUsageRestricted(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RawData(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfileFilter3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_PurposeGuid(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PurposeGuid(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ConnectionProfile(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectivityInterval>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ConnectionDuration(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectivityManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AcquireConnectionAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AddHttpRoutePolicy(void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveHttpRoutePolicy(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IDataPlanStatus>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DataPlanUsage(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DataLimitInMegabytes(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InboundBitsPerSecond(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OutboundBitsPerSecond(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NextBillingCycle(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxTransferSizeInMegabytes(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IDataPlanUsage>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MegabytesUsed(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LastSyncTime(std::int64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::IIPInformation>
    {
        ...
        {
            virtual std::int32_t __stdcall get_NetworkAdapter(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PrefixLength(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::ILanIdentifier>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InfrastructureId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PortId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkAdapterId(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::ILanIdentifierData>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Type(std::uint32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkAdapter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_OutboundMaxBitsPerSecond(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InboundMaxBitsPerSecond(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IanaInterfaceType(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkAdapterId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall GetConnectedProfileAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkInformationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetInternetConnectionProfile(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLanIdentifiers(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetHostNames(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetProxyConfigurationAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSortedEndpointPairs(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_NetworkStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NetworkStatusChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkInformationStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindConnectionProfilesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NetworkId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall GetNetworkTypes(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkSecuritySettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NetworkAuthenticationType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkEncryptionType(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkStateChangeEventDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_HasNewInternetConnectionProfile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNewConnectionCost(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNewNetworkConnectivityLevel(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNewDomainConnectivityLevel(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNewHostNameList(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNewWwanRegistrationState(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::INetworkStateChangeEventDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_HasNewTetheringOperationalState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasNewTetheringClientCount(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::IProxyConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ProxyUris(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanConnectDirectly(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IRoutePolicy>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HostNameType(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IRoutePolicyFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateRoutePolicy(void*, void*, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IWlanConnectionProfileDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetConnectedSsid(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IWwanConnectionProfileDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AccessPointName(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNetworkRegistrationState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentDataClass(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Connectivity::IWwanConnectionProfileDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IPKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PurposeGuids(void**) noexcept = 0;
        };
    };
