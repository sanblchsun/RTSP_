...
{
    enum class NotifyCollectionChangedAction : std::int32_t
    {
        Add = 0,
        Remove = 1,
        Replace = 2,
    ...
    enum class TypeKind : std::int32_t
    {
        Primitive = 0,
        Metadata = 1,
        Custom = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Xaml::Interop::IBindableVector>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAt(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Size(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetView(void**) noexcept = 0;
            virtual std::int32_t __stdcall IndexOf(void*, std::uint32_t*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetAt(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall InsertAt(std::uint32_t, void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::Xaml::Interop::INotifyCollectionChanged>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_CollectionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CollectionChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Xaml::Interop::INotifyCollectionChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_NewItems(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OldItems(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NewStartingIndex(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_OldStartingIndex(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Xaml::Interop::INotifyCollectionChangedEventArgsFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstanceWithAllParameters(std::int32_t, void*, void*, std::int32_t, std::int32_t, void*, void**, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Xaml_Interop_IBindableVector
    {
        ...
        auto GetView() const;
        auto IndexOf(winrt::Windows::Foundation::IInspectable const& value, std::uint32_t& index) const;
        auto SetAt(std::uint32_t index, winrt::Windows::Foundation::IInspectable const& value) const;
        auto InsertAt(std::uint32_t index, winrt::Windows::Foundation::IInspectable const& value) const;
