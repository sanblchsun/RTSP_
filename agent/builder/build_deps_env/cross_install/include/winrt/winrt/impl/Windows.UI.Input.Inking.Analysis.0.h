...
{
    enum class InkAnalysisDrawingKind : std::int32_t
    {
        Drawing = 0,
        Circle = 1,
        Ellipse = 2,
    ...
    enum class InkAnalysisNodeKind : std::int32_t
    {
        UnclassifiedInk = 0,
        Root = 1,
        WritingRegion = 2,
    ...
    enum class InkAnalysisStatus : std::int32_t
    {
        Updated = 0,
        Unchanged = 1,
    };
    enum class InkAnalysisStrokeKind : std::int32_t
    {
        Auto = 0,
        Writing = 1,
        Drawing = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalysisInkBullet>
    {
        ...
        {
            virtual std::int32_t __stdcall get_RecognizedText(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalysisInkDrawing>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DrawingKind(std::int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalysisInkWord>
    {
        ...
        {
            virtual std::int32_t __stdcall get_RecognizedText(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TextAlternates(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalysisLine>
    {
        ...
        {
            virtual std::int32_t __stdcall get_RecognizedText(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IndentLevel(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalysisNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_RotatedBoundingRect(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Children(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Parent(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStrokeIds(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalysisRoot>
    {
        ...
        {
            virtual std::int32_t __stdcall get_RecognizedText(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindNodes(std::int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalyzer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AnalysisRoot(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsAnalyzing(bool*) noexcept = 0;
            virtual std::int32_t __stdcall AddDataForStroke(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddDataForStrokes(void*) noexcept = 0;
            virtual std::int32_t __stdcall ClearDataForAllStrokes() noexcept = 0;
            virtual std::int32_t __stdcall RemoveDataForStroke(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall RemoveDataForStrokes(void*) noexcept = 0;
            virtual std::int32_t __stdcall ReplaceDataForStroke(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetStrokeDataKind(std::uint32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall AnalyzeAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Input::Inking::Analysis::IInkAnalyzerFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateAnalyzer(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_UI_Input_Inking_Analysis_IInkAnalyzer
    {
        ...
        auto RemoveDataForStroke(std::uint32_t strokeId) const;
        auto RemoveDataForStrokes(param::iterable<std::uint32_t> const& strokeIds) const;
        auto ReplaceDataForStroke(winrt::Windows::UI::Input::Inking::InkStroke const& stroke) const;
        auto SetStrokeDataKind(std::uint32_t strokeId, winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisStrokeKind const& strokeKind) const;
