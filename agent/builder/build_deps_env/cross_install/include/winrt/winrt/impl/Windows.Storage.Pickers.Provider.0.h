...
{
    enum class AddFileResult : std::int32_t
    {
        Added = 0,
        AlreadyAdded = 1,
        NotAllowed = 2,
    ...
    enum class FileSelectionMode : std::int32_t
    {
        Single = 0,
        Multiple = 1,
    };
    enum class SetFileNameResult : std::int32_t
    {
        Succeeded = 0,
        NotAllowed = 1,
        Unavailable = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Storage::Pickers::Provider::IFileOpenPickerUI>
    {
        ...
        {
            virtual std::int32_t __stdcall AddFile(void*, void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveFile(void*) noexcept = 0;
            virtual std::int32_t __stdcall ContainsFile(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall CanAddFile(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowedFileTypes(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SelectionMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SettingsIdentifier(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Title(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Title(void*) noexcept = 0;
            virtual std::int32_t __stdcall add_FileRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_FileRemoved(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::Pickers::Provider::IFileSavePickerUI>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall TrySetFileName(void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_FileNameChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_FileNameChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_TargetFileRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TargetFileRequested(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Storage::Pickers::Provider::IPickerClosingEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ClosingOperation(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::Pickers::Provider::ITargetFileRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_TargetFile(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TargetFile(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
        };
    };
