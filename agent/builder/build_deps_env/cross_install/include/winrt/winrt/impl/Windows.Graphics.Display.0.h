...
{
    enum class AdvancedColorKind : std::int32_t
    {
        StandardDynamicRange = 0,
        WideColorGamut = 1,
        HighDynamicRange = 2,
    };
    enum class DisplayBrightnessOverrideOptions : std::uint32_t
    {
        None = 0,
        UseDimmedPolicyWhenBatteryIsLow = 0x1,
    };
    enum class DisplayBrightnessOverrideScenario : std::int32_t
    {
        IdleBrightness = 0,
        BarcodeReadingBrightness = 1,
        FullBrightness = 2,
    };
    enum class DisplayBrightnessScenario : std::int32_t
    {
        DefaultBrightness = 0,
        IdleBrightness = 1,
    ...
    enum class DisplayColorOverrideScenario : std::int32_t
    {
        Accurate = 0,
    };
    ...
    enum class HdrMetadataFormat : std::int32_t
    {
        Hdr10 = 0,
        Hdr10Plus = 1,
    };
    enum class ResolutionScale : std::int32_t
    {
        Invalid = 0,
        Scale100Percent = 100,
        Scale120Percent = 120,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Graphics::Display::IAdvancedColorInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_CurrentAdvancedColorKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RedPrimary(winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall get_GreenPrimary(winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall get_BluePrimary(winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall get_WhitePoint(winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxLuminanceInNits(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinLuminanceInNits(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxAverageFullFrameLuminanceInNits(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_SdrWhiteLevelInNits(float*) noexcept = 0;
            virtual std::int32_t __stdcall IsHdrMetadataFormatCurrentlySupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsAdvancedColorKindAvailable(std::int32_t, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IBrightnessOverride>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsOverrideActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_BrightnessLevel(double*) noexcept = 0;
            virtual std::int32_t __stdcall SetBrightnessLevel(double, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetBrightnessScenario(std::int32_t, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetLevelForScenario(std::int32_t, double*) noexcept = 0;
            virtual std::int32_t __stdcall StartOverride() noexcept = 0;
            virtual std::int32_t __stdcall StopOverride() noexcept = 0;
            virtual std::int32_t __stdcall add_IsSupportedChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsSupportedChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_IsOverrideActiveChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsOverrideActiveChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BrightnessLevelChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BrightnessLevelChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IBrightnessOverrideSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DesiredLevel(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_DesiredNits(float*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IBrightnessOverrideSettingsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromLevel(double, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromNits(float, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromDisplayBrightnessOverrideScenario(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IBrightnessOverrideStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDefaultForSystem(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetForCurrentView(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveForSystemAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IColorOverrideSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DesiredDisplayColorOverrideScenario(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IColorOverrideSettingsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromDisplayColorOverrideScenario(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayEnhancementOverride>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ColorOverrideSettings(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ColorOverrideSettings(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_BrightnessOverrideSettings(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_BrightnessOverrideSettings(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanOverride(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOverrideActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentDisplayEnhancementOverrideCapabilities(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestOverride() noexcept = 0;
            virtual std::int32_t __stdcall StopOverride() noexcept = 0;
            virtual std::int32_t __stdcall add_CanOverrideChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CanOverrideChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_IsOverrideActiveChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsOverrideActiveChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_DisplayEnhancementOverrideCapabilitiesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DisplayEnhancementOverrideCapabilitiesChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayEnhancementOverrideCapabilities>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsBrightnessControlSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsBrightnessNitsControlSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetSupportedNitRanges(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CurrentOrientation(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NativeOrientation(std::uint32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_ResolutionScale(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LogicalDpi(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_RawDpiX(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_RawDpiY(float*) noexcept = 0;
            virtual std::int32_t __stdcall add_DpiChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DpiChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_StereoEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_StereoEnabledChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_StereoEnabledChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetColorProfileAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_ColorProfileChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ColorProfileChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayInformation2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RawPixelsPerViewPixel(double*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayInformation3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DiagonalSizeInInches(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayInformation4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ScreenWidthInRawPixels(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ScreenHeightInRawPixels(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayInformation5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAdvancedColorInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_AdvancedColorInfoChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AdvancedColorInfoChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayInformationStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall GetForCurrentView(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoRotationPreferences(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoRotationPreferences(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall add_DisplayContentsInvalidated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DisplayContentsInvalidated(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::IDisplayPropertiesStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ResolutionScale(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LogicalDpi(float*) noexcept = 0;
            virtual std::int32_t __stdcall add_LogicalDpiChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_LogicalDpiChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_StereoEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_StereoEnabledChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_StereoEnabledChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetColorProfileAsync(void**) noexcept = 0;
