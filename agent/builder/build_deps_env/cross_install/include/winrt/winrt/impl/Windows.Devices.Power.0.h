...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Power::IBattery>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_ReportUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ReportUpdated(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Power::IBatteryReport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ChargeRateInMilliwatts(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DesignCapacityInMilliwattHours(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FullChargeCapacityInMilliwattHours(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RemainingCapacityInMilliwattHours(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Power::IBatteryStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AggregateBattery(void**) noexcept = 0;
