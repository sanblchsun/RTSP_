...
{
    enum class ActivationSignalDetectionTrainingDataFormat : std::int32_t
    {
        Voice8kHz8BitMono = 0,
    ...
    enum class ActivationSignalDetectorKind : std::int32_t
    {
        AudioPattern = 0,
        AudioImpulse = 1,
        HardwareEvent = 2,
    };
    enum class ActivationSignalDetectorPowerState : std::int32_t
    {
        HighPower = 0,
        ConnectedLowPower = 1,
        DisconnectedLowPower = 2,
    };
    enum class ConversationalAgentSessionUpdateResponse : std::int32_t
    {
        Success = 0,
        Failed = 1,
    };
    enum class ConversationalAgentState : std::int32_t
    {
        Inactive = 0,
        Detecting = 1,
        Listening = 2,
    ...
    enum class ConversationalAgentSystemStateChangeType : std::int32_t
    {
    ...
    enum class DetectionConfigurationAvailabilityChangeKind : std::int32_t
    {
        SystemResourceAccess = 0,
        Permission = 1,
        LockScreenPermission = 2,
    };
    enum class DetectionConfigurationTrainingStatus : std::int32_t
    {
        Success = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IActivationSignalDetectionConfiguration>
    {
        ...
        {
            virtual std::int32_t __stdcall get_SignalId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ModelId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall SetEnabledAsync(bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AvailabilityInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_AvailabilityChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AvailabilityChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall SetModelData(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetModelDataAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetModelDataType(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetModelDataTypeAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetModelData(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetModelDataAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ClearModelData() noexcept = 0;
            virtual std::int32_t __stdcall ClearModelDataAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TrainingStepsCompleted(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrainingStepsRemaining(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrainingDataFormat(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ApplyTrainingData(std::int32_t, void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ApplyTrainingDataAsync(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ClearTrainingData() noexcept = 0;
            virtual std::int32_t __stdcall ClearTrainingDataAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IActivationSignalDetector>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CanCreateConfigurations(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedModelDataTypes(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedTrainingDataFormats(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedPowerStates(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSupportedModelIdsForSignalId(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSupportedModelIdsForSignalIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateConfiguration(void*, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall CreateConfigurationAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConfigurations(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConfigurationsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConfiguration(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConfigurationAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveConfiguration(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveConfigurationAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentDetectorManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAllActivationSignalDetectors(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAllActivationSignalDetectorsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetActivationSignalDetectors(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetActivationSignalDetectorsAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentDetectorManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Default(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_SessionInterrupted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionInterrupted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SignalDetected(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SignalDetected(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SystemStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SystemStateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_AgentState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Signal(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsIndicatorLightAvailable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsScreenAvailable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsUserAuthenticated(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsVoiceActivationAvailable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInterruptible(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInterrupted(bool*) noexcept = 0;
            virtual std::int32_t __stdcall RequestInterruptibleAsync(bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestInterruptible(bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RequestAgentStateChangeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestAgentStateChange(std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RequestForegroundActivationAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestForegroundActivation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetAudioClientAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAudioClient(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateAudioDeviceInputNodeAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateAudioDeviceInputNode(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAudioCaptureDeviceIdAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAudioCaptureDeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAudioRenderDeviceIdAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAudioRenderDeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSignalModelIdAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSignalModelId(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetSignalModelIdAsync(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetSignalModelId(std::uint32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetSupportedSignalModelIdsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSupportedSignalModelIds(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSessionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetCurrentSessionAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentSessionSync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSignal>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsSignalVerificationRequired(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSignalVerificationRequired(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_SignalId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SignalId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SignalName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SignalName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SignalContext(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SignalContext(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SignalStart(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SignalStart(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SignalEnd(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SignalEnd(std::int64_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSystemStateChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SystemStateChangeType(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IDetectionConfigurationAvailabilityInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HasSystemResourceAccess(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasPermission(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasLockScreenPermission(bool*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_ApplicationModel_ConversationalAgent_IConversationalAgentSession
    {
        ...
        auto SetSignalModelIdAsync(std::uint32_t signalModelId) const;
        auto SetSignalModelId(std::uint32_t signalModelId) const;
