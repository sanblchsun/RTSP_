...
{
    enum class EasDisallowConvenienceLogonResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasEncryptionProviderType : std::int32_t
    {
        NotEvaluated = 0,
        WindowsEncryption = 1,
        OtherEncryption = 2,
    };
    enum class EasMaxInactivityTimeLockResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasMaxPasswordFailedAttemptsResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasMinPasswordComplexCharactersResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasMinPasswordLengthResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasPasswordExpirationResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasPasswordHistoryResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
    ...
    enum class EasRequireEncryptionResult : std::int32_t
    {
        NotEvaluated = 0,
        Compliant = 1,
        CanBeCompliant = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::ExchangeActiveSyncProvisioning::IEasClientDeviceInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_OperatingSystem(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FriendlyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SystemManufacturer(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SystemProductName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SystemSku(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::ExchangeActiveSyncProvisioning::IEasClientDeviceInformation2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SystemHardwareVersion(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SystemFirmwareVersion(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::ExchangeActiveSyncProvisioning::IEasClientSecurityPolicy>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RequireEncryption(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_RequireEncryption(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MinPasswordLength(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MinPasswordLength(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DisallowConvenienceLogon(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_DisallowConvenienceLogon(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MinPasswordComplexCharacters(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MinPasswordComplexCharacters(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PasswordExpiration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PasswordExpiration(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PasswordHistory(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PasswordHistory(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxPasswordFailedAttempts(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxPasswordFailedAttempts(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxInactivityTimeLock(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxInactivityTimeLock(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall CheckCompliance(void**) noexcept = 0;
            virtual std::int32_t __stdcall ApplyAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::ExchangeActiveSyncProvisioning::IEasComplianceResults>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Compliant(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_RequireEncryptionResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinPasswordLengthResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DisallowConvenienceLogonResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinPasswordComplexCharactersResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PasswordExpirationResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PasswordHistoryResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxPasswordFailedAttemptsResult(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxInactivityTimeLockResult(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::ExchangeActiveSyncProvisioning::IEasComplianceResults2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EncryptionProviderType(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Security_ExchangeActiveSyncProvisioning_IEasClientSecurityPolicy
    {
        ...
        auto MinPasswordLength(std::uint8_t value) const;
        ...
        auto MinPasswordComplexCharacters(std::uint8_t value) const;
        ...
        auto PasswordHistory(std::uint32_t value) const;
        [[nodiscard]] auto MaxPasswordFailedAttempts() const;
        auto MaxPasswordFailedAttempts(std::uint8_t value) const;
