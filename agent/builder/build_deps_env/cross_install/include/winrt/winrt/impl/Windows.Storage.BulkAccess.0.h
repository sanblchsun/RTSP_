...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Storage::BulkAccess::IFileInformationFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetVirtualizedItemsVector(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetVirtualizedFilesVector(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetVirtualizedFoldersVector(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::BulkAccess::IFileInformationFactoryFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithMode(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithModeAndSize(void*, std::int32_t, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithModeAndSizeAndOptions(void*, std::int32_t, std::uint32_t, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithModeAndSizeAndOptionsAndFlags(void*, std::int32_t, std::uint32_t, std::uint32_t, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::BulkAccess::IStorageItemInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DocumentProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_BasicProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Thumbnail(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_ThumbnailUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ThumbnailUpdated(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PropertiesUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PropertiesUpdated(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Storage_BulkAccess_IFileInformationFactory
    {
        ...
        auto GetFilesAsync(std::uint32_t startIndex, std::uint32_t maxItemsToRetrieve) const;
        auto GetFilesAsync() const;
        auto GetFoldersAsync(std::uint32_t startIndex, std::uint32_t maxItemsToRetrieve) const;
    ...
    struct consume_Windows_Storage_BulkAccess_IFileInformationFactoryFactory
    {
        ...
        auto CreateWithModeAndSize(winrt::Windows::Storage::Search::IStorageQueryResultBase const& queryResult, winrt::Windows::Storage::FileProperties::ThumbnailMode const& mode, std::uint32_t requestedThumbnailSize) const;
        auto CreateWithModeAndSizeAndOptions(winrt::Windows::Storage::Search::IStorageQueryResultBase const& queryResult, winrt::Windows::Storage::FileProperties::ThumbnailMode const& mode, std::uint32_t requestedThumbnailSize, winrt::Windows::Storage::FileProperties::ThumbnailOptions const& thumbnailOptions) const;
