...
{
    enum class UserDataAvailability : std::int32_t
    {
        Always = 0,
        AfterFirstUnlock = 1,
        WhileUnlocked = 2,
    };
    enum class UserDataBufferUnprotectStatus : std::int32_t
    {
        Succeeded = 0,
        Unavailable = 1,
    };
    enum class UserDataStorageItemProtectionStatus : std::int32_t
    {
        Succeeded = 0,
        NotProtectable = 1,
        DataUnavailable = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::DataProtection::IUserDataBufferUnprotectResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UnprotectedBuffer(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::DataProtection::IUserDataProtectionManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ProtectStorageItemAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStorageItemProtectionInfoAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ProtectBufferAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall UnprotectBufferAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall IsContinuedDataAvailabilityExpected(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_DataAvailabilityStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DataAvailabilityStateChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::DataProtection::IUserDataProtectionManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryGetDefault(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetForUser(void*, void**) noexcept = 0;
        };
    };
