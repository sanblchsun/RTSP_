...
{
    enum class ProviderAdcChannelMode : std::int32_t
    {
        SingleEnded = 0,
        Differential = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Adc::Provider::IAdcControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall AcquireChannel(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReleaseChannel(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReadValue(std::int32_t, std::int32_t*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Adc_Provider_IAdcControllerProvider
    {
        ...
        auto AcquireChannel(std::int32_t channel) const;
        auto ReleaseChannel(std::int32_t channel) const;
        auto ReadValue(std::int32_t channelNumber) const;
    };
