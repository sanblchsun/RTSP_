...
WINRT_EXPORT namespace winrt::Windows::Web::Http
{
    struct HttpProgress
    {
        ...
        winrt::Windows::Foundation::IReference<std::uint64_t> TotalBytesToSend {};
        std::uint64_t BytesReceived {};
        winrt::Windows::Foundation::IReference<std::uint64_t> TotalBytesToReceive {};
        ...
        impl::require<HttpBufferContent, winrt::Windows::Foundation::IStringable>
    {
        ...
        HttpBufferContent(winrt::Windows::Storage::Streams::IBuffer const& content, std::uint32_t offset, std::uint32_t count);
    };
