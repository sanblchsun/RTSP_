...
{
    enum class AuthenticationProtocol : std::int32_t
    {
        Basic = 0,
        Digest = 1,
        Ntlm = 2,
    ...
    enum class CredentialSaveOption : std::int32_t
    {
        Unselected = 0,
        Selected = 1,
        Hidden = 2,
    };
    enum class UserConsentVerificationResult : std::int32_t
    {
        Verified = 0,
        DeviceNotPresent = 1,
    ...
    enum class UserConsentVerifierAvailability : std::int32_t
    {
        Available = 0,
        DeviceNotPresent = 1,
        NotConfiguredForUser = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Credentials::UI::ICredentialPickerOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_ErrorCode(std::uint32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall put_AuthenticationProtocol(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AuthenticationProtocol(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CustomAuthenticationProtocol(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomAuthenticationProtocol(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PreviousCredential(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreviousCredential(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AlwaysDisplayDialog(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AlwaysDisplayDialog(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CallerSavesCredential(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CallerSavesCredential(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CredentialSaveOption(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CredentialSaveOption(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Credentials::UI::ICredentialPickerResults>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ErrorCode(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CredentialSaveOption(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CredentialSaved(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Credential(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CredentialDomainName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CredentialUserName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CredentialPassword(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Credentials::UI::ICredentialPickerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall PickWithOptionsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall PickWithMessageAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall PickWithCaptionAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Credentials::UI::IUserConsentVerifierStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CheckAvailabilityAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestVerificationAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Security_Credentials_UI_ICredentialPickerOptions
    {
        ...
        auto ErrorCode(std::uint32_t value) const;
