...
{
    enum class AppCapabilityAccessStatus : std::int32_t
    {
        DeniedBySystem = 0,
        NotDeclaredByApp = 1,
        DeniedByUser = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Authorization::AppCapabilityAccess::IAppCapability>
    {
        ...
        {
            virtual std::int32_t __stdcall get_CapabilityName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_User(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestAccessAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall CheckAccess(std::int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Authorization::AppCapabilityAccess::IAppCapabilityStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestAccessForCapabilitiesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestAccessForCapabilitiesForUserAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall Create(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithProcessIdForUser(void*, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Security_Authorization_AppCapabilityAccess_IAppCapabilityStatics
    {
        ...
        auto CreateWithProcessIdForUser(winrt::Windows::System::User const& user, param::hstring const& capabilityName, std::uint32_t pid) const;
    };
