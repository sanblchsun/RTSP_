...
{
    enum class EnterpriseEnrollmentStatus : std::int32_t
    {
        Success = 0,
        CancelledByUser = 1,
        UnknownFailure = 2,
    };
    enum class EnterpriseStatus : std::int32_t
    {
        Enrolled = 0,
        Disabled = 1,
        Revoked = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::Management::Deployment::IEnterprise>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_WorkplaceId(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EnrollmentValidFrom(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EnrollmentValidTo(std::int64_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::Management::Deployment::IEnterpriseEnrollmentManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EnrolledEnterprises(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentEnterprise(void**) noexcept = 0;
            virtual std::int32_t __stdcall ValidateEnterprisesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestEnrollmentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestUnenrollmentAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Management::Deployment::IEnterpriseEnrollmentResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EnrolledEnterprise(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::Management::Deployment::IInstallationManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall AddPackagePreloadedAsync(void*, void*, void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPendingPackageInstalls(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindPackagesForCurrentPublisher(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::Management::Deployment::IInstallationManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RemovePackageAsync(void*, std::uint32_t, void**) noexcept = 0;
