...
{
    enum class HandJointKind : std::int32_t
    {
        Palm = 0,
        Wrist = 1,
        ThumbMetacarpal = 2,
    ...
    enum class JointPoseAccuracy : std::int32_t
    {
        High = 0,
        Approximate = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Perception::People::IEyesPose>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsCalibrationValid(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Gaze(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UpdateTimestamp(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Perception::People::IHandMeshObserver>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_TriangleIndexCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_VertexCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetTriangleIndices(std::uint32_t, std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetVertexStateForPose(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NeutralPose(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NeutralPoseVersion(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ModelId(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::People::IHandMeshVertexState>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetVertices(std::uint32_t, struct struct_Windows_Perception_People_HandMeshVertex*) noexcept = 0;
            virtual std::int32_t __stdcall get_UpdateTimestamp(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::People::IHandPose>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryGetJoint(void*, std::int32_t, struct struct_Windows_Perception_People_JointPose*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TryGetJoints(void*, std::uint32_t, std::int32_t*, std::uint32_t, struct struct_Windows_Perception_People_JointPose*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetRelativeJoint(std::int32_t, std::int32_t, struct struct_Windows_Perception_People_JointPose*) noexcept = 0;
            virtual std::int32_t __stdcall GetRelativeJoints(std::uint32_t, std::int32_t*, std::uint32_t, std::int32_t*, std::uint32_t, struct struct_Windows_Perception_People_JointPose*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Perception_People_IHandMeshObserver
    {
        ...
        auto GetTriangleIndices(array_view<std::uint16_t> indices) const;
