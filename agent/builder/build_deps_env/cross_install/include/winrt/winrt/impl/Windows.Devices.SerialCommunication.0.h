...
{
    enum class SerialError : std::int32_t
    {
        Frame = 0,
        BufferOverrun = 1,
        ReceiveFull = 2,
    ...
    enum class SerialHandshake : std::int32_t
    {
        None = 0,
        RequestToSend = 1,
        XOnXOff = 2,
    ...
    enum class SerialParity : std::int32_t
    {
        None = 0,
        Odd = 1,
        Even = 2,
    ...
    enum class SerialPinChange : std::int32_t
    {
        BreakSignal = 0,
        CarrierDetect = 1,
        ClearToSend = 2,
    ...
    enum class SerialStopBitCount : std::int32_t
    {
        One = 0,
        OnePointFive = 1,
        Two = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::SerialCommunication::IPinChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PinChange(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::SerialCommunication::ISerialDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BaudRate(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_BaudRate(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_BreakSignalState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_BreakSignalState(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_BytesReceived(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CarrierDetectState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ClearToSendState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_DataBits(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DataBits(std::uint16_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DataSetReadyState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Handshake(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Handshake(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDataTerminalReadyEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsDataTerminalReadyEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsRequestToSendEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsRequestToSendEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Parity(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Parity(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PortName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ReadTimeout(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReadTimeout(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_StopBits(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StopBits(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_UsbVendorId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsbProductId(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_WriteTimeout(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_WriteTimeout(std::int64_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_ErrorReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ErrorReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PinChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PinChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::SerialCommunication::ISerialDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetDeviceSelectorFromPortName(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorFromUsbVidPid(std::uint16_t, std::uint16_t, void**) noexcept = 0;
    ...
    struct consume_Windows_Devices_SerialCommunication_ISerialDevice
    {
        ...
        auto BaudRate(std::uint32_t value) const;
        ...
        auto DataBits(std::uint16_t value) const;
    ...
    struct consume_Windows_Devices_SerialCommunication_ISerialDeviceStatics
    {
        ...
        auto GetDeviceSelectorFromUsbVidPid(std::uint16_t vendorId, std::uint16_t productId) const;
