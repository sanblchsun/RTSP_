...
WINRT_EXPORT namespace winrt::Windows::Storage
{
    ...
    struct FileIO
    {
        ...
        static auto WriteBytesAsync(winrt::Windows::Storage::IStorageFile const& file, array_view<std::uint8_t const> buffer);
    };
    struct KnownFolders
    {
        KnownFolders() = delete;
    ...
    struct PathIO
    {
        ...
        static auto WriteBytesAsync(param::hstring const& absolutePath, array_view<std::uint8_t const> buffer);
    };
