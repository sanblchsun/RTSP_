...
{
    enum class CoreDragUIContentMode : std::uint32_t
    {
        Auto = 0,
        Deferred = 0x1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragDropManager>
    {
        ...
        {
            virtual std::int32_t __stdcall add_TargetRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TargetRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_AreConcurrentOperationsEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AreConcurrentOperationsEnabled(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragOperation>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Data(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetPointerId(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetDragUIContentFromSoftwareBitmap(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetDragUIContentFromSoftwareBitmapWithAnchorPoint(void*, winrt::Windows::Foundation::Point) noexcept = 0;
            virtual std::int32_t __stdcall get_DragUIContentMode(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DragUIContentMode(std::uint32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDropOperationTarget>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall EnterAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall OverAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall LeaveAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DropAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDropOperationTargetRequestedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetTarget(void*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        [[nodiscard]] auto Data() const;
        auto SetPointerId(std::uint32_t pointerId) const;
