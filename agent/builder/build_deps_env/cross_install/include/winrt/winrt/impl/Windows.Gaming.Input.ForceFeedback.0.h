...
{
    enum class ConditionForceEffectKind : std::int32_t
    {
        Spring = 0,
        Damper = 1,
        Inertia = 2,
    ...
    enum class ForceFeedbackEffectAxes : std::uint32_t
    {
        None = 0,
        X = 0x1,
        Y = 0x2,
    ...
    enum class ForceFeedbackEffectState : std::int32_t
    {
        Stopped = 0,
        Running = 1,
        Paused = 2,
    ...
    enum class ForceFeedbackLoadEffectResult : std::int32_t
    {
        Succeeded = 0,
        EffectStorageFull = 1,
        EffectNotSupported = 2,
    };
    enum class PeriodicForceEffectKind : std::int32_t
    {
        SquareWave = 0,
        SineWave = 1,
        TriangleWave = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::ForceFeedback::IConditionForceEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SetParameters(winrt::Windows::Foundation::Numerics::float3, float, float, float, float, float, float) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::ForceFeedback::IConstantForceEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetParameters(winrt::Windows::Foundation::Numerics::float3, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall SetParametersWithEnvelope(winrt::Windows::Foundation::Numerics::float3, float, float, float, std::int64_t, std::int64_t, std::int64_t, std::int64_t, std::uint32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::ForceFeedback::IForceFeedbackMotor>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AreEffectsPaused(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MasterGain(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_MasterGain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_IsEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedAxes(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall LoadEffectAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall PauseAllEffects() noexcept = 0;
            virtual std::int32_t __stdcall ResumeAllEffects() noexcept = 0;
            virtual std::int32_t __stdcall StopAllEffects() noexcept = 0;
            virtual std::int32_t __stdcall TryDisableAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryEnableAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryResetAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryUnloadEffectAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::ForceFeedback::IPeriodicForceEffect>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Kind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetParameters(winrt::Windows::Foundation::Numerics::float3, float, float, float, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall SetParametersWithEnvelope(winrt::Windows::Foundation::Numerics::float3, float, float, float, float, float, float, std::int64_t, std::int64_t, std::int64_t, std::int64_t, std::uint32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::ForceFeedback::IRampForceEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetParameters(winrt::Windows::Foundation::Numerics::float3, winrt::Windows::Foundation::Numerics::float3, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall SetParametersWithEnvelope(winrt::Windows::Foundation::Numerics::float3, winrt::Windows::Foundation::Numerics::float3, float, float, float, std::int64_t, std::int64_t, std::int64_t, std::int64_t, std::uint32_t) noexcept = 0;
        };
    };
    template <typename D>
