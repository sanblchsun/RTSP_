...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Payments::Provider::IPaymentAppCanMakePaymentTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ReportCanMakePaymentResult(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Payments::Provider::IPaymentAppManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RegisterAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Payments::Provider::IPaymentTransaction>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PaymentRequest(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PayerEmail(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PayerEmail(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PayerName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PayerName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PayerPhoneNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PayerPhoneNumber(void*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateShippingAddressAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateSelectedShippingOptionAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AcceptAsync(void*, void**) noexcept = 0;
