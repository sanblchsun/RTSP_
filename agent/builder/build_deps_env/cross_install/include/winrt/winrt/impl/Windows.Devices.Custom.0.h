...
{
    enum class DeviceAccessMode : std::int32_t
    {
        Read = 0,
        Write = 1,
        ReadWrite = 2,
    };
    enum class DeviceSharingMode : std::int32_t
    {
        Shared = 0,
        Exclusive = 1,
    };
    enum class IOControlAccessMode : std::int32_t
    {
        Any = 0,
        Read = 1,
        Write = 2,
    ...
    enum class IOControlBufferingMethod : std::int32_t
    {
        Buffered = 0,
        DirectInput = 1,
        DirectOutput = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Custom::ICustomDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SendIOControlAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySendIOControlAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Custom::ICustomDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDeviceSelector(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall FromIdAsync(void*, std::int32_t, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Custom::IIOControlCode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_BufferingMethod(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Function(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceType(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ControlCode(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Custom::IIOControlCodeFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateIOControlCode(std::uint16_t, std::uint16_t, std::int32_t, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Custom::IKnownDeviceTypesStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Unknown(std::uint16_t*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto CreateIOControlCode(std::uint16_t deviceType, std::uint16_t function, winrt::Windows::Devices::Custom::IOControlAccessMode const& accessMode, winrt::Windows::Devices::Custom::IOControlBufferingMethod const& bufferingMethod) const;
    };
