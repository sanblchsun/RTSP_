...
{
    enum class XboxLiveEndpointPairCreationBehaviors : std::uint32_t
    {
        None = 0,
        ReevaluatePath = 0x1,
    };
    enum class XboxLiveEndpointPairCreationStatus : std::int32_t
    {
        Succeeded = 0,
        NoLocalNetworks = 1,
    ...
    enum class XboxLiveEndpointPairState : std::int32_t
    {
        Invalid = 0,
        CreatingOutbound = 1,
        CreatingInbound = 2,
    ...
    enum class XboxLiveNetworkAccessKind : std::int32_t
    {
        Open = 0,
        Moderate = 1,
        Strict = 2,
    };
    enum class XboxLiveQualityOfServiceMeasurementStatus : std::int32_t
    {
        NotStarted = 0,
        InProgress = 1,
    ...
    enum class XboxLiveQualityOfServiceMetric : std::int32_t
    {
    ...
    enum class XboxLiveSocketKind : std::int32_t
    {
        None = 0,
        Datagram = 1,
        Stream = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveDeviceAddress>
    {
        ...
        {
            virtual std::int32_t __stdcall add_SnapshotChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SnapshotChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetSnapshotAsBase64(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSnapshotAsBuffer(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSnapshotAsBytes(std::uint32_t, std::uint8_t*, std::uint32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsLocal(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkAccessKind(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveDeviceAddressStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromSnapshotBase64(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromSnapshotBuffer(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromSnapshotBytes(std::uint32_t, std::uint8_t*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLocal(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxSnapshotBytesSize(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveEndpointPair>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetRemoteSocketAddressBytes(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetLocalSocketAddressBytes(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_State(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Template(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoteDeviceAddress(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_LocalHostName(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveEndpointPairCreationResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DeviceAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsExistingPathEvaluation(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_EndpointPair(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveEndpointPairStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindEndpointPairBySocketAddressBytes(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindEndpointPairByHostNamesAndPorts(void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveEndpointPairTemplate>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_InboundEndpointPairCreated(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_InboundEndpointPairCreated(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall CreateEndpointPairDefaultAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateEndpointPairWithBehaviorsAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateEndpointPairForPortsDefaultAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateEndpointPairForPortsWithBehaviorsAsync(void*, void*, void*, std::uint32_t, void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_InitiatorBoundPortRangeLower(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InitiatorBoundPortRangeUpper(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AcceptorBoundPortRangeLower(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AcceptorBoundPortRangeUpper(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EndpointPairs(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveEndpointPairTemplateStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetTemplateByName(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMeasurement>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall MeasureAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMetricResultsForDevice(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMetricResultsForMetric(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMetricResult(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPrivatePayloadResult(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Metrics(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceAddresses(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ShouldRequestPrivatePayloads(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ShouldRequestPrivatePayloads(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeoutInMilliseconds(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TimeoutInMilliseconds(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_NumberOfProbesToAttempt(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_NumberOfProbesToAttempt(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_NumberOfResultsPending(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MetricResults(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PrivatePayloadResults(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMeasurementStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall PublishPrivatePayloadBytes(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall ClearPrivatePayload() noexcept = 0;
            virtual std::int32_t __stdcall get_MaxSimultaneousProbeConnections(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxSimultaneousProbeConnections(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSystemOutboundBandwidthConstrained(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSystemOutboundBandwidthConstrained(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSystemInboundBandwidthConstrained(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSystemInboundBandwidthConstrained(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_PublishedPrivatePayload(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PublishedPrivatePayload(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxPrivatePayloadSize(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMetricResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Metric(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Value(std::uint64_t*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Networking_XboxLive_IXboxLiveDeviceAddress
    {
        ...
        auto GetSnapshotAsBytes(array_view<std::uint8_t> buffer, std::uint32_t& bytesWritten) const;
    ...
    struct consume_Windows_Networking_XboxLive_IXboxLiveDeviceAddressStatics
    {
        ...
        auto CreateFromSnapshotBytes(array_view<std::uint8_t const> buffer) const;
        auto GetLocal() const;
    ...
    struct consume_Windows_Networking_XboxLive_IXboxLiveEndpointPair
    {
        ...
        auto GetRemoteSocketAddressBytes(array_view<std::uint8_t> socketAddress) const;
        auto GetLocalSocketAddressBytes(array_view<std::uint8_t> socketAddress) const;
    ...
    {
        auto FindEndpointPairBySocketAddressBytes(array_view<std::uint8_t const> localSocketAddress, array_view<std::uint8_t const> remoteSocketAddress) const;
    ...
    struct consume_Windows_Networking_XboxLive_IXboxLiveQualityOfServiceMeasurement
    {
        ...
        auto TimeoutInMilliseconds(std::uint32_t value) const;
        [[nodiscard]] auto NumberOfProbesToAttempt() const;
        auto NumberOfProbesToAttempt(std::uint32_t value) const;
    ...
    {
        auto PublishPrivatePayloadBytes(array_view<std::uint8_t const> payload) const;
        auto ClearPrivatePayload() const;
        [[nodiscard]] auto MaxSimultaneousProbeConnections() const;
        auto MaxSimultaneousProbeConnections(std::uint32_t value) const;
