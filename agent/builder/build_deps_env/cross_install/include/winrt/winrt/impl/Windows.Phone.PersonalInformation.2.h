...
{
    struct WINRT_IMPL_EMPTY_BASES ContactAddress : winrt::Windows::Phone::PersonalInformation::IContactAddress
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ContactChangeRecord : winrt::Windows::Phone::PersonalInformation::IContactChangeRecord
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ContactInformation : winrt::Windows::Phone::PersonalInformation::IContactInformation
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ContactQueryOptions : winrt::Windows::Phone::PersonalInformation::IContactQueryOptions
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ContactQueryResult : winrt::Windows::Phone::PersonalInformation::IContactQueryResult
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ContactStore : winrt::Windows::Phone::PersonalInformation::IContactStore,
    ...
    struct WINRT_IMPL_EMPTY_BASES StoredContact : winrt::Windows::Phone::PersonalInformation::IStoredContact,
