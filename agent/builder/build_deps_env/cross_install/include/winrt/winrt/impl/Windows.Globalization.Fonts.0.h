...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Globalization::Fonts::ILanguageFontGroup>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UITextFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UIHeadingFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UITitleFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UICaptionFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UINotificationHeadingFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TraditionalDocumentFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ModernDocumentFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DocumentHeadingFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FixedWidthTextFont(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DocumentAlternate1Font(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DocumentAlternate2Font(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Globalization::Fonts::ILanguageFontGroupFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateLanguageFontGroup(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
