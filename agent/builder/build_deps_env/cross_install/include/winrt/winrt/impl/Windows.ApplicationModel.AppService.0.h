...
{
    enum class AppServiceClosedStatus : std::int32_t
    {
        Completed = 0,
        Canceled = 1,
    ...
    enum class AppServiceConnectionStatus : std::int32_t
    {
        Success = 0,
        AppNotInstalled = 1,
        AppUnavailable = 2,
    ...
    enum class AppServiceResponseStatus : std::int32_t
    {
        Success = 0,
        Failure = 1,
        ResourceLimitsExceeded = 2,
    ...
    enum class StatelessAppServiceResponseStatus : std::int32_t
    {
        Success = 0,
        AppNotInstalled = 1,
        AppUnavailable = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceCatalogStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall FindAppServiceProvidersAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AppServiceName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AppServiceName(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_RequestReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RequestReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ServiceClosed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ServiceClosed(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceConnection2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OpenRemoteAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_User(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_User(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceConnectionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SendStatelessMessageAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AppServiceConnection(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceTriggerDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsRemoteSystemConnection(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceTriggerDetails3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CheckCallerForCapabilityAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::AppService::IAppServiceTriggerDetails4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CallerRemoteConnectionToken(void**) noexcept = 0;
        };
    };
