...
WINRT_EXPORT namespace winrt::Windows::Security::Cryptography::Core
{
    ...
    struct CryptographicEngine
    {
        ...
        static auto DeriveKeyMaterial(winrt::Windows::Security::Cryptography::Core::CryptographicKey const& key, winrt::Windows::Security::Cryptography::Core::KeyDerivationParameters const& parameters, std::uint32_t desiredKeySize);
        ...
        impl::require<KeyDerivationParameters, winrt::Windows::Security::Cryptography::Core::IKeyDerivationParameters2>
    {
        ...
        static auto BuildForPbkdf2(winrt::Windows::Storage::Streams::IBuffer const& pbkdf2Salt, std::uint32_t iterationCount);
