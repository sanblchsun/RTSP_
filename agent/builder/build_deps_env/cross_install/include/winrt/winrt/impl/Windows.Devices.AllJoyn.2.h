...
WINRT_EXPORT namespace winrt::Windows::Devices::AllJoyn
{
    ...
    struct WINRT_IMPL_EMPTY_BASES AllJoynAboutDataView : winrt::Windows::Devices::AllJoyn::IAllJoynAboutDataView
    {
        ...
        static auto GetDataBySessionPortAsync(param::hstring const& uniqueName, winrt::Windows::Devices::AllJoyn::AllJoynBusAttachment const& busAttachment, std::uint16_t sessionPort);
        static auto GetDataBySessionPortAsync(param::hstring const& uniqueName, winrt::Windows::Devices::AllJoyn::AllJoynBusAttachment const& busAttachment, std::uint16_t sessionPort, winrt::Windows::Globalization::Language const& language);
    };
    struct WINRT_IMPL_EMPTY_BASES AllJoynAcceptSessionJoinerEventArgs : winrt::Windows::Devices::AllJoyn::IAllJoynAcceptSessionJoinerEventArgs
    {
        ...
        AllJoynAcceptSessionJoinerEventArgs(param::hstring const& uniqueName, std::uint16_t sessionPort, winrt::Windows::Devices::AllJoyn::AllJoynTrafficType const& trafficType, std::uint8_t proximity, winrt::Windows::Devices::AllJoyn::IAllJoynAcceptSessionJoiner const& acceptSessionJoiner);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES AllJoynBusObjectStoppedEventArgs : winrt::Windows::Devices::AllJoyn::IAllJoynBusObjectStoppedEventArgs
    {
        ...
        explicit AllJoynBusObjectStoppedEventArgs(std::int32_t status);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES AllJoynProducerStoppedEventArgs : winrt::Windows::Devices::AllJoyn::IAllJoynProducerStoppedEventArgs
    {
        ...
        explicit AllJoynProducerStoppedEventArgs(std::int32_t status);
    };
    struct WINRT_IMPL_EMPTY_BASES AllJoynServiceInfo : winrt::Windows::Devices::AllJoyn::IAllJoynServiceInfo
    {
        ...
        AllJoynServiceInfo(param::hstring const& uniqueName, param::hstring const& objectPath, std::uint16_t sessionPort);
    ...
    struct WINRT_IMPL_EMPTY_BASES AllJoynWatcherStoppedEventArgs : winrt::Windows::Devices::AllJoyn::IAllJoynWatcherStoppedEventArgs
    {
        ...
        explicit AllJoynWatcherStoppedEventArgs(std::int32_t status);
    };
}
#endif
