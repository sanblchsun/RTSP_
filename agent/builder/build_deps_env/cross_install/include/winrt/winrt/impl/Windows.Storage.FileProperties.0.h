...
{
    enum class PhotoOrientation : std::int32_t
    {
        Unspecified = 0,
        Normal = 1,
        FlipHorizontal = 2,
    ...
    enum class ThumbnailType : std::int32_t
    {
        Image = 0,
        Icon = 1,
    };
    enum class VideoOrientation : std::int32_t
    {
        Normal = 0,
        Rotate90 = 90,
        Rotate180 = 180,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Storage::FileProperties::IBasicProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DateModified(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ItemDate(std::int64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Storage::FileProperties::IGeotagHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetGeotagAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetGeotagFromGeolocatorAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetGeotagAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::FileProperties::IImageProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Rating(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Rating(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Keywords(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DateTaken(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DateTaken(std::int64_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Title(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Title(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Latitude(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Longitude(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CameraManufacturer(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CameraManufacturer(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CameraModel(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CameraModel(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::FileProperties::IMusicProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Album(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Composers(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Conductors(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Subtitle(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Subtitle(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Producers(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Publisher(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Publisher(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Writers(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Year(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Year(std::uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::FileProperties::IStorageItemContentProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetMusicPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetVideoPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetImagePropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDocumentPropertiesAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::FileProperties::IStorageItemExtraProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RetrievePropertiesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SavePropertiesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SavePropertiesAsyncOverloadDefault(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::FileProperties::IThumbnailProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_OriginalWidth(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_OriginalHeight(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReturnedSmallerCachedSize(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::FileProperties::IVideoProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Year(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Bitrate(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Directors(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Orientation(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Storage_FileProperties_IImageProperties
    {
        ...
        auto Rating(std::uint32_t value) const;
        [[nodiscard]] auto Keywords() const;
    ...
    struct consume_Windows_Storage_FileProperties_IMusicProperties
    {
        ...
        auto Year(std::uint32_t value) const;
    };
