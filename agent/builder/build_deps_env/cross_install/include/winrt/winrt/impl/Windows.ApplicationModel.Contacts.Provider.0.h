...
{
    enum class AddContactResult : std::int32_t
    {
        Added = 0,
        AlreadyAdded = 1,
        Unavailable = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Contacts::Provider::IContactPickerUI>
    {
        ...
        {
            virtual std::int32_t __stdcall AddContact(void*, void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveContact(void*) noexcept = 0;
            virtual std::int32_t __stdcall ContainsContact(void*, bool*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_ContactRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ContactRemoved(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Contacts::Provider::IContactPickerUI2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddContact(void*, std::int32_t*) noexcept = 0;
