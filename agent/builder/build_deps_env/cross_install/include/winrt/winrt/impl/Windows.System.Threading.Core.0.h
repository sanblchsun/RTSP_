...
WINRT_EXPORT namespace winrt::Windows::System::Threading
{
    ...
    enum class WorkItemOptions : std::uint32_t;
    enum class WorkItemPriority : std::int32_t;
}
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Threading::Core::IPreallocatedWorkItem>
    {
        ...
        {
            virtual std::int32_t __stdcall RunAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWorkItem(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWorkItemWithPriority(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWorkItemWithPriorityAndOptions(void*, std::int32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AttachToEvent(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AttachToEventWithTimeout(void*, void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall AttachToSemaphore(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AttachToSemaphoreWithTimeout(void*, void*, std::int64_t, void**) noexcept = 0;
        };
    };
