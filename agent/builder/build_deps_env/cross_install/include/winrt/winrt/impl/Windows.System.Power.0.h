...
{
    enum class BatteryStatus : std::int32_t
    {
        NotPresent = 0,
        Discharging = 1,
        Idle = 2,
    ...
    enum class EnergySaverStatus : std::int32_t
    {
        Disabled = 0,
        Off = 1,
        On = 2,
    };
    enum class PowerSupplyStatus : std::int32_t
    {
        NotPresent = 0,
        Inadequate = 1,
        Adequate = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Power::IBackgroundEnergyManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_LowUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NearMaxAcceptableUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxAcceptableUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExcessiveUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NearTerminationUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TerminationUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RecentEnergyUsage(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RecentEnergyUsageLevel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_RecentEnergyUsageIncreased(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RecentEnergyUsageIncreased(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_RecentEnergyUsageReturnedToLow(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RecentEnergyUsageReturnedToLow(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::Power::IPowerManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EnergySaverStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_EnergySaverStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_EnergySaverStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_BatteryStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_BatteryStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BatteryStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_PowerSupplyStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_PowerSupplyStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PowerSupplyStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_RemainingChargePercent(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_RemainingChargePercentChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RemainingChargePercentChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_RemainingDischargeTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_RemainingDischargeTimeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RemainingDischargeTimeChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
