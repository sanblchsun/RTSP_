...
{
    enum class SpiMode : std::int32_t
    {
        Mode0 = 0,
        Mode1 = 1,
        Mode2 = 2,
    ...
    enum class SpiSharingMode : std::int32_t
    {
        Exclusive = 0,
        Shared = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Spi::ISpiBusInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ChipSelectLineCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinClockFrequency(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxClockFrequency(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedDataBitLengths(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Spi::ISpiConnectionSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ChipSelectLine(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ChipSelectLine(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_DataBitLength(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DataBitLength(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ClockFrequency(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ClockFrequency(std::int32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Spi::ISpiController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDevice(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Spi::ISpiDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ConnectionSettings(void**) noexcept = 0;
            virtual std::int32_t __stdcall Write(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall Read(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall TransferSequential(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall TransferFullDuplex(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Spi::ISpiDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetDeviceSelectorFromFriendlyName(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBusInfo(void*, void**) noexcept = 0;
    ...
    {
        auto Create(std::int32_t chipSelectLine) const;
    };
    ...
    struct consume_Windows_Devices_Spi_ISpiDevice
    {
        ...
        auto Write(array_view<std::uint8_t const> buffer) const;
        auto Read(array_view<std::uint8_t> buffer) const;
        auto TransferSequential(array_view<std::uint8_t const> writeBuffer, array_view<std::uint8_t> readBuffer) const;
        auto TransferFullDuplex(array_view<std::uint8_t const> writeBuffer, array_view<std::uint8_t> readBuffer) const;
    };
