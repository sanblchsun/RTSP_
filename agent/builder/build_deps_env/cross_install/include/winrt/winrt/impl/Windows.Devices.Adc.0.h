...
{
    enum class AdcChannelMode : std::int32_t
    {
        SingleEnded = 0,
        Differential = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Adc::IAdcChannel>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ReadValue(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadRatio(double*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Adc::IAdcController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ChannelCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ResolutionInBits(std::int32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_ChannelMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ChannelMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall IsChannelModeSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall OpenChannel(std::int32_t, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Adc_IAdcController
    {
        ...
        auto OpenChannel(std::int32_t channelNumber) const;
    };
