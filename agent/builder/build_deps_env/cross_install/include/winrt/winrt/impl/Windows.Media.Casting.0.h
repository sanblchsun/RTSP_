...
{
    enum class CastingConnectionErrorStatus : std::int32_t
    {
        Succeeded = 0,
    ...
    enum class CastingConnectionState : std::int32_t
    {
        Disconnected = 0,
        Connected = 1,
        Rendering = 2,
    ...
    enum class CastingPlaybackTypes : std::uint32_t
    {
        None = 0,
        Audio = 0x1,
        Video = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Casting::ICastingConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall RequestStartCastingAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DisconnectAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Casting::ICastingDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetSupportedCastingPlaybackTypesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateCastingConnection(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Casting::ICastingDevicePicker>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_CastingDeviceSelected(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CastingDeviceSelected(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CastingDevicePickerDismissed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CastingDevicePickerDismissed(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Casting::ICastingDevicePickerFilter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SupportsPictures(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_SupportsPictures(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedCastingSources(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Casting::ICastingDeviceSelectedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SelectedCastingDevice(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Casting::ICastingDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDeviceSelector(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorFromCastingSourceAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FromIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeviceInfoSupportsCastingAsync(void*, void**) noexcept = 0;
        };
    };
