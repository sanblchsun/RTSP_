...
{
    enum class WiFiDirectServiceAdvertisementStatus : std::int32_t
    {
        Created = 0,
        Started = 1,
        Stopped = 2,
    ...
    enum class WiFiDirectServiceConfigurationMethod : std::int32_t
    {
        Default = 0,
        PinDisplay = 1,
        PinEntry = 2,
    };
    enum class WiFiDirectServiceError : std::int32_t
    {
        Success = 0,
        RadioNotAvailable = 1,
        ResourceInUse = 2,
    ...
    enum class WiFiDirectServiceIPProtocol : std::int32_t
    {
        Tcp = 6,
        Udp = 17,
    };
    enum class WiFiDirectServiceSessionErrorStatus : std::int32_t
    {
        Ok = 0,
        Disassociated = 1,
        LocalClose = 2,
    ...
    enum class WiFiDirectServiceSessionStatus : std::int32_t
    {
        Closed = 0,
        Initiated = 1,
        Requested = 2,
    ...
    enum class WiFiDirectServiceStatus : std::int32_t
    {
        Available = 0,
        Busy = 1,
        Custom = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectService>
    {
        ...
        {
            virtual std::int32_t __stdcall get_RemoteServiceInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedConfigurationMethods(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferGroupOwnerMode(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferGroupOwnerMode(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_SessionInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SessionInfo(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceError(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_SessionDeferred(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionDeferred(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetProvisioningInfoAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConnectAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ConnectAsyncWithPin(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceAdvertiser>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ServiceNamePrefixes(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ServiceInfo(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoAcceptSession(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoAcceptSession(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferGroupOwnerMode(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferGroupOwnerMode(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredConfigurationMethods(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ServiceStatus(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomServiceStatusCode(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CustomServiceStatusCode(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DeferredSessionInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DeferredSessionInfo(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AdvertisementStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceError(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_SessionRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_AutoAcceptSessionConnected(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AutoAcceptSessionConnected(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall ConnectAsyncWithPin(void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceAdvertiserFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWiFiDirectServiceAdvertiser(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceProvisioningInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SelectedConfigurationMethod(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsGroupFormationNeeded(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SessionId(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AdvertisementId(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SessionAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConnectionEndpointPairs(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall AddStreamSocketListenerAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AddDatagramSocketAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_RemotePortAdded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RemotePortAdded(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceSessionRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ProvisioningInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SessionInfo(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceSessionRequestedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetSessionRequest(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetSelector(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSelectorWithFilter(void*, void*, void**) noexcept = 0;
    ...
    struct consume_Windows_Devices_WiFiDirect_Services_IWiFiDirectServiceAdvertiser
    {
        ...
        auto CustomServiceStatusCode(std::uint32_t value) const;
