...
{
    enum class LampArrayKind : std::int32_t
    {
        Undefined = 0,
        Keyboard = 1,
        Mouse = 2,
    ...
    enum class LampPurposes : std::uint32_t
    {
        Undefined = 0,
        Control = 0x1,
        Accent = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::ILamp>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_BrightnessLevel(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_BrightnessLevel(float) noexcept = 0;
            virtual std::int32_t __stdcall get_IsColorSettable(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::ILampArray>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HardwareVersion(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LampArrayKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LampCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinUpdateInterval(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BoundingBox(winrt::Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_BrightnessLevel(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_BrightnessLevel(double) noexcept = 0;
            virtual std::int32_t __stdcall get_IsConnected(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportsVirtualKeys(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetLampInfo(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIndicesForKey(std::int32_t, std::uint32_t* __resultSize, std::int32_t**) noexcept = 0;
            virtual std::int32_t __stdcall GetIndicesForPurposes(std::uint32_t, std::uint32_t* __resultSize, std::int32_t**) noexcept = 0;
            virtual std::int32_t __stdcall SetColor(struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall SetColorForIndex(std::int32_t, struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall SetSingleColorForIndices(struct struct_Windows_UI_Color, std::uint32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetColorsForIndices(std::uint32_t, struct struct_Windows_UI_Color*, std::uint32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetColorsForKey(struct struct_Windows_UI_Color, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetColorsForKeys(std::uint32_t, struct struct_Windows_UI_Color*, std::uint32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetColorsForPurposes(struct struct_Windows_UI_Color, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall SendMessageAsync(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestMessageAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::ILampInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Index(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Purposes(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Position(winrt::Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual std::int32_t __stdcall get_RedLevelCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_GreenLevelCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BlueLevelCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_GainLevelCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FixedColor(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNearestSupportedColor(struct struct_Windows_UI_Color, struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall get_UpdateLatency(std::int64_t*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Lights_ILampArray
    {
        ...
        auto GetLampInfo(std::int32_t lampIndex) const;
        ...
        auto SetColorForIndex(std::int32_t lampIndex, winrt::Windows::UI::Color const& desiredColor) const;
        auto SetSingleColorForIndices(winrt::Windows::UI::Color const& desiredColor, array_view<std::int32_t const> lampIndexes) const;
        auto SetColorsForIndices(array_view<winrt::Windows::UI::Color const> desiredColors, array_view<std::int32_t const> lampIndexes) const;
        ...
        auto SendMessageAsync(std::int32_t messageId, winrt::Windows::Storage::Streams::IBuffer const& message) const;
        auto RequestMessageAsync(std::int32_t messageId) const;
    };
