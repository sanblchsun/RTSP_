...
{
    enum class ClosedCaptionColor : std::int32_t
    {
        Default = 0,
        White = 1,
        Black = 2,
    ...
    enum class ClosedCaptionEdgeEffect : std::int32_t
    {
        Default = 0,
        None = 1,
        Raised = 2,
    ...
    enum class ClosedCaptionOpacity : std::int32_t
    {
        Default = 0,
        OneHundredPercent = 1,
    ...
    enum class ClosedCaptionSize : std::int32_t
    {
        Default = 0,
        FiftyPercent = 1,
        OneHundredPercent = 2,
    ...
    enum class ClosedCaptionStyle : std::int32_t
    {
        Default = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::ClosedCaptioning::IClosedCaptionPropertiesStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_FontColor(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ComputedFontColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall get_FontOpacity(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FontSize(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FontStyle(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FontEffect(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BackgroundColor(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ComputedBackgroundColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall get_BackgroundOpacity(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RegionColor(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ComputedRegionColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall get_RegionOpacity(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
