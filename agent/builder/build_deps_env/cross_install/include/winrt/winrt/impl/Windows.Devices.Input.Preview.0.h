...
{
    enum class GazeDeviceConfigurationStatePreview : std::int32_t
    {
        Unknown = 0,
        Ready = 1,
        Configuring = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Input::Preview::IGazeDevicePreview>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CanTrackEyes(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanTrackHead(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ConfigurationState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RequestCalibrationAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetNumericControlDescriptions(std::uint16_t, std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanControlDescriptions(std::uint16_t, std::uint16_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Input::Preview::IGazeInputSourcePreview>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_GazeMoved(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GazeMoved(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_GazeEntered(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GazeEntered(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_GazeExited(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GazeExited(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Input::Preview::IGazePointPreview>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SourceDevice(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EyeGazePosition(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HeadGazePosition(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Timestamp(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_HidInputReport(void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Devices_Input_Preview_IGazeDevicePreview
    {
        ...
        auto GetNumericControlDescriptions(std::uint16_t usagePage, std::uint16_t usageId) const;
        auto GetBooleanControlDescriptions(std::uint16_t usagePage, std::uint16_t usageId) const;
    };
