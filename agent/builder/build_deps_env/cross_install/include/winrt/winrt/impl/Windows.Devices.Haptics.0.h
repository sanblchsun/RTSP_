...
{
    enum class VibrationAccessStatus : std::int32_t
    {
        Allowed = 0,
        DeniedByUser = 1,
        DeniedBySystem = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Haptics::IKnownSimpleHapticsControllerWaveformsStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Click(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BuzzContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RumbleContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Press(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Release(std::uint16_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Haptics::ISimpleHapticsController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SupportedFeedback(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsIntensitySupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPlayCountSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPlayDurationSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsReplayPauseIntervalSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall StopFeedback() noexcept = 0;
            virtual std::int32_t __stdcall SendHapticFeedback(void*) noexcept = 0;
            virtual std::int32_t __stdcall SendHapticFeedbackWithIntensity(void*, double) noexcept = 0;
            virtual std::int32_t __stdcall SendHapticFeedbackForDuration(void*, double, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall SendHapticFeedbackForPlayCount(void*, double, std::int32_t, std::int64_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Haptics::ISimpleHapticsControllerFeedback>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Waveform(std::uint16_t*) noexcept = 0;
    ...
    struct consume_Windows_Devices_Haptics_ISimpleHapticsController
    {
        ...
        auto SendHapticFeedbackForPlayCount(winrt::Windows::Devices::Haptics::SimpleHapticsControllerFeedback const& feedback, double intensity, std::int32_t playCount, winrt::Windows::Foundation::TimeSpan const& replayPauseInterval) const;
    };
