...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::ILowLevelDevicesAggregateProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AdcControllerProvider(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PwmControllerProvider(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_GpioControllerProvider(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_I2cControllerProvider(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SpiControllerProvider(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::ILowLevelDevicesAggregateProviderFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Create(void*, void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::ILowLevelDevicesControllerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DefaultProvider(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DefaultProvider(void*) noexcept = 0;
        };
    };
    template <typename D>
