...
{
    enum class GlobalSystemMediaTransportControlsSessionPlaybackStatus : std::int32_t
    {
        Closed = 0,
        Opened = 1,
        Changing = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Control::IGlobalSystemMediaTransportControlsSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SourceAppUserModelId(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetMediaPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetTimelineProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPlaybackInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryPlayAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryPauseAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryStopAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryRecordAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryFastForwardAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryRewindAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySkipNextAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySkipPreviousAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryChangeChannelUpAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryChangeChannelDownAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryTogglePlayPauseAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryChangeAutoRepeatModeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryChangePlaybackRateAsync(double, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryChangeShuffleActiveAsync(bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryChangePlaybackPositionAsync(std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_TimelinePropertiesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TimelinePropertiesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PlaybackInfoChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PlaybackInfoChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_MediaPropertiesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MediaPropertiesChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Control::IGlobalSystemMediaTransportControlsSessionManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetCurrentSession(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSessions(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_CurrentSessionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CurrentSessionChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SessionsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionsChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Control::IGlobalSystemMediaTransportControlsSessionMediaProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_TrackNumber(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Genres(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AlbumTrackCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackType(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Control::IGlobalSystemMediaTransportControlsSessionPlaybackControls>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsPlayPauseToggleEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsShuffleEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsRepeatEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPlaybackRateEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPlaybackPositionEnabled(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Control::IGlobalSystemMediaTransportControlsSessionPlaybackInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Controls(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackType(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoRepeatMode(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackRate(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsShuffleActive(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Media_Control_IGlobalSystemMediaTransportControlsSession
    {
        ...
        auto TryChangePlaybackPositionAsync(std::int64_t requestedPlaybackPosition) const;
