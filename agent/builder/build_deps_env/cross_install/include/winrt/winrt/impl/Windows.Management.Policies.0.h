...
{
    enum class NamedPolicyKind : std::int32_t
    {
        Invalid = 0,
        Binary = 1,
        Boolean = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Management::Policies::INamedPolicyData>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsManaged(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsUserPolicy(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_User(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBoolean(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetBinary(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Management::Policies::INamedPolicyStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetPolicyFromPath(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPolicyFromPathForUser(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
