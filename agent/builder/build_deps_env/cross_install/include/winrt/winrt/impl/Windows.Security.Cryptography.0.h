...
{
    enum class BinaryStringEncoding : std::int32_t
    {
        Utf8 = 0,
        Utf16LE = 1,
        Utf16BE = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::ICryptographicBufferStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall Compare(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GenerateRandom(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateRandomNumber(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromByteArray(std::uint32_t, std::uint8_t*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CopyToByteArray(void*, std::uint32_t*, std::uint8_t**) noexcept = 0;
            virtual std::int32_t __stdcall DecodeFromHexString(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall EncodeToHexString(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DecodeFromBase64String(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall EncodeToBase64String(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConvertStringToBinary(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConvertBinaryToString(std::int32_t, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Security_Cryptography_ICryptographicBufferStatics
    {
        ...
        auto GenerateRandom(std::uint32_t length) const;
        auto GenerateRandomNumber() const;
        auto CreateFromByteArray(array_view<std::uint8_t const> value) const;
        auto CopyToByteArray(winrt::Windows::Storage::Streams::IBuffer const& buffer, com_array<std::uint8_t>& value) const;
