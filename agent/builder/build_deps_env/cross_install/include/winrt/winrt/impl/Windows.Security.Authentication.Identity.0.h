...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::IEnterpriseKeyCredentialRegistrationInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_TenantId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TenantName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Subject(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_KeyId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_KeyName(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::IEnterpriseKeyCredentialRegistrationManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetRegistrationsAsync(void**) noexcept = 0;
        };
    };
