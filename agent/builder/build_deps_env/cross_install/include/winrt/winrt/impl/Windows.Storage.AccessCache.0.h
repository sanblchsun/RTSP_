...
{
    enum class AccessCacheOptions : std::uint32_t
    {
        None = 0,
    ...
    enum class RecentStorageItemVisibility : std::int32_t
    {
        AppOnly = 0,
        AppAndSystem = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Storage::AccessCache::IItemRemovedEventArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall get_RemovedEntry(struct struct_Windows_Storage_AccessCache_AccessListEntry*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::AccessCache::IStorageApplicationPermissionsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_FutureAccessList(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MostRecentlyUsedList(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::AccessCache::IStorageApplicationPermissionsStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetFutureAccessListForUser(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMostRecentlyUsedListForUser(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::AccessCache::IStorageItemAccessList>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddOverloadDefaultMetadata(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall Add(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall AddOrReplaceOverloadDefaultMetadata(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall AddOrReplace(void*, void*, void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall GetItemWithOptionsAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFileWithOptionsAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFolderWithOptionsAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall Remove(void*) noexcept = 0;
            virtual std::int32_t __stdcall ContainsItem(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall Clear() noexcept = 0;
            virtual std::int32_t __stdcall CheckAccess(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Entries(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MaximumItemsAllowed(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::AccessCache::IStorageItemMostRecentlyUsedList>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_ItemRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ItemRemoved(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::AccessCache::IStorageItemMostRecentlyUsedList2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddWithMetadataAndVisibility(void*, void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall AddOrReplaceWithMetadataAndVisibility(void*, void*, void*, std::int32_t) noexcept = 0;
        };
    };
    template <typename D>
