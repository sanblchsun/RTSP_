...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <typename T> struct abi<winrt::Windows::Foundation::Collections::IIterable<T>>
    {
        ...
        {
            virtual std::int32_t __stdcall First(void**) noexcept = 0;
        };
    };
    template <typename T> struct abi<winrt::Windows::Foundation::Collections::IIterator<T>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Current(arg_out<T>) noexcept = 0;
            virtual std::int32_t __stdcall get_HasCurrent(bool*) noexcept = 0;
            virtual std::int32_t __stdcall MoveNext(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetMany(std::uint32_t, arg_out<T>, std::uint32_t*) noexcept = 0;
        };
    };
    template <typename K, typename V> struct abi<winrt::Windows::Foundation::Collections::IKeyValuePair<K, V>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Key(arg_out<K>) noexcept = 0;
            virtual std::int32_t __stdcall get_Value(arg_out<V>) noexcept = 0;
        };
    };
    ...
    template <typename K, typename V> struct abi<winrt::Windows::Foundation::Collections::IMapView<K, V>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Lookup(arg_in<K>, arg_out<V>) noexcept = 0;
            virtual std::int32_t __stdcall get_Size(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall HasKey(arg_in<K>, bool*) noexcept = 0;
            virtual std::int32_t __stdcall Split(void**, void**) noexcept = 0;
        };
    };
    template <typename K, typename V> struct abi<winrt::Windows::Foundation::Collections::IMap<K, V>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall Insert(arg_in<K>, arg_in<V>, bool*) noexcept = 0;
            virtual std::int32_t __stdcall Remove(arg_in<K>) noexcept = 0;
    ...
    template <typename K, typename V> struct abi<winrt::Windows::Foundation::Collections::IObservableMap<K, V>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_MapChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MapChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <typename T> struct abi<winrt::Windows::Foundation::Collections::IObservableVector<T>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_VectorChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_VectorChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <typename T> struct abi<winrt::Windows::Foundation::Collections::IVectorView<T>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAt(std::uint32_t, arg_out<T>) noexcept = 0;
            virtual std::int32_t __stdcall get_Size(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall IndexOf(arg_in<T>, std::uint32_t*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetMany(std::uint32_t, std::uint32_t, arg_out<T>, std::uint32_t*) noexcept = 0;
        };
    };
    template <typename T> struct abi<winrt::Windows::Foundation::Collections::IVector<T>>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetView(void**) noexcept = 0;
            virtual std::int32_t __stdcall IndexOf(arg_in<T>, std::uint32_t*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetAt(std::uint32_t, arg_in<T>) noexcept = 0;
            virtual std::int32_t __stdcall InsertAt(std::uint32_t, arg_in<T>) noexcept = 0;
            virtual std::int32_t __stdcall RemoveAt(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall Append(arg_in<T>) noexcept = 0;
            virtual std::int32_t __stdcall RemoveAtEnd() noexcept = 0;
            virtual std::int32_t __stdcall Clear() noexcept = 0;
            virtual std::int32_t __stdcall GetMany(std::uint32_t, std::uint32_t, arg_out<T>, std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReplaceAll(std::uint32_t, arg_out<T>) noexcept = 0;
        };
    };
    ...
    {
        auto GetAt(std::uint32_t index) const;
        [[nodiscard]] auto Size() const;
        auto IndexOf(impl::param_type<T> const& value, std::uint32_t& index) const;
        auto GetMany(std::uint32_t startIndex, array_view<T> items) const;
    };
    ...
    struct consume_Windows_Foundation_Collections_IVector
    {
        ...
        auto GetView() const;
        auto IndexOf(impl::param_type<T> const& value, std::uint32_t& index) const;
        auto SetAt(std::uint32_t index, impl::param_type<T> const& value) const;
        auto InsertAt(std::uint32_t index, impl::param_type<T> const& value) const;
        auto RemoveAt(std::uint32_t index) const;
