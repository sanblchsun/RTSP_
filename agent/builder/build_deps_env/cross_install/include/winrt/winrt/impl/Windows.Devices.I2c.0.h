...
{
    enum class I2cBusSpeed : std::int32_t
    {
        StandardMode = 0,
        FastMode = 1,
    };
    enum class I2cSharingMode : std::int32_t
    {
        Exclusive = 0,
        Shared = 1,
    };
    enum class I2cTransferStatus : std::int32_t
    {
        FullTransfer = 0,
        PartialTransfer = 1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Devices::I2c::I2cTransferResult>{ using type = struct_category<winrt::Windows::Devices::I2c::I2cTransferStatus, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Windows::Devices::I2c::II2cConnectionSettings>
    {
        ...
        {
            virtual std::int32_t __stdcall get_SlaveAddress(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SlaveAddress(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_BusSpeed(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_BusSpeed(std::int32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::I2c::II2cDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall WritePartial(std::uint32_t, std::uint8_t*, struct struct_Windows_Devices_I2c_I2cTransferResult*) noexcept = 0;
            virtual std::int32_t __stdcall Read(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadPartial(std::uint32_t, std::uint8_t*, struct struct_Windows_Devices_I2c_I2cTransferResult*) noexcept = 0;
            virtual std::int32_t __stdcall WriteRead(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall WriteReadPartial(std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*, struct struct_Windows_Devices_I2c_I2cTransferResult*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_I2c_II2cConnectionSettings
    {
        ...
        auto SlaveAddress(std::int32_t value) const;
    ...
    {
        auto Create(std::int32_t slaveAddress) const;
    };
    ...
    struct consume_Windows_Devices_I2c_II2cDevice
    {
        ...
        auto WritePartial(array_view<std::uint8_t const> buffer) const;
        auto Read(array_view<std::uint8_t> buffer) const;
        auto ReadPartial(array_view<std::uint8_t> buffer) const;
        auto WriteRead(array_view<std::uint8_t const> writeBuffer, array_view<std::uint8_t> readBuffer) const;
        auto WriteReadPartial(array_view<std::uint8_t const> writeBuffer, array_view<std::uint8_t> readBuffer) const;
    };
