...
{
    enum class HttpCacheReadBehavior : std::int32_t
    {
        Default = 0,
        MostRecent = 1,
        OnlyFromCache = 2,
    ...
    enum class HttpCacheWriteBehavior : std::int32_t
    {
        Default = 0,
        NoCache = 1,
    };
    enum class HttpCookieUsageBehavior : std::int32_t
    {
        Default = 0,
        NoCookies = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AllowAutoRedirect(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowAutoRedirect(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowUI(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowUI(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AutomaticDecompression(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutomaticDecompression(bool) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_MaxConnectionsPerServer(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxConnectionsPerServer(std::uint32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_UseProxy(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_UseProxy(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MaxVersion(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxVersion(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CookieUsageBehavior(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CookieUsageBehavior(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ClearAuthenticationCache() noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Web::Http::Filters::IHttpCacheControl>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ReadBehavior(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReadBehavior(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_WriteBehavior(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_WriteBehavior(std::int32_t) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Web_Http_Filters_IHttpBaseProtocolFilter
    {
        ...
        auto MaxConnectionsPerServer(std::uint32_t value) const;
