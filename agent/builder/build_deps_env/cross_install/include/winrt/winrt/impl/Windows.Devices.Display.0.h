...
{
    enum class DisplayMonitorConnectionKind : std::int32_t
    {
        Internal = 0,
        Wired = 1,
        Wireless = 2,
    ...
    enum class DisplayMonitorDescriptorKind : std::int32_t
    {
        Edid = 0,
        DisplayId = 1,
    };
    enum class DisplayMonitorPhysicalConnectorKind : std::int32_t
    {
        Unknown = 0,
        HD15 = 1,
        AnalogTV = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Display::IDisplayMonitor>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ConnectionKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhysicalConnector(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayAdapterDeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayAdapterId(struct struct_Windows_Graphics_DisplayAdapterId*) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayAdapterTargetId(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UsageKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NativeResolutionInRawPixels(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhysicalSizeInInches(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall GetDescriptor(std::int32_t, std::uint32_t* __resultSize, std::uint8_t**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Display::IDisplayMonitor2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsDolbyVisionSupportedInHdrMode(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Display::IDisplayMonitorStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall FromInterfaceIdAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
