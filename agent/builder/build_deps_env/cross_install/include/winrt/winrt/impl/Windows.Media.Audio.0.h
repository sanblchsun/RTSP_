...
WINRT_EXPORT namespace winrt::Windows::Media
{
    ...
    enum class SoundLevel : std::int32_t;
}
...
{
    enum class AudioDeviceRole : std::int32_t;
}
...
{
    enum class AudioRenderCategory : std::int32_t;
}
...
{
    enum class AudioDeviceNodeCreationStatus : std::int32_t
    {
        Success = 0,
    ...
    enum class AudioFileNodeCreationStatus : std::int32_t
    {
        Success = 0,
        FileNotFound = 1,
        InvalidFileType = 2,
    ...
    enum class AudioGraphCreationStatus : std::int32_t
    {
        Success = 0,
        DeviceNotAvailable = 1,
        FormatNotSupported = 2,
    ...
    enum class AudioGraphUnrecoverableError : std::int32_t
    {
        None = 0,
        AudioDeviceLost = 1,
    ...
    enum class AudioNodeEmitterDecayKind : std::int32_t
    {
        Natural = 0,
        Custom = 1,
    };
    enum class AudioNodeEmitterSettings : std::uint32_t
    {
        None = 0,
        DisableDoppler = 0x1,
    };
    enum class AudioNodeEmitterShapeKind : std::int32_t
    {
        Omnidirectional = 0,
        Cone = 1,
    };
    enum class AudioPlaybackConnectionOpenResultStatus : std::int32_t
    {
        Success = 0,
        RequestTimedOut = 1,
        DeniedBySystem = 2,
    ...
    enum class AudioPlaybackConnectionState : std::int32_t
    {
        Closed = 0,
        Opened = 1,
    };
    enum class MediaSourceAudioInputNodeCreationStatus : std::int32_t
    {
        Success = 0,
    ...
    enum class MixedRealitySpatialAudioFormatPolicy : std::int32_t
    {
        UseMixedRealityDefaultSpatialAudioFormat = 0,
        UseDeviceConfigurationDefaultSpatialAudioFormat = 1,
    };
    enum class QuantumSizeSelectionMode : std::int32_t
    {
        SystemDefault = 0,
        LowestLatency = 1,
        ClosestToDesired = 2,
    };
    enum class SetDefaultSpatialAudioFormatStatus : std::int32_t
    {
        Succeeded = 0,
        AccessDenied = 1,
        LicenseExpired = 2,
    ...
    enum class SpatialAudioModel : std::int32_t
    {
        ObjectBased = 0,
        FoldDown = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioFileInputNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_PlaybackSpeedFactor(double) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackSpeedFactor(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_Position(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall Seek(std::int64_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_LoopCount(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LoopCount(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Duration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SourceFile(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_FileCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_FileCompleted(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioFileOutputNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_FileEncodingProfile(void**) noexcept = 0;
            virtual std::int32_t __stdcall FinalizeAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioFrameInputNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_PlaybackSpeedFactor(double) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackSpeedFactor(double*) noexcept = 0;
            virtual std::int32_t __stdcall AddFrame(void*) noexcept = 0;
            virtual std::int32_t __stdcall DiscardQueuedFrames() noexcept = 0;
            virtual std::int32_t __stdcall get_QueuedSampleCount(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_AudioFrameCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AudioFrameCompleted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_QuantumStarted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_QuantumStarted(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioFrameOutputNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetFrame(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraph>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFrameInputNode(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFrameInputNodeWithFormat(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDeviceInputNodeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDeviceInputNodeWithFormatAsync(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDeviceInputNodeWithFormatOnDeviceAsync(std::int32_t, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFrameOutputNode(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFrameOutputNodeWithFormat(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDeviceOutputNodeAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFileInputNodeAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFileOutputNodeAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFileOutputNodeWithFileProfileAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateSubmixNode(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateSubmixNodeWithFormat(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall Start() noexcept = 0;
            virtual std::int32_t __stdcall Stop() noexcept = 0;
            virtual std::int32_t __stdcall ResetAllNodes() noexcept = 0;
            virtual std::int32_t __stdcall add_QuantumStarted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_QuantumStarted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_QuantumProcessed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_QuantumProcessed(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_UnrecoverableErrorOccurred(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_UnrecoverableErrorOccurred(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_CompletedQuantumCount(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EncodingProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LatencyInSamples(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PrimaryRenderDevice(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RenderDeviceAudioProcessing(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SamplesPerQuantum(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraph2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFrameInputNodeWithFormatAndEmitter(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDeviceInputNodeWithFormatAndEmitterOnDeviceAsync(std::int32_t, void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFileInputNodeWithEmitterAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateSubmixNodeWithFormatAndEmitter(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateBatchUpdater(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraph3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateMediaSourceAudioInputNodeAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateMediaSourceAudioInputNodeWithEmitterAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraphConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Destination(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Gain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Gain(double*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraphSettings>
    {
        ...
        {
            virtual std::int32_t __stdcall get_EncodingProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_EncodingProperties(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PrimaryRenderDevice(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PrimaryRenderDevice(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_QuantumSizeSelectionMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_QuantumSizeSelectionMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DesiredSamplesPerQuantum(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DesiredSamplesPerQuantum(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioRenderCategory(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioRenderCategory(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DesiredRenderDeviceAudioProcessing(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DesiredRenderDeviceAudioProcessing(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraphSettings2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_MaxPlaybackSpeedFactor(double) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxPlaybackSpeedFactor(double*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioGraphStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioInputNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_OutgoingConnections(void**) noexcept = 0;
            virtual std::int32_t __stdcall AddOutgoingConnection(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddOutgoingConnectionWithGain(void*, double) noexcept = 0;
            virtual std::int32_t __stdcall RemoveOutgoingConnection(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioInputNode2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Emitter(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EffectDefinitions(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingGain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingGain(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_EncodingProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ConsumeInput(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ConsumeInput(bool) noexcept = 0;
            virtual std::int32_t __stdcall Start() noexcept = 0;
            virtual std::int32_t __stdcall Stop() noexcept = 0;
            virtual std::int32_t __stdcall Reset() noexcept = 0;
            virtual std::int32_t __stdcall DisableEffectsByDefinition(void*) noexcept = 0;
            virtual std::int32_t __stdcall EnableEffectsByDefinition(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Position(winrt::Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual std::int32_t __stdcall put_Position(winrt::Windows::Foundation::Numerics::float3) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Shape(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DecayModel(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Gain(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_Gain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_DistanceScale(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_DistanceScale(double) noexcept = 0;
            virtual std::int32_t __stdcall get_DopplerScale(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_DopplerScale(double) noexcept = 0;
            virtual std::int32_t __stdcall get_DopplerVelocity(winrt::Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual std::int32_t __stdcall put_DopplerVelocity(winrt::Windows::Foundation::Numerics::float3) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDopplerDisabled(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SpatialAudioModel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SpatialAudioModel(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterConeProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InnerAngle(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_OuterAngle(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_OuterAngleGain(double*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterDecayModel>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MinGain(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxGain(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_NaturalProperties(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterDecayModelStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateNatural(double, double, double, double, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateCustom(double, double, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateAudioNodeEmitter(void*, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterNaturalDecayModelProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UnityGainDistance(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_CutoffDistance(double*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterShape>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Kind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ConeProperties(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeEmitterShapeStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateCone(double, double, double, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateOmnidirectional(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeListener>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SpeedOfSound(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_SpeedOfSound(double) noexcept = 0;
            virtual std::int32_t __stdcall get_DopplerVelocity(winrt::Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual std::int32_t __stdcall put_DopplerVelocity(winrt::Windows::Foundation::Numerics::float3) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioNodeWithListener>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_Listener(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioPlaybackConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall Open(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioPlaybackConnectionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall TryCreateFromId(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioStateMonitor>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_SoundLevelChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SoundLevelChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_SoundLevel(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IAudioStateMonitorStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateForRenderMonitoring(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForRenderMonitoringWithCategory(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForRenderMonitoringWithCategoryAndDeviceRole(std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForRenderMonitoringWithCategoryAndDeviceId(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForCaptureMonitoring(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForCaptureMonitoringWithCategory(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForCaptureMonitoringWithCategoryAndDeviceRole(std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForCaptureMonitoringWithCategoryAndDeviceId(std::int32_t, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::ICreateAudioDeviceInputNodeResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceInputNode(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ICreateAudioDeviceOutputNodeResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceOutputNode(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ICreateAudioFileInputNodeResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FileInputNode(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ICreateAudioFileOutputNodeResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FileOutputNode(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ICreateAudioGraphResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Graph(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ICreateMediaSourceAudioInputNodeResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Node(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IEchoEffectDefinition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_WetDryMix(double) noexcept = 0;
            virtual std::int32_t __stdcall get_WetDryMix(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_Feedback(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Feedback(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_Delay(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Delay(double*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IEqualizerBand>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Bandwidth(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_Bandwidth(double) noexcept = 0;
            virtual std::int32_t __stdcall get_FrequencyCenter(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_FrequencyCenter(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Gain(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_Gain(double) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IEqualizerEffectDefinition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Bands(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IFrameInputNodeQuantumStartedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RequiredSamples(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::ILimiterEffectDefinition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_Release(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Release(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Loudness(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Loudness(std::uint32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IMediaSourceAudioInputNode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_LoopCount(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Duration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MediaSource(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_MediaSourceCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MediaSourceCompleted(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::IReverbEffectDefinition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_WetDryMix(double) noexcept = 0;
            virtual std::int32_t __stdcall get_WetDryMix(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReflectionsDelay(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ReflectionsDelay(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReverbDelay(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ReverbDelay(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RearDelay(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RearDelay(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PositionLeft(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PositionLeft(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PositionRight(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PositionRight(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PositionMatrixLeft(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PositionMatrixLeft(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PositionMatrixRight(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PositionMatrixRight(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EarlyDiffusion(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_EarlyDiffusion(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_LateDiffusion(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_LateDiffusion(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_LowEQGain(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_LowEQGain(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_LowEQCutoff(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_LowEQCutoff(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_HighEQGain(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_HighEQGain(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_HighEQCutoff(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall get_HighEQCutoff(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RoomFilterFreq(double) noexcept = 0;
            virtual std::int32_t __stdcall get_RoomFilterFreq(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_RoomFilterMain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_RoomFilterMain(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_RoomFilterHF(double) noexcept = 0;
            virtual std::int32_t __stdcall get_RoomFilterHF(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReflectionsGain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_ReflectionsGain(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReverbGain(double) noexcept = 0;
            virtual std::int32_t __stdcall get_ReverbGain(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_DecayTime(double) noexcept = 0;
            virtual std::int32_t __stdcall get_DecayTime(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_Density(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Density(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_RoomSize(double) noexcept = 0;
            virtual std::int32_t __stdcall get_RoomSize(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_DisableLateField(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_DisableLateField(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ISpatialAudioDeviceConfiguration>
    {
        ...
        {
            virtual std::int32_t __stdcall get_DeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSpatialAudioSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsSpatialAudioFormatSupported(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ActiveSpatialAudioFormat(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultSpatialAudioFormat(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetDefaultSpatialAudioFormatAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_ConfigurationChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ConfigurationChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::ISpatialAudioDeviceConfigurationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetForDeviceId(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Audio::ISpatialAudioFormatConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReportLicenseChangedAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportConfigurationChangedAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MixedRealityExclusiveModePolicy(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MixedRealityExclusiveModePolicy(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ISpatialAudioFormatSubtypeStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_WindowsSonic(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DolbyAtmosForHeadphones(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DolbyAtmosForHomeTheater(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DolbyAtmosForSpeakers(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DTSHeadphoneX(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DTSXUltra(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Media_Audio_IAudioFileInputNode
    {
        ...
        auto LoopCount(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
    ...
    struct consume_Windows_Media_Audio_IAudioGraphSettings
    {
        ...
        auto DesiredSamplesPerQuantum(std::int32_t value) const;
    ...
    {
        auto Release(std::uint32_t value) const;
        [[nodiscard]] auto Release() const;
        auto Loudness(std::uint32_t value) const;
    ...
    struct consume_Windows_Media_Audio_IReverbEffectDefinition
    {
        auto WetDryMix(double value) const;
        [[nodiscard]] auto WetDryMix() const;
        auto ReflectionsDelay(std::uint32_t value) const;
        [[nodiscard]] auto ReflectionsDelay() const;
        auto ReverbDelay(std::uint8_t value) const;
        [[nodiscard]] auto ReverbDelay() const;
        auto RearDelay(std::uint8_t value) const;
        [[nodiscard]] auto RearDelay() const;
        auto PositionLeft(std::uint8_t value) const;
        [[nodiscard]] auto PositionLeft() const;
        auto PositionRight(std::uint8_t value) const;
        [[nodiscard]] auto PositionRight() const;
        auto PositionMatrixLeft(std::uint8_t value) const;
        [[nodiscard]] auto PositionMatrixLeft() const;
        auto PositionMatrixRight(std::uint8_t value) const;
        [[nodiscard]] auto PositionMatrixRight() const;
        auto EarlyDiffusion(std::uint8_t value) const;
        [[nodiscard]] auto EarlyDiffusion() const;
        auto LateDiffusion(std::uint8_t value) const;
        [[nodiscard]] auto LateDiffusion() const;
        auto LowEQGain(std::uint8_t value) const;
        [[nodiscard]] auto LowEQGain() const;
        auto LowEQCutoff(std::uint8_t value) const;
        [[nodiscard]] auto LowEQCutoff() const;
        auto HighEQGain(std::uint8_t value) const;
        [[nodiscard]] auto HighEQGain() const;
        auto HighEQCutoff(std::uint8_t value) const;
