...
WINRT_EXPORT namespace winrt::Windows::Networking
{
    ...
    enum class HostNameType : std::int32_t
    {
        DomainName = 0,
        Ipv4 = 1,
        Ipv6 = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Networking::IEndpointPair>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_LocalHostName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalServiceName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LocalServiceName(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall put_RemoteServiceName(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::IEndpointPairFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateEndpointPair(void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::IHostName>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IPInformation(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RawName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanonicalName(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Networking::IHostNameFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateHostName(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::IHostNameStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Compare(void*, void*, std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
