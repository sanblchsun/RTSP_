...
{
    enum class DayFormat : std::int32_t
    {
        None = 0,
        Default = 1,
    };
    enum class DayOfWeekFormat : std::int32_t
    {
        None = 0,
        Default = 1,
        Abbreviated = 2,
    ...
    enum class HourFormat : std::int32_t
    {
        None = 0,
        Default = 1,
    };
    enum class MinuteFormat : std::int32_t
    {
        None = 0,
        Default = 1,
    };
    enum class MonthFormat : std::int32_t
    {
        None = 0,
        Default = 1,
        Abbreviated = 2,
    ...
    enum class SecondFormat : std::int32_t
    {
        None = 0,
        Default = 1,
    };
    enum class YearFormat : std::int32_t
    {
        None = 0,
        Default = 1,
        Abbreviated = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Globalization::DateTimeFormatting::IDateTimeFormatter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Calendar(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Clock(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Patterns(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Template(void**) noexcept = 0;
            virtual std::int32_t __stdcall Format(std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeYear(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeMonth(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeDayOfWeek(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeDay(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeHour(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeMinute(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeSecond(std::int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Globalization::DateTimeFormatting::IDateTimeFormatter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FormatUsingTimeZone(std::int64_t, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Globalization::DateTimeFormatting::IDateTimeFormatterFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateDateTimeFormatter(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDateTimeFormatterLanguages(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDateTimeFormatterContext(void*, void*, void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDateTimeFormatterDate(std::int32_t, std::int32_t, std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDateTimeFormatterTime(std::int32_t, std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDateTimeFormatterDateTimeLanguages(std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDateTimeFormatterDateTimeContext(std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Globalization::DateTimeFormatting::IDateTimeFormatterStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LongDate(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LongTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ShortDate(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ShortTime(void**) noexcept = 0;
        };
    };
    template <typename D>
