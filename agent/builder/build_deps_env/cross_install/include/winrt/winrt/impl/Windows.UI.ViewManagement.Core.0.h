...
{
    enum class CoreInputViewKind : std::int32_t
    {
        Default = 0,
        Keyboard = 1,
        Handwriting = 2,
    ...
    enum class CoreInputViewOcclusionKind : std::int32_t
    {
        Docked = 0,
        Floating = 1,
        Overlay = 2,
    };
    enum class CoreInputViewXYFocusTransferDirection : std::int32_t
    {
        Up = 0,
        Right = 1,
        Down = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputView>
    {
        ...
        {
            virtual std::int32_t __stdcall add_OcclusionsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_OcclusionsChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetCoreInputViewOcclusions(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryShowPrimaryView(bool*) noexcept = 0;
            virtual std::int32_t __stdcall TryHidePrimaryView(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputView2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_XYFocusTransferringFromPrimaryView(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_XYFocusTransferringFromPrimaryView(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_XYFocusTransferredToPrimaryView(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_XYFocusTransferredToPrimaryView(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall TryTransferXYFocusToPrimaryView(winrt::Windows::Foundation::Rect, std::int32_t, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputView3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall TryShowWithKind(std::int32_t, bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputView4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_PrimaryViewShowing(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PrimaryViewShowing(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PrimaryViewHiding(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PrimaryViewHiding(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputViewOcclusion>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_OcclusionKind(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputViewOcclusionsChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Occlusions(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputViewTransferringXYFocusEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Origin(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall get_Direction(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TransferHandled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_TransferHandled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_KeepPrimaryViewVisible(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_KeepPrimaryViewVisible(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::IUISettingsController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetAdvancedEffectsEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall SetAnimationsEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall SetAutoHideScrollBars(bool) noexcept = 0;
            virtual std::int32_t __stdcall SetMessageDuration(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetTextScaleFactor(double) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::IUISettingsControllerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestDefaultAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_UI_ViewManagement_Core_IUISettingsController
    {
        ...
        auto SetMessageDuration(std::uint32_t value) const;
