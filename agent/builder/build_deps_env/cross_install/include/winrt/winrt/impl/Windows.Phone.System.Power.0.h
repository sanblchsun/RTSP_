...
{
    enum class PowerSavingMode : std::int32_t
    {
        Off = 0,
        On = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::System::Power::IPowerManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_PowerSavingMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_PowerSavingModeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PowerSavingModeChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::System::Power::IPowerManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PowerSavingModeEnabled(bool*) noexcept = 0;
        };
    };
    template <typename D>
