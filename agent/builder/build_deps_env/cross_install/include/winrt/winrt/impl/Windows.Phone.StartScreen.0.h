...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::StartScreen::IDualSimTile>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsPinnedToStart(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::StartScreen::IDualSimTileStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetTileForSim2(void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateDisplayNameForSim1Async(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateTileUpdaterForSim1(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateTileUpdaterForSim2(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateBadgeUpdaterForSim1(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateBadgeUpdaterForSim2(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateToastNotifierForSim1(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateToastNotifierForSim2(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::StartScreen::IToastNotificationManagerStatics3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateToastNotifierForSecondaryTile(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
