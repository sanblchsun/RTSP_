...
{
    enum class MediaPlaybackAutoRepeatMode : std::int32_t;
    enum class MediaPlaybackType : std::int32_t;
...
{
    enum class MediaRotation : std::int32_t;
    enum class SphericalVideoFrameFormat : std::int32_t;
    enum class StereoscopicVideoPackingMode : std::int32_t;
}
...
{
    enum class AutoLoadedDisplayPropertyKind : std::int32_t
    {
        None = 0,
        MusicOrVideo = 1,
        Music = 2,
    ...
    enum class FailedMediaStreamKind : std::int32_t
    {
        Unknown = 0,
        Audio = 1,
        Video = 2,
    };
    enum class MediaBreakInsertionMethod : std::int32_t
    {
        Interrupt = 0,
        Replace = 1,
    };
    enum class MediaCommandEnablingRule : std::int32_t
    {
        Auto = 0,
        Always = 1,
        Never = 2,
    };
    enum class MediaPlaybackItemChangedReason : std::int32_t
    {
        InitialItem = 0,
        EndOfStream = 1,
        Error = 2,
    ...
    enum class MediaPlaybackItemErrorCode : std::int32_t
    {
        None = 0,
        Aborted = 1,
        NetworkError = 2,
    ...
    enum class MediaPlaybackSessionVideoConstrictionReason : std::int32_t
    {
        None = 0,
        VirtualMachine = 1,
    ...
    enum class MediaPlaybackState : std::int32_t
    {
        None = 0,
        Opening = 1,
        Buffering = 2,
    ...
    enum class MediaPlayerAudioCategory : std::int32_t
    {
        Other = 0,
        Communications = 3,
        Alerts = 4,
    ...
    enum class MediaPlayerAudioDeviceType : std::int32_t
    {
        Console = 0,
        Multimedia = 1,
        Communications = 2,
    };
    enum class MediaPlayerError : std::int32_t
    {
        Unknown = 0,
        Aborted = 1,
        NetworkError = 2,
    ...
    enum class SphericalVideoProjectionMode : std::int32_t
    {
        Spherical = 0,
        Flat = 1,
    };
    enum class StereoscopicVideoRenderMode : std::int32_t
    {
        Mono = 0,
        Stereo = 1,
    };
    enum class TimedMetadataTrackPresentationMode : std::int32_t
    {
        Disabled = 0,
        Hidden = 1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IBackgroundMediaPlayerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_MessageReceivedFromBackground(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MessageReceivedFromBackground(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_MessageReceivedFromForeground(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MessageReceivedFromForeground(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall SendMessageToBackground(void*) noexcept = 0;
            virtual std::int32_t __stdcall SendMessageToForeground(void*) noexcept = 0;
            virtual std::int32_t __stdcall IsMediaPlaying(bool*) noexcept = 0;
            virtual std::int32_t __stdcall Shutdown() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::ICurrentMediaPlaybackItemChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NewItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OldItem(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaBreak>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PlaybackList(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PresentationPosition(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InsertionMethod(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanStart(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanStart(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaBreakEndedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MediaBreak(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaBreakFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithPresentationPosition(std::int32_t, std::int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaBreakManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_BreaksSeekedOver(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BreaksSeekedOver(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BreakStarted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BreakStarted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BreakEnded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BreakEnded(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BreakSkipped(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BreakSkipped(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentBreak(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackSession(void**) noexcept = 0;
            virtual std::int32_t __stdcall PlayBreak(void*) noexcept = 0;
            virtual std::int32_t __stdcall SkipCurrentBreak() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaBreakSchedule>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_ScheduleChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ScheduleChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall InsertMidrollBreak(void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveMidrollBreak(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_MidrollBreaks(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PrerollBreak(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PrerollBreak(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PostrollBreak(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PostrollBreak(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaBreakSeekedOverEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SeekedOverBreaks(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OldPosition(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NewPosition(std::int64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaEnginePlaybackSource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CurrentItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetPlaybackSource(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaItemDisplayProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Type(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall ClearAll() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackCommandManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MediaPlayer(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PlayBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PauseBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NextBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PreviousBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FastForwardBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RewindBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ShuffleBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoRepeatModeBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PositionBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RateBehavior(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_PlayReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PlayReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PauseReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PauseReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_NextReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NextReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PreviousReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PreviousReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_FastForwardReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_FastForwardReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_RewindReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RewindReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ShuffleReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ShuffleReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_AutoRepeatModeReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AutoRepeatModeReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PositionReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PositionReceived(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_RateReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RateReceived(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AutoRepeatMode(std::int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackCommandManagerCommandBehavior>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CommandManager(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_EnablingRule(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EnablingRule(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall add_IsEnabledChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsEnabledChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackCommandManagerPositionReceivedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Handled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_Handled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Position(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackCommandManagerRateReceivedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Handled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_Handled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackRate(double*) noexcept = 0;
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackCommandManagerShuffleReceivedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Handled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_Handled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsShuffleRequested(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_AudioTracksChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AudioTracksChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_VideoTracksChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_VideoTracksChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_TimedMetadataTracksChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TimedMetadataTracksChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_Source(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioTracks(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_VideoTracks(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackItem2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BreakSchedule(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_StartTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DurationLimit(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanSkip(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanSkip(bool) noexcept = 0;
            virtual std::int32_t __stdcall GetDisplayProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall ApplyDisplayProperties(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackItem3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsDisabledInPlaybackList(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsDisabledInPlaybackList(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_TotalDownloadProgress(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoLoadedDisplayProperties(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoLoadedDisplayProperties(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackItemFactory2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithStartTime(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithStartTimeAndDurationLimit(void*, std::int64_t, std::int64_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackItemStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindFromMediaSource(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackList>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_ItemFailed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ItemFailed(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CurrentItemChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CurrentItemChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ItemOpened(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ItemOpened(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_Items(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoRepeatEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoRepeatEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ShuffleEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ShuffleEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentItemIndex(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveNext(void**) noexcept = 0;
            virtual std::int32_t __stdcall MovePrevious(void**) noexcept = 0;
            virtual std::int32_t __stdcall MoveTo(std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackList2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MaxPrefetchTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxPrefetchTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_StartingItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_StartingItem(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ShuffledItems(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetShuffledItems(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackList3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MaxPlayedItemsToKeepOpen(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxPlayedItemsToKeepOpen(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_PlaybackStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PlaybackStateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PlaybackRateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PlaybackRateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SeekCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SeekCompleted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BufferingStarted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BufferingStarted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BufferingEnded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BufferingEnded(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BufferingProgressChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BufferingProgressChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_DownloadProgressChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DownloadProgressChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_NaturalDurationChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NaturalDurationChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PositionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PositionChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_NaturalVideoSizeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NaturalVideoSizeChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_MediaPlayer(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NaturalDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Position(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Position(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanSeek(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanPause(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsProtected(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackRate(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_PlaybackRate(double) noexcept = 0;
            virtual std::int32_t __stdcall get_BufferingProgress(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_DownloadProgress(double*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_NormalizedSourceRect(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall put_NormalizedSourceRect(winrt::Windows::Foundation::Rect) noexcept = 0;
            virtual std::int32_t __stdcall get_StereoscopicVideoPackingMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StereoscopicVideoPackingMode(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackSession2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_BufferedRangesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BufferedRangesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PlayedRangesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PlayedRangesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SeekableRangesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SeekableRangesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SupportedPlaybackRatesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SupportedPlaybackRatesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_SphericalVideoProjection(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsMirroring(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsMirroring(bool) noexcept = 0;
            virtual std::int32_t __stdcall GetBufferedRanges(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPlayedRanges(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSeekableRanges(void**) noexcept = 0;
            virtual std::int32_t __stdcall IsSupportedPlaybackRateRange(double, double, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackSession3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PlaybackRotation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PlaybackRotation(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetOutputDegradationPolicyState(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackSessionBufferingStartedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsPlaybackInterruption(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackSessionOutputDegradationPolicyState>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_VideoConstrictionReason(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackSphericalVideoProjection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_FrameFormat(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_FrameFormat(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_HorizontalFieldOfViewInDegrees(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_HorizontalFieldOfViewInDegrees(double) noexcept = 0;
            virtual std::int32_t __stdcall get_ViewOrientation(winrt::Windows::Foundation::Numerics::quaternion*) noexcept = 0;
            virtual std::int32_t __stdcall put_ViewOrientation(winrt::Windows::Foundation::Numerics::quaternion) noexcept = 0;
            virtual std::int32_t __stdcall get_ProjectionMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ProjectionMode(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlaybackTimedMetadataTrackList>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_PresentationModeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PresentationModeChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetPresentationMode(std::uint32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetPresentationMode(std::uint32_t, std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Position(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_BufferingProgress(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanSeek(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanPause(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsLoopingEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsLoopingEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsProtected(bool*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_PlaybackMediaMarkers(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_PlaybackMediaMarkerReached(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PlaybackMediaMarkerReached(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_MediaPlayerRateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MediaPlayerRateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_VolumeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_VolumeChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SeekCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SeekCompleted(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_BufferingStarted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BufferingStarted(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall SetUriSource(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SystemMediaTransportControls(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioCategory(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioCategory(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioDeviceType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioDeviceType(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AudioBalance(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioBalance(double) noexcept = 0;
            virtual std::int32_t __stdcall get_RealTimePlayback(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_RealTimePlayback(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_StereoscopicVideoRenderMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StereoscopicVideoRenderMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_BreakManager(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CommandManager(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioDevice(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioDevice(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimelineController(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TimelineController(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimelineControllerPositionOffset(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TimelineControllerPositionOffset(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PlaybackSession(void**) noexcept = 0;
            virtual std::int32_t __stdcall StepForwardOneFrame() noexcept = 0;
            virtual std::int32_t __stdcall StepBackwardOneFrame() noexcept = 0;
            virtual std::int32_t __stdcall GetAsCastingSource(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetSurfaceSize(winrt::Windows::Foundation::Size) noexcept = 0;
            virtual std::int32_t __stdcall GetSurface(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_VideoFrameAvailable(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_VideoFrameAvailable(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_IsVideoFrameServerEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsVideoFrameServerEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall CopyFrameToVideoSurface(void*) noexcept = 0;
            virtual std::int32_t __stdcall CopyFrameToVideoSurfaceWithTargetRectangle(void*, winrt::Windows::Foundation::Rect) noexcept = 0;
            virtual std::int32_t __stdcall CopyFrameToStereoscopicVideoSurfaces(void*, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer6>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_SubtitleFrameChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SubtitleFrameChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall RenderSubtitlesToSurface(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall RenderSubtitlesToSurfaceWithTargetRectangle(void*, winrt::Windows::Foundation::Rect, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayer7>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AudioStateMonitor(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayerEffects>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddAudioEffect(void*, bool, void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveAllEffects() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayerEffects2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddVideoEffect(void*, bool, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayerFailedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ExtendedErrorCode(winrt::hresult*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayerRateChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NewRate(double*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayerSource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ProtectionManager(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ProtectionManager(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetFileSource(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetStreamSource(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetMediaSource(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IMediaPlayerSurface>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CompositionSurface(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IPlaybackMediaMarker>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Time(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MediaMarkerType(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::IPlaybackMediaMarkerFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromTime(std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall Create(std::int64_t, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IPlaybackMediaMarkerReachedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PlaybackMediaMarker(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Playback::IPlaybackMediaMarkerSequence>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Size(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Insert(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Playback::ITimedMetadataPresentationModeChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Track(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OldPresentationMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NewPresentationMode(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Media_Playback_IMediaPlaybackList
    {
        ...
        auto MoveTo(std::uint32_t itemIndex) const;
    };
    ...
    struct consume_Windows_Media_Playback_IMediaPlaybackList3
    {
        ...
        auto MaxPlayedItemsToKeepOpen(winrt::Windows::Foundation::IReference<std::uint32_t> const& value) const;
    };
    ...
    struct consume_Windows_Media_Playback_IMediaPlaybackTimedMetadataTrackList
    {
        ...
        auto GetPresentationMode(std::uint32_t index) const;
        auto SetPresentationMode(std::uint32_t index, winrt::Windows::Media::Playback::TimedMetadataTrackPresentationMode const& value) const;
    };
