...
WINRT_EXPORT namespace winrt::Windows::Media::Transcoding
{
    ...
    enum class TranscodeFailureReason : std::int32_t
    {
        None = 0,
        Unknown = 1,
        InvalidProfile = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Transcoding::IMediaTranscoder>
    {
        ...
        {
            virtual std::int32_t __stdcall put_TrimStartTime(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TrimStartTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TrimStopTime(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TrimStopTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AlwaysReencode(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AlwaysReencode(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_HardwareAccelerationEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_HardwareAccelerationEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall AddAudioEffect(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddAudioEffectWithSettings(void*, bool, void*) noexcept = 0;
            virtual std::int32_t __stdcall AddVideoEffect(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddVideoEffectWithSettings(void*, bool, void*) noexcept = 0;
            virtual std::int32_t __stdcall ClearEffects() noexcept = 0;
            virtual std::int32_t __stdcall PrepareFileTranscodeAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall PrepareStreamTranscodeAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Transcoding::IMediaTranscoder2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall PrepareMediaStreamSourceTranscodeAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall put_VideoProcessingAlgorithm(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_VideoProcessingAlgorithm(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Transcoding::IPrepareTranscodeResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanTranscode(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_FailureReason(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall TranscodeAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
