...
{
    enum class WalletItemAppAssociation : std::int32_t
    {
        None = 0,
        AppInstalled = 1,
        AppNotInstalled = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetAppStatusForItem(void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall LaunchAppForItemAsync(void*, void**) noexcept = 0;
        };
    };
