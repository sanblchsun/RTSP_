...
{
    enum class PrintWorkflowSessionStatus : std::int32_t
    {
        Started = 0,
        Completed = 1,
        Aborted = 2,
    ...
    enum class PrintWorkflowSubmittedStatus : std::int32_t
    {
        Succeeded = 0,
        Canceled = 1,
        Failed = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowBackgroundSession>
    {
        ...
        {
            virtual std::int32_t __stdcall add_SetupRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SetupRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_Submitted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_Submitted(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowBackgroundSetupRequestedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetUserPrintTicketAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Configuration(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetRequiresUI() noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SourceAppDisplayName(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowForegroundSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_SetupRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SetupRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_XpsDataAvailable(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_XpsDataAvailable(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Start() noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowSourceContent>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetJobPrintTicketAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSourceSpoolDataAsStreamContent(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSourceSpoolDataAsXpsObjectModel(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowSpoolStreamContent>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetInputStream(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowStreamTarget>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetOutputStream(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowSubmittedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetTarget(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowSubmittedOperation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Complete(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Configuration(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_XpsContent(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowTarget>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_TargetAsStream(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TargetAsXpsObjectModelPackage(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PrintWorkflowSession(void**) noexcept = 0;
        };
    };
