...
{
    enum class PlatformTelemetryRegistrationStatus : std::int32_t
    {
        Success = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Diagnostics::Telemetry::IPlatformTelemetryClientStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall Register(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterWithSettings(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::Diagnostics::Telemetry::IPlatformTelemetryRegistrationSettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_StorageSize(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StorageSize(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_UploadQuotaSize(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UploadQuotaSize(std::uint32_t) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryRegistrationSettings
    {
        ...
        auto StorageSize(std::uint32_t value) const;
        [[nodiscard]] auto UploadQuotaSize() const;
        auto UploadQuotaSize(std::uint32_t value) const;
    };
