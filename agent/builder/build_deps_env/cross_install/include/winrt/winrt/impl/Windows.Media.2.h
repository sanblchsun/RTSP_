...
WINRT_EXPORT namespace winrt::Windows::Media
{
    ...
    struct WINRT_IMPL_EMPTY_BASES AudioFrame : winrt::Windows::Media::IAudioFrame
    {
        ...
        explicit AudioFrame(std::uint32_t capacity);
    };
        ...
        impl::require<VideoFrame, winrt::Windows::Media::IVideoFrame2>
    {
        ...
        VideoFrame(winrt::Windows::Graphics::Imaging::BitmapPixelFormat const& format, std::int32_t width, std::int32_t height);
        VideoFrame(winrt::Windows::Graphics::Imaging::BitmapPixelFormat const& format, std::int32_t width, std::int32_t height, winrt::Windows::Graphics::Imaging::BitmapAlphaMode const& alpha);
        ...
        static auto CreateAsDirect3D11SurfaceBacked(winrt::Windows::Graphics::DirectX::DirectXPixelFormat const& format, std::int32_t width, std::int32_t height);
        static auto CreateAsDirect3D11SurfaceBacked(winrt::Windows::Graphics::DirectX::DirectXPixelFormat const& format, std::int32_t width, std::int32_t height, winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DDevice const& device);
