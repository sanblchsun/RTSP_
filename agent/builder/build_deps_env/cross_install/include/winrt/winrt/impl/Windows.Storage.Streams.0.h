...
{
    enum class ByteOrder : std::int32_t
    {
        LittleEndian = 0,
        BigEndian = 1,
    };
    enum class FileOpenDisposition : std::int32_t
    {
        OpenExisting = 0,
        OpenAlways = 1,
        CreateNew = 2,
    ...
    enum class InputStreamOptions : std::uint32_t
    {
        None = 0,
        Partial = 0x1,
        ReadAhead = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct default_interface<winrt::Windows::Storage::Streams::DataReaderLoadOperation>{ using type = winrt::Windows::Foundation::IAsyncOperation<std::uint32_t>; };
    ...
    template <> struct default_interface<winrt::Windows::Storage::Streams::DataWriterStoreOperation>{ using type = winrt::Windows::Foundation::IAsyncOperation<std::uint32_t>; };
    ...
    template <> struct abi<winrt::Windows::Storage::Streams::IBufferStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateCopyFromMemoryBuffer(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateMemoryBufferOverIBuffer(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Storage::Streams::IDataReader>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UnconsumedBufferLength(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UnicodeEncoding(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UnicodeEncoding(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ByteOrder(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ByteOrder(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_InputStreamOptions(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_InputStreamOptions(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReadByte(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadBytes(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadBuffer(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReadBoolean(bool*) noexcept = 0;
            virtual std::int32_t __stdcall ReadGuid(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall ReadInt16(std::int16_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadInt32(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadInt64(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadUInt16(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadUInt32(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadUInt64(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadSingle(float*) noexcept = 0;
            virtual std::int32_t __stdcall ReadDouble(double*) noexcept = 0;
            virtual std::int32_t __stdcall ReadString(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReadDateTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall ReadTimeSpan(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall LoadAsync(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall DetachBuffer(void**) noexcept = 0;
            virtual std::int32_t __stdcall DetachStream(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IDataReaderFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateDataReader(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IDataReaderStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromBuffer(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IDataWriter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UnstoredBufferLength(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UnicodeEncoding(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UnicodeEncoding(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ByteOrder(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ByteOrder(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteByte(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteBytes(std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall WriteBuffer(void*) noexcept = 0;
            virtual std::int32_t __stdcall WriteBufferRange(void*, std::uint32_t, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteBoolean(bool) noexcept = 0;
            virtual std::int32_t __stdcall WriteGuid(winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall WriteInt16(std::int16_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteInt32(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteInt64(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteUInt16(std::uint16_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteUInt32(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteUInt64(std::uint64_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteSingle(float) noexcept = 0;
            virtual std::int32_t __stdcall WriteDouble(double) noexcept = 0;
            virtual std::int32_t __stdcall WriteDateTime(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteTimeSpan(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall WriteString(void*, std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MeasureString(void*, std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall StoreAsync(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::Streams::IDataWriterFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateDataWriter(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IFileRandomAccessStreamStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OpenAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenWithOptionsAsync(void*, std::int32_t, std::uint32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenTransactedWriteAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenTransactedWriteWithOptionsAsync(void*, std::uint32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenForUserAsync(void*, void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenForUserWithOptionsAsync(void*, void*, std::int32_t, std::uint32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenTransactedWriteForUserAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenTransactedWriteForUserWithOptionsAsync(void*, void*, std::uint32_t, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IInputStream>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReadAsync(void*, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IInputStreamReference>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OpenSequentialReadAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IOutputStream>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall WriteAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FlushAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IRandomAccessStream>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Size(std::uint64_t) noexcept = 0;
            virtual std::int32_t __stdcall GetInputStreamAt(std::uint64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetOutputStreamAt(std::uint64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Position(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall Seek(std::uint64_t) noexcept = 0;
            virtual std::int32_t __stdcall CloneStream(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanRead(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanWrite(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IRandomAccessStreamReference>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OpenReadAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Storage::Streams::IRandomAccessStreamReferenceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromFile(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::Streams::IRandomAccessStreamStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CopyAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CopySizeAsync(void*, void*, std::uint64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CopyAndCloseAsync(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Storage_Streams_IDataReader
    {
        ...
        auto ReadByte() const;
        auto ReadBytes(array_view<std::uint8_t> value) const;
        auto ReadBuffer(std::uint32_t length) const;
        ...
        auto ReadString(std::uint32_t codeUnitCount) const;
        auto ReadDateTime() const;
        auto ReadTimeSpan() const;
        auto LoadAsync(std::uint32_t count) const;
    ...
    struct consume_Windows_Storage_Streams_IDataWriter
    {
        ...
        [[nodiscard]] auto ByteOrder() const;
        auto ByteOrder(winrt::Windows::Storage::Streams::ByteOrder const& value) const;
        auto WriteByte(std::uint8_t value) const;
        auto WriteBytes(array_view<std::uint8_t const> value) const;
        auto WriteBuffer(winrt::Windows::Storage::Streams::IBuffer const& buffer) const;
        auto WriteBuffer(winrt::Windows::Storage::Streams::IBuffer const& buffer, std::uint32_t start, std::uint32_t count) const;
        auto WriteBoolean(bool value) const;
        auto WriteGuid(winrt::guid const& value) const;
        auto WriteInt16(std::int16_t value) const;
        auto WriteInt32(std::int32_t value) const;
        auto WriteInt64(std::int64_t value) const;
        auto WriteUInt16(std::uint16_t value) const;
        auto WriteUInt32(std::uint32_t value) const;
        auto WriteUInt64(std::uint64_t value) const;
    ...
    {
        auto ReadAsync(winrt::Windows::Storage::Streams::IBuffer const& buffer, std::uint32_t count, winrt::Windows::Storage::Streams::InputStreamOptions const& options) const;
    };
    ...
    struct consume_Windows_Storage_Streams_IRandomAccessStream
    {
        ...
        auto Size(std::uint64_t value) const;
        auto GetInputStreamAt(std::uint64_t position) const;
        auto GetOutputStreamAt(std::uint64_t position) const;
        [[nodiscard]] auto Position() const;
        auto Seek(std::uint64_t position) const;
    ...
    struct consume_Windows_Storage_Streams_IRandomAccessStreamStatics
    {
        ...
        auto CopyAsync(winrt::Windows::Storage::Streams::IInputStream const& source, winrt::Windows::Storage::Streams::IOutputStream const& destination, std::uint64_t bytesToCopy) const;
