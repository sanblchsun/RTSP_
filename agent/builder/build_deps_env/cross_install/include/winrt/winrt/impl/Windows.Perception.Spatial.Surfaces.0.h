...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Perception::Spatial::Surfaces::ISpatialSurfaceInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall TryGetBounds(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryComputeLatestMeshAsync(double, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryComputeLatestMeshWithOptionsAsync(double, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMesh>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SurfaceInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CoordinateSystem(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TriangleIndices(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_VertexPositions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_VertexPositionScale(winrt::Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual std::int32_t __stdcall get_VertexNormals(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMeshBuffer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Stride(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ElementCount(std::uint32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMeshOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_VertexPositionFormat(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_VertexPositionFormat(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TriangleIndexFormat(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TriangleIndexFormat(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_VertexNormalFormat(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_VertexNormalFormat(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeVertexNormals(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeVertexNormals(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMeshOptionsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SupportedVertexPositionFormats(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedTriangleIndexFormats(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedVertexNormalFormats(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::Spatial::Surfaces::ISpatialSurfaceObserver>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetObservedSurfaces(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetBoundingVolume(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetBoundingVolumes(void*) noexcept = 0;
            virtual std::int32_t __stdcall add_ObservedSurfacesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ObservedSurfacesChanged(winrt::event_token) noexcept = 0;
        };
    };
