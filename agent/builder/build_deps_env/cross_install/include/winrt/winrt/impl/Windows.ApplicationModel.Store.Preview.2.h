...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Store::Preview
{
    ...
    struct StoreConfiguration
    {
        ...
        static auto SetMobileOperatorConfiguration(param::hstring const& mobileOperatorId, std::uint32_t appDownloadLimitInMegabytes, std::uint32_t updateDownloadLimitInMegabytes);
        ...
        static auto PurchasePromptingPolicy(winrt::Windows::Foundation::IReference<std::uint32_t> const& value);
        ...
        static auto SetPurchasePromptingPolicyForUser(winrt::Windows::System::User const& user, winrt::Windows::Foundation::IReference<std::uint32_t> const& value);
