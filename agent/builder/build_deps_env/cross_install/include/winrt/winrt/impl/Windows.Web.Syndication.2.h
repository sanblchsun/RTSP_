...
WINRT_EXPORT namespace winrt::Windows::Web::Syndication
{
    ...
    struct WINRT_IMPL_EMPTY_BASES SyndicationLink : winrt::Windows::Web::Syndication::ISyndicationLink
    {
        ...
        SyndicationLink(winrt::Windows::Foundation::Uri const& uri, param::hstring const& relationship, param::hstring const& title, param::hstring const& mediaType, std::uint32_t length);
    };
