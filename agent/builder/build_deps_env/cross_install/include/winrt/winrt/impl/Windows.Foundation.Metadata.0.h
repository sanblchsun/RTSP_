...
{
    enum class AttributeTargets : std::uint32_t
    {
        All = 0xffffffff,
        Delegate = 0x1,
        Enum = 0x2,
    ...
    enum class CompositionType : std::int32_t
    {
        Protected = 1,
        Public = 2,
    };
    enum class DeprecationType : std::int32_t
    {
        Deprecate = 0,
        Remove = 1,
    };
    enum class FeatureStage : std::int32_t
    {
        AlwaysDisabled = 0,
        DisabledByDefault = 1,
        EnabledByDefault = 2,
    ...
    enum class GCPressureAmount : std::int32_t
    {
        Low = 0,
        Medium = 1,
        High = 2,
    };
    enum class MarshalingType : std::int32_t
    {
        None = 1,
        Agile = 2,
        Standard = 3,
    ...
    enum class ThreadingModel : std::int32_t
    {
        STA = 1,
        MTA = 2,
        Both = 3,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Foundation::Metadata::IApiInformationStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall IsTypePresent(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsMethodPresent(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsMethodPresentWithArity(void*, void*, std::uint32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsEventPresent(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsPropertyPresent(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsReadOnlyPropertyPresent(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsWriteablePropertyPresent(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsEnumNamedValuePresent(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsApiContractPresentByMajor(void*, std::uint16_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsApiContractPresentByMajorAndMinor(void*, std::uint16_t, std::uint16_t, bool*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Foundation_Metadata_IApiInformationStatics
    {
        ...
        auto IsMethodPresent(param::hstring const& typeName, param::hstring const& methodName, std::uint32_t inputParameterCount) const;
        ...
        auto IsApiContractPresent(param::hstring const& contractName, std::uint16_t majorVersion) const;
        auto IsApiContractPresent(param::hstring const& contractName, std::uint16_t majorVersion, std::uint16_t minorVersion) const;
    };
