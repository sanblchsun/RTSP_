...
{
    enum class ExtendedExecutionForegroundReason : std::int32_t
    {
        Unspecified = 0,
        SavingData = 1,
        BackgroundAudio = 2,
    ...
    enum class ExtendedExecutionForegroundResult : std::int32_t
    {
        Allowed = 0,
        Denied = 1,
    };
    enum class ExtendedExecutionForegroundRevokedReason : std::int32_t
    {
        Resumed = 0,
        SystemPolicy = 1,
    };
