...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Web::AtomPub::IAtomPubClient>
    {
        ...
        {
            virtual std::int32_t __stdcall RetrieveServiceDocumentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RetrieveMediaResourceAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RetrieveResourceAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateResourceAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateMediaResourceAsync(void*, void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateMediaResourceAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateResourceAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateResourceItemAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteResourceAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteResourceItemAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CancelAsyncOperations() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::AtomPub::IAtomPubClientFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateAtomPubClientWithCredentials(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::AtomPub::IResourceCollection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Accepts(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::AtomPub::IServiceDocument>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Workspaces(void**) noexcept = 0;
        };
    };
