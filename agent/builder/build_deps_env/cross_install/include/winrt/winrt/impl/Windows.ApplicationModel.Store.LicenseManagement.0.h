...
{
    enum class LicenseRefreshOption : std::int32_t
    {
        RunningLicenses = 0,
        AllLicenses = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall AddLicenseAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSatisfactionInfosAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RefreshLicensesAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SatisfiedByDevice(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SatisfiedByOpenLicense(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SatisfiedByTrial(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SatisfiedByPass(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SatisfiedByInstallMedia(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SatisfiedBySignedInUser(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSatisfied(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LicenseSatisfactionInfos(void**) noexcept = 0;
