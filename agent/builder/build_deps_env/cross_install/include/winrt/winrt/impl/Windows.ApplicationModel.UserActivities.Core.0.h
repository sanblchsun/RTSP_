...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::UserActivities::Core::ICoreUserActivityManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall CreateUserActivitySessionInBackground(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteUserActivitySessionsInTimeRangeAsync(void*, std::int64_t, std::int64_t, void**) noexcept = 0;
        };
    };
    template <typename D>
