...
WINRT_EXPORT namespace winrt::Windows::Devices::HumanInterfaceDevice
{
    ...
    struct WINRT_IMPL_EMPTY_BASES HidDevice : winrt::Windows::Devices::HumanInterfaceDevice::IHidDevice
    {
        ...
        static auto GetDeviceSelector(std::uint16_t usagePage, std::uint16_t usageId);
        static auto GetDeviceSelector(std::uint16_t usagePage, std::uint16_t usageId, std::uint16_t vendorId, std::uint16_t productId);
