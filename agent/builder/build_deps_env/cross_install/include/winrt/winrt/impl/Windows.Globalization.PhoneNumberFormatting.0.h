...
{
    enum class PhoneNumberFormat : std::int32_t
    {
        E164 = 0,
        International = 1,
        National = 2,
    ...
    enum class PhoneNumberMatchResult : std::int32_t
    {
        NoMatch = 0,
    ...
    enum class PhoneNumberParseResult : std::int32_t
    {
        Valid = 0,
        NotANumber = 1,
    ...
    enum class PredictedPhoneNumberKind : std::int32_t
    {
        FixedLine = 0,
        Mobile = 1,
        FixedLineOrMobile = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Globalization::PhoneNumberFormatting::IPhoneNumberFormatter>
    {
        ...
        {
            virtual std::int32_t __stdcall Format(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FormatWithOutputFormat(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FormatPartialString(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FormatString(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FormatStringWithLeftToRightMarkers(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Globalization::PhoneNumberFormatting::IPhoneNumberFormatterStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryCreate(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCountryCodeForRegion(void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetNationalDirectDialingPrefixForRegion(void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall WrapWithLeftToRightMarkers(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Globalization::PhoneNumberFormatting::IPhoneNumberInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CountryCode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLengthOfGeographicalAreaCode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetNationalSignificantNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLengthOfNationalDestinationCode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall PredictNumberKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetGeographicRegionCode(void**) noexcept = 0;
            virtual std::int32_t __stdcall CheckNumberMatch(void*, std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Globalization::PhoneNumberFormatting::IPhoneNumberInfoStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryParse(void*, void**, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall TryParseWithRegion(void*, void*, void**, std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
