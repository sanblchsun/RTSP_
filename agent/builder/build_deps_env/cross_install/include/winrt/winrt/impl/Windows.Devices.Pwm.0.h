...
{
    enum class PwmPulsePolarity : std::int32_t
    {
        ActiveHigh = 0,
        ActiveLow = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Pwm::IPwmController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ActualFrequency(double*) noexcept = 0;
            virtual std::int32_t __stdcall SetDesiredFrequency(double, double*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinFrequency(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxFrequency(double*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Pwm::IPwmPin>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetActiveDutyCyclePercentage(double*) noexcept = 0;
            virtual std::int32_t __stdcall SetActiveDutyCyclePercentage(double) noexcept = 0;
