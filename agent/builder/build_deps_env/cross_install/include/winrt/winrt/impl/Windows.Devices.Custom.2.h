...
WINRT_EXPORT namespace winrt::Windows::Devices::Custom
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IOControlCode : winrt::Windows::Devices::Custom::IIOControlCode
    {
        ...
        IOControlCode(std::uint16_t deviceType, std::uint16_t function, winrt::Windows::Devices::Custom::IOControlAccessMode const& accessMode, winrt::Windows::Devices::Custom::IOControlBufferingMethod const& bufferingMethod);
    };
