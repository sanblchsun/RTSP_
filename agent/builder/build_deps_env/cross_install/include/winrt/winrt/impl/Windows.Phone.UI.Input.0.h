...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_BackPressed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_BackPressed(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_CameraHalfPressed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CameraHalfPressed(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CameraPressed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CameraPressed(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CameraReleased(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CameraReleased(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
