...
{
    enum class HdmiDisplayColorSpace : std::int32_t
    {
        RgbLimited = 0,
        RgbFull = 1,
        BT2020 = 2,
    ...
    enum class HdmiDisplayHdrOption : std::int32_t
    {
        None = 0,
        EotfSdr = 1,
        Eotf2084 = 2,
    ...
    enum class HdmiDisplayPixelEncoding : std::int32_t
    {
        Rgb444 = 0,
        Ycc444 = 1,
        Ycc422 = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Graphics::Display::Core::HdmiDisplayHdr2086Metadata>{ using type = struct_category<std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t>; };
    ...
    template <> struct abi<winrt::Windows::Graphics::Display::Core::IHdmiDisplayInformation>
    {
        ...
        {
            virtual std::int32_t __stdcall GetSupportedDisplayModes(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentDisplayMode(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetDefaultDisplayModeAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestSetCurrentDisplayModeAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestSetCurrentDisplayModeWithHdrAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestSetCurrentDisplayModeWithHdrAndMetadataAsync(void*, std::int32_t, struct struct_Windows_Graphics_Display_Core_HdmiDisplayHdr2086Metadata, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_DisplayModesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DisplayModesChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Display::Core::IHdmiDisplayMode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ResolutionWidthInRawPixels(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ResolutionHeightInRawPixels(std::uint32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_BitsPerPixel(std::uint16_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsSdrLuminanceSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSmpte2084Supported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Is2086MetadataSupported(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Display::Core::IHdmiDisplayMode2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsDolbyVisionLowLatencySupported(bool*) noexcept = 0;
        };
    };
    template <typename D>
