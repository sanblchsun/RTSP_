...
{
    enum class VoiceCommandCompletionReason : std::int32_t
    {
        Unknown = 0,
    ...
    enum class VoiceCommandContentTileType : std::int32_t
    {
        TitleOnly = 0,
        TitleWithText = 1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommand>
    {
        ...
        {
            virtual std::int32_t __stdcall get_CommandName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Properties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SpeechRecognitionResult(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandConfirmationResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Confirmed(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandContentTile>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_TextLine1(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TextLine1(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_TextLine2(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TextLine2(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_TextLine3(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TextLine3(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Image(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Image(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AppContext(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AppContext(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AppLaunchArgument(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AppLaunchArgument(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ContentTileType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ContentTileType(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandDefinitionManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall InstallCommandDefinitionsFromStorageFileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_InstalledCommandDefinitions(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandResponse>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_RepeatMessage(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RepeatMessage(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AppLaunchArgument(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AppLaunchArgument(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_VoiceCommandContentTiles(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandResponseStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MaxSupportedVoiceCommandContentTiles(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall CreateResponse(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateResponseWithTiles(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateResponseForPrompt(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateResponseForPromptWithTiles(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandServiceConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetVoiceCommandAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestConfirmationAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestDisambiguationAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportProgressAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportSuccessAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportFailureAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestAppLaunchAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Language(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_VoiceCommandCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_VoiceCommandCompleted(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandServiceConnectionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromAppServiceTriggerDetails(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::VoiceCommands::IVoiceCommandUserMessage>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SpokenMessage(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SpokenMessage(void*) noexcept = 0;
        };
    };
    template <typename D>
