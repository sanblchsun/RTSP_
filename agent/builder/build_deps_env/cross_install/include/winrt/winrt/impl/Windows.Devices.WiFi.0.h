...
{
    enum class WiFiAccessStatus : std::int32_t
    {
        Unspecified = 0,
        Allowed = 1,
        DeniedByUser = 2,
    ...
    enum class WiFiConnectionMethod : std::int32_t
    {
        Default = 0,
        WpsPin = 1,
        WpsPushButton = 2,
    };
    enum class WiFiConnectionStatus : std::int32_t
    {
    ...
    enum class WiFiNetworkKind : std::int32_t
    {
        Any = 0,
        Infrastructure = 1,
        Adhoc = 2,
    };
    enum class WiFiPhyKind : std::int32_t
    {
        Unknown = 0,
        Fhss = 1,
        Dsss = 2,
    ...
    enum class WiFiReconnectionKind : std::int32_t
    {
        Automatic = 0,
        Manual = 1,
    };
    enum class WiFiWpsConfigurationStatus : std::int32_t
    {
        UnspecifiedFailure = 0,
        Success = 1,
        Timeout = 2,
    };
    enum class WiFiWpsKind : std::int32_t
    {
        Unknown = 0,
        Pin = 1,
        PushButton = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiAdapter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ScanAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkReport(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_AvailableNetworksChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AvailableNetworksChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall ConnectAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConnectWithPasswordCredentialAsync(void*, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConnectWithPasswordCredentialAndSsidAsync(void*, std::int32_t, void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiAdapter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetWpsConfigurationAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync(void*, std::int32_t, void*, void*, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiAdapterStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindAllAdaptersAsync(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiAvailableNetwork>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Uptime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Ssid(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Bssid(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ChannelCenterFrequencyInKilohertz(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkRssiInDecibelMilliwatts(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_SignalBars(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_NetworkKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhyKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SecuritySettings(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_BeaconInterval(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsWiFiDirect(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiNetworkReport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AvailableNetworks(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiWpsConfigurationResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SupportedWpsKinds(void**) noexcept = 0;
        };
    };
    template <typename D>
