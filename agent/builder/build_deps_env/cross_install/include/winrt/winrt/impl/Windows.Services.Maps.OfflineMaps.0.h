...
{
    enum class OfflineMapPackageQueryStatus : std::int32_t
    {
        Success = 0,
        UnknownError = 1,
    ...
    enum class OfflineMapPackageStartDownloadStatus : std::int32_t
    {
        Success = 0,
        UnknownError = 1,
        InvalidCredentials = 2,
    ...
    enum class OfflineMapPackageStatus : std::int32_t
    {
        NotDownloaded = 0,
        Downloading = 1,
        Downloaded = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Services::Maps::OfflineMaps::IOfflineMapPackage>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_EnclosingRegionName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EstimatedSizeInBytes(std::uint64_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall RequestStartDownloadAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Maps::OfflineMaps::IOfflineMapPackageQueryResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Packages(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Maps::OfflineMaps::IOfflineMapPackageStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindPackagesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindPackagesInBoundingBoxAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindPackagesInGeocircleAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
