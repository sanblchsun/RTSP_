...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Threading::IThreadPoolStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall RunAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RunWithPriorityAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RunWithPriorityAndOptionsAsync(void*, std::int32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::Threading::IThreadPoolTimerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreatePeriodicTimer(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateTimer(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreatePeriodicTimerWithCompletion(void*, std::int64_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateTimerWithCompletion(void*, std::int64_t, void*, void**) noexcept = 0;
        };
    };
