...
{
    enum class DeviceAccountAuthenticationType : std::int32_t
    {
        Basic = 0,
        OAuth = 1,
        SingleSignOn = 2,
    };
    enum class DeviceAccountIconId : std::int32_t
    {
        Exchange = 0,
        Msa = 1,
        Outlook = 2,
    ...
    enum class DeviceAccountMailAgeFilter : std::int32_t
    {
        All = 0,
        Last1Day = 1,
        Last3Days = 2,
    ...
    enum class DeviceAccountServerType : std::int32_t
    {
        Exchange = 0,
        Pop = 1,
        Imap = 2,
    };
    enum class DeviceAccountSyncScheduleKind : std::int32_t
    {
        Manual = 0,
        Every15Minutes = 1,
        Every30Minutes = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::IDeviceAccountConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_AccountName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceAccountTypeId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DeviceAccountTypeId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServerType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ServerType(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_EmailAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_EmailAddress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Domain(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Domain(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_EmailSyncEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_EmailSyncEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ContactsSyncEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ContactsSyncEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CalendarSyncEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CalendarSyncEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IncomingServerAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IncomingServerAddress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IncomingServerPort(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncomingServerPort(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IncomingServerRequiresSsl(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncomingServerRequiresSsl(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IncomingServerUsername(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IncomingServerUsername(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingServerAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingServerAddress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingServerPort(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingServerPort(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingServerRequiresSsl(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingServerRequiresSsl(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingServerUsername(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingServerUsername(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::IDeviceAccountConfiguration2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IncomingServerCredential(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IncomingServerCredential(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingServerCredential(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingServerCredential(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_OAuthRefreshToken(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OAuthRefreshToken(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsExternallyManaged(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsExternallyManaged(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AccountIconId(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AccountIconId(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsSsoAuthenticationSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SsoAccountId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SsoAccountId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AlwaysDownloadFullMessage(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AlwaysDownloadFullMessage(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_DoesPolicyAllowMailSync(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_SyncScheduleKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SyncScheduleKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_MailAgeFilter(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MailAgeFilter(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IsClientAuthenticationCertificateRequired(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsClientAuthenticationCertificateRequired(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AutoSelectAuthenticationCertificate(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AutoSelectAuthenticationCertificate(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AuthenticationCertificateId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AuthenticationCertificateId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CardDavSyncScheduleKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CardDavSyncScheduleKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CalDavSyncScheduleKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CalDavSyncScheduleKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CardDavServerUrl(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CardDavServerUrl(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CardDavRequiresSsl(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CardDavRequiresSsl(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CalDavServerUrl(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CalDavServerUrl(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CalDavRequiresSsl(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CalDavRequiresSsl(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_WasModifiedByUser(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_WasModifiedByUser(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_WasIncomingServerCertificateHashConfirmed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_WasIncomingServerCertificateHashConfirmed(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IncomingServerCertificateHash(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IncomingServerCertificateHash(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOutgoingServerAuthenticationRequired(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsOutgoingServerAuthenticationRequired(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOutgoingServerAuthenticationEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsOutgoingServerAuthenticationEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_WasOutgoingServerCertificateHashConfirmed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_WasOutgoingServerCertificateHashConfirmed(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_OutgoingServerCertificateHash(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OutgoingServerCertificateHash(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSyncScheduleManagedBySystem(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSyncScheduleManagedBySystem(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::IUserDataAccountSystemAccessManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddAndShowDeviceAccountsAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::IUserDataAccountSystemAccessManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SuppressLocalAccountWithAccountAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDeviceAccountAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteDeviceAccountAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceAccountConfigurationAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_ApplicationModel_UserDataAccounts_SystemAccess_IDeviceAccountConfiguration
    {
        ...
        auto IncomingServerPort(std::int32_t value) const;
        ...
        auto OutgoingServerPort(std::int32_t value) const;
