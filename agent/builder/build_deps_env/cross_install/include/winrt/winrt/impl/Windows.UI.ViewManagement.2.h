...
WINRT_EXPORT namespace winrt::Windows::UI::ViewManagement
{
    ...
    struct ApplicationViewSwitcher
    {
        ...
        static auto TryShowAsStandaloneAsync(std::int32_t viewId);
        static auto TryShowAsStandaloneAsync(std::int32_t viewId, winrt::Windows::UI::ViewManagement::ViewSizePreference const& sizePreference);
        static auto TryShowAsStandaloneAsync(std::int32_t viewId, winrt::Windows::UI::ViewManagement::ViewSizePreference const& sizePreference, std::int32_t anchorViewId, winrt::Windows::UI::ViewManagement::ViewSizePreference const& anchorSizePreference);
        static auto SwitchAsync(std::int32_t viewId);
        static auto SwitchAsync(std::int32_t toViewId, std::int32_t fromViewId);
        static auto SwitchAsync(std::int32_t toViewId, std::int32_t fromViewId, winrt::Windows::UI::ViewManagement::ApplicationViewSwitchingOptions const& options);
        static auto PrepareForCustomAnimatedSwitchAsync(std::int32_t toViewId, std::int32_t fromViewId, winrt::Windows::UI::ViewManagement::ApplicationViewSwitchingOptions const& options);
        static auto DisableSystemViewActivationPolicy();
        static auto TryShowAsViewModeAsync(std::int32_t viewId, winrt::Windows::UI::ViewManagement::ApplicationViewMode const& viewMode);
        static auto TryShowAsViewModeAsync(std::int32_t viewId, winrt::Windows::UI::ViewManagement::ApplicationViewMode const& viewMode, winrt::Windows::UI::ViewManagement::ViewModePreferences const& viewModePreferences);
    };
    ...
    struct ProjectionManager
    {
        ...
        static auto StartProjectingAsync(std::int32_t projectionViewId, std::int32_t anchorViewId);
        static auto SwapDisplaysForViewsAsync(std::int32_t projectionViewId, std::int32_t anchorViewId);
        static auto StopProjectingAsync(std::int32_t projectionViewId, std::int32_t anchorViewId);
        ...
        static auto StartProjectingAsync(std::int32_t projectionViewId, std::int32_t anchorViewId, winrt::Windows::Devices::Enumeration::DeviceInformation const& displayDeviceInfo);
        static auto RequestStartProjectingAsync(std::int32_t projectionViewId, std::int32_t anchorViewId, winrt::Windows::Foundation::Rect const& selection);
        static auto RequestStartProjectingAsync(std::int32_t projectionViewId, std::int32_t anchorViewId, winrt::Windows::Foundation::Rect const& selection, winrt::Windows::UI::Popups::Placement const& prefferedPlacement);
