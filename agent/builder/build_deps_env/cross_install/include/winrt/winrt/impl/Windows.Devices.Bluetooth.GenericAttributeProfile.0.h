...
{
    enum class BluetoothCacheMode : std::int32_t;
...
{
    enum class GattCharacteristicProperties : std::uint32_t
    {
        None = 0,
        Broadcast = 0x1,
        Read = 0x2,
    ...
    enum class GattClientCharacteristicConfigurationDescriptorValue : std::int32_t
    {
        None = 0,
        Notify = 1,
        Indicate = 2,
    };
    enum class GattCommunicationStatus : std::int32_t
    {
        Success = 0,
        Unreachable = 1,
        ProtocolError = 2,
    ...
    enum class GattOpenStatus : std::int32_t
    {
        Unspecified = 0,
        Success = 1,
        AlreadyOpened = 2,
    ...
    enum class GattProtectionLevel : std::int32_t
    {
        Plain = 0,
    ...
    enum class GattRequestState : std::int32_t
    {
        Pending = 0,
        Completed = 1,
        Canceled = 2,
    };
    enum class GattServiceProviderAdvertisementStatus : std::int32_t
    {
        Created = 0,
        Stopped = 1,
        Started = 2,
    ...
    enum class GattSessionStatus : std::int32_t
    {
        Closed = 0,
        Active = 1,
    };
    enum class GattSharingMode : std::int32_t
    {
        Unspecified = 0,
        Exclusive = 1,
        SharedReadOnly = 2,
    ...
    enum class GattWriteOption : std::int32_t
    {
        WriteWithResponse = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristic>
    {
        ...
        {
            virtual std::int32_t __stdcall GetDescriptors(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacteristicProperties(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProtectionLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ProtectionLevel(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_UserDescription(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Uuid(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_AttributeHandle(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PresentationFormats(void**) noexcept = 0;
            virtual std::int32_t __stdcall ReadValueAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ReadValueWithCacheModeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall WriteValueAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall WriteValueWithOptionAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ReadClientCharacteristicConfigurationDescriptorAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall WriteClientCharacteristicConfigurationDescriptorAsync(std::int32_t, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristic2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetAllDescriptors(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristic3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDescriptorsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDescriptorsWithCacheModeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDescriptorsForUuidAsync(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDescriptorsForUuidWithCacheModeAsync(winrt::guid, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall WriteValueWithResultAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall WriteValueWithResultAndOptionAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall WriteClientCharacteristicConfigurationDescriptorWithResultAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristicStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ConvertShortIdToUuid(std::uint16_t, winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristicUuidsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BatteryLevel(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BloodPressureFeature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BloodPressureMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BodySensorLocation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CscFeature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CscMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GlucoseFeature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GlucoseMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GlucoseMeasurementContext(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HeartRateControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HeartRateMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_IntermediateCuffPressure(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_IntermediateTemperature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_MeasurementInterval(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_RecordAccessControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_RscFeature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_RscMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SCControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SensorLocation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TemperatureMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TemperatureType(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristicUuidsStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AlertCategoryId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_AlertCategoryIdBitMask(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_AlertLevel(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_AlertNotificationControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_AlertStatus(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GapAppearance(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BootKeyboardInputReport(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BootKeyboardOutputReport(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BootMouseInputReport(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentTime(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CyclingPowerControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CyclingPowerFeature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CyclingPowerMeasurement(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CyclingPowerVector(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_DateTime(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_DayDateTime(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_DayOfWeek(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GapDeviceName(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_DstOffset(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExactTime256(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_FirmwareRevisionString(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HardwareRevisionString(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HidControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HidInformation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_Ieee1107320601RegulatoryCertificationDataList(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_LnControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_LnFeature(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalTimeInformation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_LocationAndSpeed(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ManufacturerNameString(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ModelNumberString(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_Navigation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_NewAlert(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GapPeripheralPreferredConnectionParameters(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GapPeripheralPrivacyFlag(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_PnpId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_PositionQuality(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProtocolMode(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GapReconnectionAddress(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReferenceTimeInformation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_Report(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReportMap(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_RingerControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_RingerSetting(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ScanIntervalWindow(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ScanRefresh(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SerialNumberString(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GattServiceChanged(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SoftwareRevisionString(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedNewAlertCategory(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportUnreadAlertCategory(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_SystemId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeAccuracy(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeSource(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeUpdateControlPoint(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeUpdateState(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeWithDst(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeZone(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TxPowerLevel(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_UnreadAlertStatus(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattCharacteristicsResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ProtocolError(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Characteristics(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattClientNotificationResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SubscribedClient(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProtocolError(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattClientNotificationResult2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BytesSent(std::uint16_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDescriptorUuidsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CharacteristicAggregateFormat(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacteristicExtendedProperties(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacteristicPresentationFormat(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacteristicUserDescription(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ClientCharacteristicConfiguration(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServerCharacteristicConfiguration(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDescriptorsResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProtocolError(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Descriptors(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDeviceService>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetCharacteristics(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIncludedServices(winrt::guid, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDeviceService2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Device(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ParentServices(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAllCharacteristics(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAllIncludedServices(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDeviceService3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DeviceAccessInformation(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Session(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SharingMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RequestAccessAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall OpenAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCharacteristicsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCharacteristicsWithCacheModeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCharacteristicsForUuidAsync(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCharacteristicsForUuidWithCacheModeAsync(winrt::guid, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIncludedServicesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIncludedServicesWithCacheModeAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIncludedServicesForUuidAsync(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIncludedServicesForUuidWithCacheModeAsync(winrt::guid, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDeviceServiceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetDeviceSelectorFromUuid(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorFromShortId(std::uint16_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ConvertShortIdToUuid(std::uint16_t, winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDeviceServiceStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromIdWithSharingModeAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceId(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceIdWithCacheMode(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceIdAndUuid(void*, winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceSelectorForBluetoothDeviceIdAndUuidWithCacheMode(void*, winrt::guid, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattDeviceServicesResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProtocolError(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Services(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalCharacteristic>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Uuid(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_StaticValue(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacteristicProperties(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReadProtectionLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_WriteProtectionLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall CreateDescriptorAsync(winrt::guid, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Descriptors(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UserDescription(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PresentationFormats(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SubscribedClients(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_SubscribedClientsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SubscribedClientsChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ReadRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ReadRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_WriteRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_WriteRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall NotifyValueAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall NotifyValueForSubscribedClientAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalCharacteristicParameters>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_StaticValue(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_StaticValue(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CharacteristicProperties(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacteristicProperties(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReadProtectionLevel(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ReadProtectionLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_WriteProtectionLevel(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_WriteProtectionLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UserDescription(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_UserDescription(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PresentationFormats(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalCharacteristicResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Characteristic(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Error(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalDescriptorResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Descriptor(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Error(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalService>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Uuid(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall CreateCharacteristicAsync(winrt::guid, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Characteristics(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattPresentationFormat>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_FormatType(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Exponent(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Unit(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Namespace(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Description(std::uint16_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattPresentationFormatStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BluetoothSigAssignedNumbers(std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattPresentationFormatStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromParts(std::uint8_t, std::int32_t, std::uint16_t, std::uint8_t, std::uint16_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattPresentationFormatTypesStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Boolean(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Bit2(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Nibble(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt8(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt12(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt16(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt24(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt32(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt48(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt64(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UInt128(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt8(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt12(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt16(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt24(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt32(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt48(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt64(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SInt128(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Float32(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Float64(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SFloat(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Float(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DUInt16(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Utf8(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Utf16(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Struct(std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattProtocolErrorStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InvalidHandle(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReadNotPermitted(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_WriteNotPermitted(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InvalidPdu(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InsufficientAuthentication(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RequestNotSupported(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InvalidOffset(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InsufficientAuthorization(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PrepareQueueFull(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AttributeNotFound(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AttributeNotLong(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InsufficientEncryptionKeySize(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InvalidAttributeValueLength(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UnlikelyError(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InsufficientEncryption(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UnsupportedGroupType(std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InsufficientResources(std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattReadClientCharacteristicConfigurationDescriptorResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ClientCharacteristicConfigurationDescriptor(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattReadRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Offset(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Length(std::uint32_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall RespondWithValue(void*) noexcept = 0;
            virtual std::int32_t __stdcall RespondWithProtocolError(std::uint8_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattReadRequestedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetRequestAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattReliableWriteTransaction>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall WriteValue(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall CommitAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattReliableWriteTransaction2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CommitWithResultAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Service(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AdvertisementStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_AdvertisementStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_AdvertisementStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall StartAdvertising() noexcept = 0;
            virtual std::int32_t __stdcall StartAdvertisingWithParameters(void*) noexcept = 0;
            virtual std::int32_t __stdcall StopAdvertising() noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProviderAdvertisingParameters>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_IsConnectable(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsConnectable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsDiscoverable(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDiscoverable(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProviderAdvertisingParameters2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_ServiceData(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceData(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProviderResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Error(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceProvider(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProviderStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateAsync(winrt::guid, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceUuidsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Battery(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_BloodPressure(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CyclingSpeedAndCadence(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GenericAccess(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_GenericAttribute(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_Glucose(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HealthThermometer(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HeartRate(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_RunningSpeedAndCadence(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceUuidsStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AlertNotification(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentTime(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_CyclingPower(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceInformation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_HumanInterfaceDevice(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ImmediateAlert(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_LinkLoss(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_LocationAndNavigation(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_NextDstChange(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhoneAlertStatus(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReferenceTimeUpdate(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_ScanParameters(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_TxPower(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattSession>
    {
        ...
        {
            virtual std::int32_t __stdcall get_DeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanMaintainConnection(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaintainConnection(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MaintainConnection(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxPduSize(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SessionStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_MaxPduSizeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MaxPduSizeChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SessionStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionStatusChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattSessionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromDeviceIdAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattSubscribedClient>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Session(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxNotificationSize(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_MaxNotificationSizeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MaxNotificationSizeChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattValueChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CharacteristicValue(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattWriteRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Value(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Offset(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Option(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_State(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_StateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_StateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall Respond() noexcept = 0;
            virtual std::int32_t __stdcall RespondWithProtocolError(std::uint8_t) noexcept = 0;
        };
    };
    ...
    {
        auto ConvertShortIdToUuid(std::uint16_t shortId) const;
    };
    ...
    struct consume_Windows_Devices_Bluetooth_GenericAttributeProfile_IGattDeviceServiceStatics
    {
        ...
        auto GetDeviceSelectorFromShortId(std::uint16_t serviceShortId) const;
        auto ConvertShortIdToUuid(std::uint16_t shortId) const;
    };
    ...
    {
        auto FromParts(std::uint8_t formatType, std::int32_t exponent, std::uint16_t unit, std::uint8_t namespaceId, std::uint16_t description) const;
    };
    ...
    struct consume_Windows_Devices_Bluetooth_GenericAttributeProfile_IGattReadRequest
    {
        ...
        auto RespondWithProtocolError(std::uint8_t protocolError) const;
    };
