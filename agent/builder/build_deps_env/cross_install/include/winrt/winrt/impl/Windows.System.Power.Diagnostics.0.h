...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Power::Diagnostics::IBackgroundEnergyDiagnosticsStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_DeviceSpecificConversionFactor(double*) noexcept = 0;
            virtual std::int32_t __stdcall ComputeTotalEnergyUsage(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall ResetTotalEnergyUsage() noexcept = 0;
        };
    };
