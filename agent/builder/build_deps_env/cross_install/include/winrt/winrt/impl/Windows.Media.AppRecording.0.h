...
{
    enum class AppRecordingSaveScreenshotOption : std::int32_t
    {
        None = 0,
        HdrContentVisible = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::AppRecording::IAppRecordingManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall StartRecordingToFileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RecordTimeSpanToFileAsync(std::int64_t, std::int64_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedScreenshotMediaEncodingSubtypes(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveScreenshotToFilesAsync(void*, void*, std::int32_t, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::AppRecording::IAppRecordingResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsFileTruncated(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::AppRecording::IAppRecordingSaveScreenshotResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Succeeded(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall get_SavedScreenshotInfos(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::AppRecording::IAppRecordingSavedScreenshotInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MediaEncodingSubtype(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::AppRecording::IAppRecordingStatus>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanRecord(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanRecordTimeSpan(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HistoricalBufferDuration(std::int64_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::AppRecording::IAppRecordingStatusDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsAnyAppBroadcasting(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsCaptureResourceUnavailable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsGameStreamInProgress(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsTimeSpanRecordingDisabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsGpuConstrained(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsAppInactive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsBlockedForApp(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDisabledByUser(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDisabledBySystem(bool*) noexcept = 0;
        };
    };
    template <typename D>
