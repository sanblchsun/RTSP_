...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::SocialInfo::Provider::ISocialDashboardItemUpdater>
    {
        ...
        {
            virtual std::int32_t __stdcall get_OwnerRemoteId(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::SocialInfo::Provider::ISocialInfoProviderManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateSocialFeedUpdaterAsync(std::int32_t, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDashboardItemUpdaterAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateBadgeCountValue(void*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReportNewContentAvailable(void*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ProvisionAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall DeprovisionAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_ApplicationModel_SocialInfo_Provider_ISocialInfoProviderManagerStatics
    {
        ...
        auto UpdateBadgeCountValue(param::hstring const& itemRemoteId, std::int32_t newCount) const;
