...
{
    enum class IsolatedWindowsEnvironmentActivator : std::int32_t
    {
        System = 0,
        User = 1,
    };
    enum class IsolatedWindowsEnvironmentAllowedClipboardFormats : std::uint32_t
    {
        None = 0,
        Text = 0x1,
        Image = 0x2,
    };
    enum class IsolatedWindowsEnvironmentAvailablePrinters : std::uint32_t
    {
        None = 0,
        Local = 0x1,
        Network = 0x2,
    ...
    enum class IsolatedWindowsEnvironmentClipboardCopyPasteDirections : std::uint32_t
    {
        None = 0,
        HostToIsolatedWindowsEnvironment = 0x1,
        IsolatedWindowsEnvironmentToHost = 0x2,
    };
    enum class IsolatedWindowsEnvironmentCreateStatus : std::int32_t
    {
        Success = 0,
        FailureByPolicy = 1,
        UnknownFailure = 2,
    };
    enum class IsolatedWindowsEnvironmentHostError : std::int32_t
    {
    ...
    enum class IsolatedWindowsEnvironmentLaunchFileStatus : std::int32_t
    {
        Success = 0,
        UnknownFailure = 1,
    ...
    enum class IsolatedWindowsEnvironmentOwnerRegistrationStatus : std::int32_t
    {
        Success = 0,
        InvalidArgument = 1,
        AccessDenied = 2,
    ...
    enum class IsolatedWindowsEnvironmentProcessState : std::int32_t
    {
        Running = 1,
        Aborted = 2,
        Completed = 3,
    };
    enum class IsolatedWindowsEnvironmentProgressState : std::int32_t
    {
        Queued = 0,
        Processing = 1,
        Completed = 2,
    };
    enum class IsolatedWindowsEnvironmentShareFolderStatus : std::int32_t
    {
        Success = 0,
        UnknownFailure = 1,
        EnvironmentUnavailable = 2,
    ...
    enum class IsolatedWindowsEnvironmentStartProcessStatus : std::int32_t
    {
        Success = 0,
        UnknownFailure = 1,
        EnvironmentUnavailable = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Security::Isolation::IsolatedWindowsEnvironmentCreateProgress>{ using type = struct_category<winrt::Windows::Security::Isolation::IsolatedWindowsEnvironmentProgressState, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironment>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall StartProcessSilentlyAsync(void*, void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall StartProcessSilentlyWithTelemetryAsync(void*, void*, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShareFolderAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShareFolderWithTelemetryAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall LaunchFileWithUIAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall LaunchFileWithUIAndTelemetryAsync(void*, void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TerminateAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TerminateWithTelemetryAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterMessageReceiver(winrt::guid, void*) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterMessageReceiver(winrt::guid) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithTelemetryAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetById(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindByOwnerId(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentFile>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HostPath(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentHostStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsReady(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HostErrors(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EnvironmentOwnerId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_EnvironmentOwnerId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowedClipboardFormats(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowedClipboardFormats(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ClipboardCopyPasteDirections(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ClipboardCopyPasteDirections(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AvailablePrinters(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AvailablePrinters(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SharedHostFolderPath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SharedFolderNameInEnvironment(void**) noexcept = 0;
            virtual std::int32_t __stdcall ShareHostFolderForUntrustedItems(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PersistUserProfile(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_PersistUserProfile(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowGraphicsHardwareAcceleration(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowGraphicsHardwareAcceleration(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowCameraAndMicrophoneAccess(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowCameraAndMicrophoneAccess(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentOwnerRegistrationData>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ShareableFolders(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ProcessesRunnableAsSystem(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ProcessesRunnableAsUser(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ActivationFileExtensions(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentOwnerRegistrationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall Unregister(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentProcess>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall WaitForExit() noexcept = 0;
            virtual std::int32_t __stdcall WaitForExitWithTimeout(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall WaitForExitAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentShareFolderRequestOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AllowWrite(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowWrite(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentStartProcessResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual std::int32_t __stdcall get_Process(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsEnvironmentTelemetryParameters>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_CorrelationId(winrt::guid) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::IIsolatedWindowsHostMessengerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall PostMessageToReceiver(winrt::guid, void*) noexcept = 0;
            virtual std::int32_t __stdcall GetFileId(void*, winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Isolation::MessageReceivedCallback>
    {
        ...
        {
            virtual std::int32_t __stdcall Invoke(winrt::guid, void*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Security_Isolation_IIsolatedWindowsEnvironmentProcess
    {
        ...
        auto WaitForExitWithTimeout(std::uint32_t timeoutMilliseconds) const;
