...
{
    enum class MediaTrimmingPreference : std::int32_t
    {
        Fast = 0,
        Precise = 1,
    };
    enum class VideoFramePrecision : std::int32_t
    {
        NearestFrame = 0,
        NearestKeyFrame = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Editing::IBackgroundAudioTrack>
    {
        ...
        {
            virtual std::int32_t __stdcall get_TrimTimeFromStart(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TrimTimeFromStart(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TrimTimeFromEnd(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TrimTimeFromEnd(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_OriginalDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrimmedDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UserData(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Delay(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Delay(std::int64_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall GetAudioEncodingProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioEffectDefinitions(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IBackgroundAudioTrackStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromEmbeddedAudioTrack(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Editing::IMediaClip>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UserData(void**) noexcept = 0;
            virtual std::int32_t __stdcall Clone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_StartTimeInComposition(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EndTimeInComposition(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EmbeddedAudioTracks(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SelectedEmbeddedAudioTrackIndex(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SelectedEmbeddedAudioTrackIndex(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall put_Volume(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Volume(double*) noexcept = 0;
            virtual std::int32_t __stdcall GetVideoEncodingProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioEffectDefinitions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_VideoEffectDefinitions(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaClipStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromColor(struct struct_Windows_UI_Color, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromFileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromImageFileAsync(void*, std::int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaClipStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromSurface(void*, std::int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaComposition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Clips(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_BackgroundAudioTracks(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UserData(void**) noexcept = 0;
            virtual std::int32_t __stdcall Clone(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetThumbnailAsync(std::int64_t, std::int32_t, std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetThumbnailsAsync(void*, std::int32_t, std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RenderToFileAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RenderToFileWithTrimmingPreferenceAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RenderToFileWithProfileAsync(void*, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateDefaultEncodingProfile(void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateMediaStreamSource(void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateMediaStreamSourceWithProfile(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GeneratePreviewMediaStreamSource(std::int32_t, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaComposition2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_OverlayLayers(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Editing::IMediaOverlay>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Position(winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall put_Position(winrt::Windows::Foundation::Rect) noexcept = 0;
            virtual std::int32_t __stdcall put_Delay(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Delay(std::int64_t*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_AudioEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioEnabled(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaOverlayFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithPositionAndOpacity(void*, winrt::Windows::Foundation::Rect, double, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaOverlayLayer>
    {
        ...
        {
            virtual std::int32_t __stdcall Clone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Overlays(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomCompositorDefinition(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Editing::IMediaOverlayLayerFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithCompositorDefinition(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Media_Editing_IMediaClip
    {
        ...
        auto SelectedEmbeddedAudioTrackIndex(std::uint32_t value) const;
        auto Volume(double value) const;
        [[nodiscard]] auto Volume() const;
    ...
    struct consume_Windows_Media_Editing_IMediaComposition
    {
        ...
        auto GetThumbnailAsync(winrt::Windows::Foundation::TimeSpan const& timeFromStart, std::int32_t scaledWidth, std::int32_t scaledHeight, winrt::Windows::Media::Editing::VideoFramePrecision const& framePrecision) const;
        auto GetThumbnailsAsync(param::async_iterable<winrt::Windows::Foundation::TimeSpan> const& timesFromStart, std::int32_t scaledWidth, std::int32_t scaledHeight, winrt::Windows::Media::Editing::VideoFramePrecision const& framePrecision) const;
        ...
        auto GeneratePreviewMediaStreamSource(std::int32_t scaledWidth, std::int32_t scaledHeight) const;
    };
