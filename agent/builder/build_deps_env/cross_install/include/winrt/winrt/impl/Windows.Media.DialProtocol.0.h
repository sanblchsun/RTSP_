...
{
    enum class DialAppLaunchResult : std::int32_t
    {
        Launched = 0,
        FailedToLaunch = 1,
        NotFound = 2,
    ...
    enum class DialAppState : std::int32_t
    {
        Unknown = 0,
        Stopped = 1,
        Running = 2,
    ...
    enum class DialAppStopResult : std::int32_t
    {
        Stopped = 0,
        StopFailed = 1,
    ...
    enum class DialDeviceDisplayStatus : std::int32_t
    {
        None = 0,
        Connecting = 1,
        Connected = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialApp>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall RequestLaunchAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall StopAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppStateAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialAppStateDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_FullXml(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialDevice>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetDialApp(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialDevicePicker>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall add_DialDeviceSelected(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DialDeviceSelected(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_DialDevicePickerDismissed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DialDevicePickerDismissed(winrt::event_token) noexcept = 0;
            ...
            virtual std::int32_t __stdcall PickSingleDialDeviceAsync(winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall PickSingleDialDeviceAsyncWithPlacement(winrt::Windows::Foundation::Rect, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall Hide() noexcept = 0;
            virtual std::int32_t __stdcall SetDisplayStatus(void*, std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialDevicePickerFilter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SupportedAppNames(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialDeviceSelectedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SelectedDialDevice(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialDeviceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall DeviceInfoSupportsDialAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialReceiverApp>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAdditionalDataAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetAdditionalDataAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::DialProtocol::IDialReceiverApp2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetUniqueDeviceNameAsync(void**) noexcept = 0;
        };
    };
