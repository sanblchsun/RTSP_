...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Composition::Core::ICompositorController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall Commit() noexcept = 0;
            virtual std::int32_t __stdcall EnsurePreviousCommitCompletedAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_CommitNeeded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CommitNeeded(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
