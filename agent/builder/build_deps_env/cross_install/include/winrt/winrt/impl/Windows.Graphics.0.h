...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Graphics::DisplayAdapterId>{ using type = struct_category<std::uint32_t, std::int32_t>; };
    template <> struct category<winrt::Windows::Graphics::PointInt32>{ using type = struct_category<std::int32_t, std::int32_t>; };
    template <> struct category<winrt::Windows::Graphics::RectInt32>{ using type = struct_category<std::int32_t, std::int32_t, std::int32_t, std::int32_t>; };
    template <> struct category<winrt::Windows::Graphics::SizeInt32>{ using type = struct_category<std::int32_t, std::int32_t>; };
