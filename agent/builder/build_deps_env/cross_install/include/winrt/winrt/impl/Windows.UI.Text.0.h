...
{
    enum class CaretType : std::int32_t
    {
        Normal = 0,
        Null = 1,
    };
    enum class FindOptions : std::uint32_t
    {
        None = 0,
        Word = 0x2,
        Case = 0x4,
    };
    enum class FontStretch : std::int32_t
    {
        Undefined = 0,
        UltraCondensed = 1,
        ExtraCondensed = 2,
    ...
    enum class FontStyle : std::int32_t
    {
        Normal = 0,
        Oblique = 1,
        Italic = 2,
    };
    enum class FormatEffect : std::int32_t
    {
        Off = 0,
        On = 1,
        Toggle = 2,
    ...
    enum class HorizontalCharacterAlignment : std::int32_t
    {
        Left = 0,
        Right = 1,
        Center = 2,
    };
    enum class LetterCase : std::int32_t
    {
        Lower = 0,
        Upper = 1,
    };
    enum class LineSpacingRule : std::int32_t
    {
        Undefined = 0,
        Single = 1,
        OneAndHalf = 2,
    ...
    enum class MarkerAlignment : std::int32_t
    {
        Undefined = 0,
        Left = 1,
        Center = 2,
    ...
    enum class MarkerType : std::int32_t
    {
        Undefined = 0,
        None = 1,
        Bullet = 2,
    ...
    enum class ParagraphAlignment : std::int32_t
    {
        Undefined = 0,
        Left = 1,
        Center = 2,
    ...
    enum class ParagraphStyle : std::int32_t
    {
        Undefined = 0,
        None = 1,
        Normal = 2,
    ...
    enum class PointOptions : std::uint32_t
    {
        None = 0,
        IncludeInset = 0x1,
        Start = 0x20,
    ...
    enum class RangeGravity : std::int32_t
    {
        UIBehavior = 0,
        Backward = 1,
        Forward = 2,
    ...
    enum class RichEditMathMode : std::int32_t
    {
        NoMath = 0,
        MathOnly = 1,
    };
    enum class SelectionOptions : std::uint32_t
    {
        StartActive = 0x1,
        AtEndOfLine = 0x2,
        Overtype = 0x4,
    ...
    enum class TabAlignment : std::int32_t
    {
        Left = 0,
        Center = 1,
        Right = 2,
    ...
    enum class TabLeader : std::int32_t
    {
        Spaces = 0,
        Dots = 1,
        Dashes = 2,
    ...
    enum class TextDecorations : std::uint32_t
    {
        None = 0,
        Underline = 0x1,
        Strikethrough = 0x2,
    };
    enum class TextGetOptions : std::uint32_t
    {
        None = 0,
        AdjustCrlf = 0x1,
        UseCrlf = 0x2,
    ...
    enum class TextRangeUnit : std::int32_t
    {
        Character = 0,
        Word = 1,
        Sentence = 2,
    ...
    enum class TextScript : std::int32_t
    {
        Undefined = 0,
        Ansi = 1,
        EastEurope = 2,
    ...
    enum class TextSetOptions : std::uint32_t
    {
        None = 0,
        UnicodeBidi = 0x1,
        Unlink = 0x8,
    ...
    enum class UnderlineType : std::int32_t
    {
        Undefined = 0,
        None = 1,
        Single = 2,
    ...
    enum class VerticalCharacterAlignment : std::int32_t
    {
        Top = 0,
        Baseline = 1,
        Bottom = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::UI::Text::FontWeight>{ using type = struct_category<std::uint16_t>; };
    ...
    template <> struct abi<winrt::Windows::UI::Text::IContentLinkInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Id(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Id(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DisplayText(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SecondaryText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SecondaryText(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Uri(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Uri(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_LinkContentKind(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LinkContentKind(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Text::IFontWeightsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Black(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_Bold(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtraBlack(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtraBold(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtraLight(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_Light(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_Medium(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_Normal(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_SemiBold(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_SemiLight(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
            virtual std::int32_t __stdcall get_Thin(struct struct_Windows_UI_Text_FontWeight*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::IRichEditTextRange>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ContentLinkInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ContentLinkInfo(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextCharacterFormat>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AllCaps(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllCaps(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_BackgroundColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall put_BackgroundColor(struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall get_Bold(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Bold(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_FontStretch(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_FontStretch(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_ForegroundColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall put_ForegroundColor(struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall get_Hidden(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Hidden(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Italic(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Italic(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Kerning(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_Kerning(float) noexcept = 0;
            virtual std::int32_t __stdcall get_LanguageTag(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LanguageTag(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_LinkType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Name(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Name(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Outline(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Outline(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Position(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_Position(float) noexcept = 0;
            virtual std::int32_t __stdcall get_ProtectedText(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ProtectedText(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Size(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_Size(float) noexcept = 0;
            virtual std::int32_t __stdcall get_SmallCaps(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SmallCaps(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Spacing(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_Spacing(float) noexcept = 0;
            virtual std::int32_t __stdcall get_Strikethrough(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Strikethrough(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Subscript(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Subscript(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Superscript(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Superscript(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TextScript(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_TextScript(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Underline(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Underline(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Weight(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Weight(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetClone(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetClone(void**) noexcept = 0;
            virtual std::int32_t __stdcall IsEqual(void*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextConstantsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AutoColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinUnitCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxUnitCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UndefinedColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall get_UndefinedFloatValue(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_UndefinedInt32Value(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UndefinedFontStretch(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UndefinedFontStyle(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextDocument>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CaretType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CaretType(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultTabStop(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_DefaultTabStop(float) noexcept = 0;
            virtual std::int32_t __stdcall get_Selection(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UndoLimit(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UndoLimit(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall CanCopy(bool*) noexcept = 0;
            virtual std::int32_t __stdcall CanPaste(bool*) noexcept = 0;
            virtual std::int32_t __stdcall CanRedo(bool*) noexcept = 0;
            virtual std::int32_t __stdcall CanUndo(bool*) noexcept = 0;
            virtual std::int32_t __stdcall ApplyDisplayUpdates(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall BatchDisplayUpdates(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall BeginUndoGroup() noexcept = 0;
            virtual std::int32_t __stdcall EndUndoGroup() noexcept = 0;
            virtual std::int32_t __stdcall GetDefaultCharacterFormat(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDefaultParagraphFormat(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetRange(std::int32_t, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetRangeFromPoint(winrt::Windows::Foundation::Point, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetText(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall LoadFromStream(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall Redo() noexcept = 0;
            virtual std::int32_t __stdcall SaveToStream(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetDefaultCharacterFormat(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetDefaultParagraphFormat(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetText(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall Undo() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextDocument2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AlignmentIncludesTrailingWhitespace(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AlignmentIncludesTrailingWhitespace(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IgnoreTrailingCharacterSpacing(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IgnoreTrailingCharacterSpacing(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextDocument3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ClearUndoRedoHistory() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextDocument4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetMath(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetMath(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetMathMode(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextParagraphFormat>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_FirstLineIndent(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_KeepTogether(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_KeepTogether(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_KeepWithNext(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_KeepWithNext(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_LeftIndent(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_LineSpacing(float*) noexcept = 0;
            virtual std::int32_t __stdcall get_LineSpacingRule(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ListAlignment(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ListAlignment(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ListLevelIndex(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ListLevelIndex(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ListStart(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ListStart(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ListStyle(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ListStyle(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_ListTab(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_ListTab(float) noexcept = 0;
            virtual std::int32_t __stdcall get_ListType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ListType(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_NoLineNumber(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_NoLineNumber(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PageBreakBefore(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PageBreakBefore(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RightIndent(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_RightIndent(float) noexcept = 0;
            virtual std::int32_t __stdcall get_RightToLeft(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RightToLeft(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_SpaceAfter(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_SpaceAfter(float) noexcept = 0;
            virtual std::int32_t __stdcall get_SpaceBefore(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_SpaceBefore(float) noexcept = 0;
            virtual std::int32_t __stdcall get_WidowControl(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_WidowControl(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TabCount(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall AddTab(float, std::int32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ClearAllTabs() noexcept = 0;
            virtual std::int32_t __stdcall DeleteTab(float) noexcept = 0;
            virtual std::int32_t __stdcall GetClone(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetTab(std::int32_t, float*, std::int32_t*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall IsEqual(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetClone(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetIndents(float, float, float) noexcept = 0;
            virtual std::int32_t __stdcall SetLineSpacing(std::int32_t, float) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextRange>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Character(char16_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Character(char16_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CharacterFormat(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CharacterFormat(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_FormattedText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_FormattedText(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_EndPosition(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EndPosition(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Gravity(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Gravity(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Length(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Link(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Link(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ParagraphFormat(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ParagraphFormat(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_StartPosition(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StartPosition(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_StoryLength(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Text(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Text(void*) noexcept = 0;
            virtual std::int32_t __stdcall CanPaste(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall ChangeCase(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall Collapse(bool) noexcept = 0;
            virtual std::int32_t __stdcall Copy() noexcept = 0;
            virtual std::int32_t __stdcall Cut() noexcept = 0;
            virtual std::int32_t __stdcall Delete(std::int32_t, std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall EndOf(std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Expand(std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall FindText(void*, std::int32_t, std::uint32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetCharacterUtf32(std::uint32_t*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetClone(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetIndex(std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetPoint(std::int32_t, std::int32_t, std::uint32_t, winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall GetRect(std::uint32_t, winrt::Windows::Foundation::Rect*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetText(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetTextViaStream(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall InRange(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall InsertImage(std::int32_t, std::int32_t, std::int32_t, std::int32_t, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall InStory(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsEqual(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall Move(std::int32_t, std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveEnd(std::int32_t, std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveStart(std::int32_t, std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Paste(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ScrollIntoView(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall MatchSelection() noexcept = 0;
            virtual std::int32_t __stdcall SetIndex(std::int32_t, std::int32_t, bool) noexcept = 0;
            virtual std::int32_t __stdcall SetPoint(winrt::Windows::Foundation::Point, std::uint32_t, bool) noexcept = 0;
            virtual std::int32_t __stdcall SetRange(std::int32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetText(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetTextViaStream(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall StartOf(std::int32_t, bool, std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Text::ITextSelection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Options(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Options(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Type(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall EndKey(std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall HomeKey(std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveDown(std::int32_t, std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveLeft(std::int32_t, std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveRight(std::int32_t, std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall MoveUp(std::int32_t, std::int32_t, bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall TypeText(void*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_UI_Text_IContentLinkInfo
    {
        ...
        auto Id(std::uint32_t value) const;
    ...
    struct consume_Windows_UI_Text_ITextCharacterFormat
    {
        ...
        auto Weight(std::int32_t value) const;
    ...
    struct consume_Windows_UI_Text_ITextDocument
    {
        ...
        auto UndoLimit(std::uint32_t value) const;
        auto CanCopy() const;
        auto CanPaste() const;
        auto CanRedo() const;
        auto CanUndo() const;
        ...
        auto GetRange(std::int32_t startPosition, std::int32_t endPosition) const;
    ...
    struct consume_Windows_UI_Text_ITextParagraphFormat
    {
        ...
        auto ListLevelIndex(std::int32_t value) const;
        [[nodiscard]] auto ListStart() const;
        auto ListStart(std::int32_t value) const;
        ...
        auto GetClone() const;
        auto GetTab(std::int32_t index, float& position, winrt::Windows::UI::Text::TabAlignment& align, winrt::Windows::UI::Text::TabLeader& leader) const;
    ...
    struct consume_Windows_UI_Text_ITextRange
    {
        ...
        auto EndPosition(std::int32_t value) const;
        ...
        auto FindText(param::hstring const& value, std::int32_t scanLength, winrt::Windows::UI::Text::FindOptions const& options) const;
        auto GetCharacterUtf32(std::uint32_t& value, std::int32_t offset) const;
        auto GetClone() const;
        ...
        auto GetRect(winrt::Windows::UI::Text::PointOptions const& options, winrt::Windows::Foundation::Rect& rect, std::int32_t& hit) const;
        auto GetText(winrt::Windows::UI::Text::TextGetOptions const& options, hstring& value) const;
        ...
        auto InsertImage(std::int32_t width, std::int32_t height, std::int32_t ascent, winrt::Windows::UI::Text::VerticalCharacterAlignment const& verticalAlign, param::hstring const& alternateText, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        ...
        auto Move(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        auto MoveEnd(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        auto MoveStart(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        auto Paste(std::int32_t format) const;
        auto ScrollIntoView(winrt::Windows::UI::Text::PointOptions const& value) const;
        auto MatchSelection() const;
        auto SetIndex(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t index, bool extend) const;
        ...
        auto SetRange(std::int32_t startPosition, std::int32_t endPosition) const;
        auto SetText(winrt::Windows::UI::Text::TextSetOptions const& options, param::hstring const& value) const;
    ...
    struct consume_Windows_UI_Text_ITextSelection
    {
        ...
        auto MoveDown(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
        auto MoveLeft(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
        auto MoveRight(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
        auto MoveUp(winrt::Windows::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
