...
WINRT_EXPORT namespace winrt::Windows::Devices::Bluetooth
{
    ...
    struct WINRT_IMPL_EMPTY_BASES BluetoothClassOfDevice : winrt::Windows::Devices::Bluetooth::IBluetoothClassOfDevice
    {
        ...
        static auto FromRawValue(std::uint32_t rawValue);
        ...
        impl::require<BluetoothDevice, winrt::Windows::Foundation::IClosable, winrt::Windows::Devices::Bluetooth::IBluetoothDevice2, winrt::Windows::Devices::Bluetooth::IBluetoothDevice3, winrt::Windows::Devices::Bluetooth::IBluetoothDevice4, winrt::Windows::Devices::Bluetooth::IBluetoothDevice5>
    {
        ...
        static auto FromBluetoothAddressAsync(std::uint64_t address);
        static auto GetDeviceSelector();
        ...
        static auto GetDeviceSelectorFromBluetoothAddress(std::uint64_t bluetoothAddress);
    ...
    struct WINRT_IMPL_EMPTY_BASES BluetoothLEAppearance : winrt::Windows::Devices::Bluetooth::IBluetoothLEAppearance
    {
        ...
        static auto FromRawValue(std::uint16_t rawValue);
        static auto FromParts(std::uint16_t appearanceCategory, std::uint16_t appearanceSubCategory);
    };
        ...
        impl::require<BluetoothLEDevice, winrt::Windows::Foundation::IClosable, winrt::Windows::Devices::Bluetooth::IBluetoothLEDevice2, winrt::Windows::Devices::Bluetooth::IBluetoothLEDevice3, winrt::Windows::Devices::Bluetooth::IBluetoothLEDevice4, winrt::Windows::Devices::Bluetooth::IBluetoothLEDevice5>
    {
        ...
        static auto FromIdAsync(param::hstring const& deviceId);
        static auto FromBluetoothAddressAsync(std::uint64_t bluetoothAddress);
        static auto GetDeviceSelector();
        static auto GetDeviceSelectorFromPairingState(bool pairingState);
        static auto GetDeviceSelectorFromConnectionStatus(winrt::Windows::Devices::Bluetooth::BluetoothConnectionStatus const& connectionStatus);
        static auto GetDeviceSelectorFromDeviceName(param::hstring const& deviceName);
        static auto GetDeviceSelectorFromBluetoothAddress(std::uint64_t bluetoothAddress);
        static auto GetDeviceSelectorFromBluetoothAddress(std::uint64_t bluetoothAddress, winrt::Windows::Devices::Bluetooth::BluetoothAddressType const& bluetoothAddressType);
        static auto GetDeviceSelectorFromAppearance(winrt::Windows::Devices::Bluetooth::BluetoothLEAppearance const& appearance);
        static auto FromBluetoothAddressAsync(std::uint64_t bluetoothAddress, winrt::Windows::Devices::Bluetooth::BluetoothAddressType const& bluetoothAddressType);
    };
    ...
    struct BluetoothUuidHelper
    {
        ...
        static auto FromShortId(std::uint32_t shortId);
