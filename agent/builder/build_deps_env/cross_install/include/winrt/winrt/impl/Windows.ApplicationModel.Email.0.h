...
{
    enum class EmailAttachmentDownloadState : std::int32_t
    {
        NotDownloaded = 0,
        Downloading = 1,
        Downloaded = 2,
    ...
    enum class EmailBatchStatus : std::int32_t
    {
        Success = 0,
        ServerSearchSyncManagerError = 1,
        ServerSearchUnknownError = 2,
    };
    enum class EmailCertificateValidationStatus : std::int32_t
    {
        Success = 0,
        NoMatch = 1,
        InvalidUsage = 2,
    ...
    enum class EmailFlagState : std::int32_t
    {
        Unflagged = 0,
        Flagged = 1,
        Completed = 2,
    ...
    enum class EmailImportance : std::int32_t
    {
        Normal = 0,
        High = 1,
        Low = 2,
    };
    enum class EmailMailboxActionKind : std::int32_t
    {
        MarkMessageAsSeen = 0,
        MarkMessageRead = 1,
    ...
    enum class EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation : std::int32_t
    {
        None = 0,
        StrongAlgorithm = 1,
        AnyAlgorithm = 2,
    };
    enum class EmailMailboxAutoReplyMessageResponseKind : std::int32_t
    {
        Html = 0,
        PlainText = 1,
    };
    enum class EmailMailboxChangeType : std::int32_t
    {
        MessageCreated = 0,
        MessageModified = 1,
        MessageDeleted = 2,
    ...
    enum class EmailMailboxCreateFolderStatus : std::int32_t
    {
        Success = 0,
        NetworkError = 1,
        PermissionsError = 2,
    ...
    enum class EmailMailboxDeleteFolderStatus : std::int32_t
    {
        Success = 0,
        NetworkError = 1,
        PermissionsError = 2,
    ...
    enum class EmailMailboxEmptyFolderStatus : std::int32_t
    {
        Success = 0,
        NetworkError = 1,
        PermissionsError = 2,
    ...
    enum class EmailMailboxOtherAppReadAccess : std::int32_t
    {
        SystemOnly = 0,
        Full = 1,
        None = 2,
    };
    enum class EmailMailboxOtherAppWriteAccess : std::int32_t
    {
        None = 0,
        Limited = 1,
    };
    enum class EmailMailboxSmimeEncryptionAlgorithm : std::int32_t
    {
        Any = 0,
        TripleDes = 1,
        Des = 2,
    ...
    enum class EmailMailboxSmimeSigningAlgorithm : std::int32_t
    {
        Any = 0,
        Sha1 = 1,
        MD5 = 2,
    };
    enum class EmailMailboxSyncStatus : std::int32_t
    {
        Idle = 0,
        Syncing = 1,
        UpToDate = 2,
    ...
    enum class EmailMeetingResponseType : std::int32_t
    {
        Accept = 0,
        Decline = 1,
        Tentative = 2,
    };
    enum class EmailMessageBodyKind : std::int32_t
    {
        Html = 0,
        PlainText = 1,
    };
    enum class EmailMessageDownloadState : std::int32_t
    {
    ...
    enum class EmailMessageResponseKind : std::int32_t
    {
        None = 0,
        Reply = 1,
        ReplyAll = 2,
    ...
    enum class EmailMessageSmimeKind : std::int32_t
    {
        None = 0,
        ClearSigned = 1,
        OpaqueSigned = 2,
    ...
    enum class EmailQueryKind : std::int32_t
    {
        All = 0,
        Important = 1,
        Flagged = 2,
    ...
    enum class EmailQuerySearchFields : std::uint32_t
    {
        None = 0,
        Subject = 0x1,
        Sender = 0x2,
    ...
    enum class EmailQuerySearchScope : std::int32_t
    {
        Local = 0,
        Server = 1,
    };
    enum class EmailQuerySortDirection : std::int32_t
    {
        Descending = 0,
        Ascending = 1,
    };
    enum class EmailQuerySortProperty : std::int32_t
    {
        Date = 0,
    };
    enum class EmailRecipientResolutionStatus : std::int32_t
    {
        Success = 0,
        RecipientNotFound = 1,
    ...
    enum class EmailSpecialFolderKind : std::int32_t
    {
        None = 0,
        Root = 1,
        Inbox = 2,
    ...
    enum class EmailStoreAccessType : std::int32_t
    {
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailAttachment>
    {
        ...
        {
            virtual std::int32_t __stdcall get_FileName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_FileName(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailAttachment2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_ContentId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ContentLocation(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ContentLocation(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_DownloadState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DownloadState(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_EstimatedDownloadSizeInBytes(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EstimatedDownloadSizeInBytes(std::uint64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IsFromBaseMessage(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsInline(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsInline(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MimeType(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MimeType(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailAttachmentFactory2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Create(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailConversation>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Id(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MailboxId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FlagState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasAttachment(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Importance(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_LastEmailResponseKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MessageCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MostRecentMessageId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MostRecentMessageTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Preview(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LatestSender(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Subject(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UnreadMessageCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall FindMessagesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindMessagesWithCountAsync(std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailConversationBatch>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Conversations(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailFolder>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MailboxId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ParentFolderId(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsSyncEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSyncEnabled(bool) noexcept = 0;
            ...
            virtual std::int32_t __stdcall CreateFolderAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindChildFoldersAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConversationReader(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConversationReaderWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageReader(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageReaderWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageCountsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryMoveAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryMoveWithNewNameAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySaveAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveMessageAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailIrmInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanEdit(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanEdit(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanExtractData(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanExtractData(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanForward(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanForward(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanModifyRecipientsOnResponse(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanModifyRecipientsOnResponse(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanPrintData(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanPrintData(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanRemoveIrmOnResponse(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanRemoveIrmOnResponse(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanReply(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanReply(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanReplyAll(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanReplyAll(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ExpirationDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ExpirationDate(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IsIrmOriginator(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsIrmOriginator(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsProgramaticAccessAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsProgramaticAccessAllowed(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Template(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Template(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailIrmInfoFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Create(std::int64_t, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailItemCounts>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Flagged(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Important(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Total(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Unread(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailbox>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_DisplayName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Id(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOwnedByCurrentApp(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDataEncryptedUnderLock(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MailAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MailAddress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_MailAddressAliases(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Policies(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall GetMessageReaderWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConversationAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFolderAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSpecialFolderAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkMessageAsSeenAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkFolderAsSeenAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkMessageReadAsync(void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall ChangeMessageFlagStateAsync(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryMoveMessageAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryMoveFolderAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryMoveFolderWithNewNameAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteMessageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall MarkFolderSyncEnabledAsync(void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall SendMessageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveDraftAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DownloadMessageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DownloadAttachmentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateResponseMessageAsync(void*, std::int32_t, void*, std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryUpdateMeetingResponseAsync(void*, std::int32_t, void*, void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryForwardMeetingAsync(void*, void*, void*, std::int32_t, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryProposeNewTimeForMeetingAsync(void*, std::int64_t, std::int64_t, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_MailboxChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_MailboxChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall SmartSendMessageAsync(void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySetAutoReplySettingsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetAutoReplySettingsAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailbox2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LinkedMailboxId(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailbox3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ResolveRecipientsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ValidateCertificatesAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryEmptyFolderAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryCreateFolderAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryDeleteFolderAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxAction>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Kind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ChangeNumber(std::uint64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxAutoReplySettings>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ResponseKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ResponseKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_StartTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_StartTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_EndTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_EndTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_InternalReply(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_KnownExternalReply(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UnknownExternalReply(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxCapabilities>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanForwardMeetings(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanGetAndSetExternalAutoReplies(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanGetAndSetInternalAutoReplies(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanUpdateMeetingResponses(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanServerSearchFolders(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanServerSearchMailbox(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanProposeNewTimeForMeetings(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanSmartSend(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxCapabilities2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CanResolveRecipients(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanValidateCertificates(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanEmptyFolder(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanCreateFolder(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanDeleteFolder(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_CanMoveFolder(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxCapabilities3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_CanForwardMeetings(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanGetAndSetExternalAutoReplies(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanGetAndSetInternalAutoReplies(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanUpdateMeetingResponses(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanServerSearchFolders(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanServerSearchMailbox(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanProposeNewTimeForMeetings(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanSmartSend(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanResolveRecipients(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanValidateCertificates(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanEmptyFolder(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanCreateFolder(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanDeleteFolder(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_CanMoveFolder(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxChange>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MailboxActions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Message(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Folder(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxPolicies>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AllowedSmimeEncryptionAlgorithmNegotiation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowSmimeSoftCertificates(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_RequiredSmimeEncryptionAlgorithm(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RequiredSmimeSigningAlgorithm(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxPolicies2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MustEncryptSmimeMessages(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MustSignSmimeMessages(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMailboxPolicies3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall put_AllowedSmimeEncryptionAlgorithmNegotiation(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowSmimeSoftCertificates(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_RequiredSmimeEncryptionAlgorithm(void*) noexcept = 0;
            virtual std::int32_t __stdcall put_RequiredSmimeSigningAlgorithm(void*) noexcept = 0;
            virtual std::int32_t __stdcall put_MustEncryptSmimeMessages(bool) noexcept = 0;
            virtual std::int32_t __stdcall put_MustSignSmimeMessages(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailManagerForUser>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ShowComposeNewEmailAsync(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMeetingInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AllowNewTimeProposal(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowNewTimeProposal(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_AppointmentRoamingId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AppointmentRoamingId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AppointmentOriginalStartTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AppointmentOriginalStartTime(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsAllDay(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsAllDay(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsResponseRequested(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsResponseRequested(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Location(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Location(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProposedStartTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ProposedStartTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ProposedDuration(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ProposedDuration(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_RecurrenceStartTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RecurrenceStartTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Recurrence(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Recurrence(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoteChangeNumber(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RemoteChangeNumber(std::uint64_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMeetingInfo2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsReportedOutOfDateByServer(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMessage>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Subject(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Subject(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Body(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Body(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_To(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CC(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Bcc(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Attachments(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMessage2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_RemoteId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_MailboxId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ConversationId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FolderId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowInternetImages(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowInternetImages(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ChangeNumber(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DownloadState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DownloadState(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_EstimatedDownloadSizeInBytes(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EstimatedDownloadSizeInBytes(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_FlagState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_FlagState(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_HasPartialBodies(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_Importance(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Importance(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_InResponseToMessageId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IrmInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_IrmInfo(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDraftMessage(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsRead(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsRead(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSeen(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSeen(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsServerSearchMessage(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSmartSendable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_MessageClass(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MessageClass(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_NormalizedSubject(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OriginalCodePage(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_OriginalCodePage(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Preview(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Preview(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_LastResponseKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_LastResponseKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Sender(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Sender(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SentTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SentTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_MeetingInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MeetingInfo(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetBodyStream(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetBodyStream(std::int32_t, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMessage3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SmimeData(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SmimeData(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SmimeKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SmimeKind(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMessage4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ReplyTo(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SentRepresenting(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SentRepresenting(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailMessageBatch>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Messages(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailQueryOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SortDirection(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SortDirection(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SortProperty(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SortProperty(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Kind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Kind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_FolderIds(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailRecipientFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithName(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailRecipientResolutionResult>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PublicKeys(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailRecipientResolutionResult2>
    {
        ...
        {
            virtual std::int32_t __stdcall put_Status(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetPublicKeys(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Email::IEmailStore>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindMailboxesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConversationReader(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConversationReaderWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageReader(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageReaderWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMailboxAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetConversationAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFolderAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMessageAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateMailboxAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateMailboxInAccountAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_ApplicationModel_Email_IEmailAttachment2
    {
        ...
        auto EstimatedDownloadSizeInBytes(std::uint64_t value) const;
    ...
    struct consume_Windows_ApplicationModel_Email_IEmailConversation
    {
        ...
        auto FindMessagesAsync(std::uint32_t count) const;
    };
    ...
    struct consume_Windows_ApplicationModel_Email_IEmailMeetingInfo
    {
        ...
        auto RemoteChangeNumber(std::uint64_t value) const;
        [[nodiscard]] auto StartTime() const;
    ...
    struct consume_Windows_ApplicationModel_Email_IEmailMessage2
    {
        ...
        [[nodiscard]] auto EstimatedDownloadSizeInBytes() const;
        auto EstimatedDownloadSizeInBytes(std::uint32_t value) const;
        [[nodiscard]] auto FlagState() const;
        ...
        auto OriginalCodePage(std::int32_t value) const;
        [[nodiscard]] auto Preview() const;
