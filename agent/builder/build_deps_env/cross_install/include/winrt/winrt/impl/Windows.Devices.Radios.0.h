...
{
    enum class RadioAccessStatus : std::int32_t
    {
        Unspecified = 0,
        Allowed = 1,
        DeniedByUser = 2,
    ...
    enum class RadioKind : std::int32_t
    {
        Other = 0,
        WiFi = 1,
        MobileBroadband = 2,
    ...
    enum class RadioState : std::int32_t
    {
        Unknown = 0,
        On = 1,
        Off = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Radios::IRadio>
    {
        ...
        {
            virtual std::int32_t __stdcall SetStateAsync(std::int32_t, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Radios::IRadioStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetRadiosAsync(void**) noexcept = 0;
