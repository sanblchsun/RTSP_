...
{
    enum class MicrosoftAccountMultiFactorAuthenticationType : std::int32_t
    {
        User = 0,
        Device = 1,
    };
    enum class MicrosoftAccountMultiFactorServiceResponse : std::int32_t
    {
        Success = 0,
        Error = 1,
    ...
    enum class MicrosoftAccountMultiFactorSessionApprovalStatus : std::int32_t
    {
        Pending = 0,
        Approved = 1,
        Denied = 2,
    };
    enum class MicrosoftAccountMultiFactorSessionAuthenticationStatus : std::int32_t
    {
        Authenticated = 0,
        Unauthenticated = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorAuthenticationManager>
    {
        ...
        {
            virtual std::int32_t __stdcall GetOneTimePassCodeAsync(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall AddDeviceAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveDeviceAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateWnsChannelAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSessionsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSessionsAndUnregisteredAccountsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ApproveSessionUsingAuthSessionInfoAsync(std::int32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ApproveSessionAsync(std::int32_t, void*, void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall DenySessionUsingAuthSessionInfoAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DenySessionAsync(void*, void*, std::int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorGetSessionsResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Sessions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceResponse(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorOneTimeCodedInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_TimeInterval(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeToLive(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceResponse(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorSessionInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UserAccountId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SessionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplaySessionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ApprovalStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_AuthenticationType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RequestTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExpirationTime(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Sessions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UnregisteredAccounts(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceResponse(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto GetOneTimePassCodeAsync(param::hstring const& userAccountId, std::uint32_t codeLength) const;
