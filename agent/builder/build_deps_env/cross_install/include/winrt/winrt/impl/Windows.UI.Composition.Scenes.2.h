...
WINRT_EXPORT namespace winrt::Windows::UI::Composition::Scenes
{
    ...
    struct WINRT_IMPL_EMPTY_BASES SceneVisual : winrt::Windows::UI::Composition::Scenes::ISceneVisual,
        ...
        impl::require<SceneVisual, winrt::Windows::UI::Composition::IContainerVisual, winrt::Windows::UI::Composition::IVisual, winrt::Windows::UI::Composition::IVisual2, winrt::Windows::UI::Composition::ICompositionObject, winrt::Windows::UI::Composition::ICompositionObject2, winrt::Windows::UI::Composition::ICompositionObject3, winrt::Windows::UI::Composition::ICompositionObject4, winrt::Windows::Foundation::IClosable, winrt::Windows::UI::Composition::IAnimationObject>
    {
