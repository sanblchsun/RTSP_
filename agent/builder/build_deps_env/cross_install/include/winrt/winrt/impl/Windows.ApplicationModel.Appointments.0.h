...
{
    enum class AppointmentBusyStatus : std::int32_t
    {
        Busy = 0,
        Tentative = 1,
        Free = 2,
    ...
    enum class AppointmentCalendarOtherAppReadAccess : std::int32_t
    {
        SystemOnly = 0,
        Limited = 1,
        Full = 2,
    ...
    enum class AppointmentCalendarOtherAppWriteAccess : std::int32_t
    {
        None = 0,
        SystemOnly = 1,
        Limited = 2,
    };
    enum class AppointmentCalendarSyncStatus : std::int32_t
    {
        Idle = 0,
        Syncing = 1,
        UpToDate = 2,
    ...
    enum class AppointmentConflictType : std::int32_t
    {
        None = 0,
        Adjacent = 1,
        Overlap = 2,
    };
    enum class AppointmentDaysOfWeek : std::uint32_t
    {
        None = 0,
        Sunday = 0x1,
        Monday = 0x2,
    ...
    enum class AppointmentDetailsKind : std::int32_t
    {
        PlainText = 0,
        Html = 1,
    };
    enum class AppointmentParticipantResponse : std::int32_t
    {
        None = 0,
        Tentative = 1,
        Accepted = 2,
    ...
    enum class AppointmentParticipantRole : std::int32_t
    {
        RequiredAttendee = 0,
        OptionalAttendee = 1,
        Resource = 2,
    };
    enum class AppointmentRecurrenceUnit : std::int32_t
    {
        Daily = 0,
        Weekly = 1,
        Monthly = 2,
    ...
    enum class AppointmentSensitivity : std::int32_t
    {
        Public = 0,
        Private = 1,
    };
    enum class AppointmentStoreAccessType : std::int32_t
    {
        AppCalendarsReadWrite = 0,
        AllCalendarsReadOnly = 1,
        AllCalendarsReadWrite = 2,
    };
    enum class AppointmentStoreChangeType : std::int32_t
    {
    ...
    enum class AppointmentSummaryCardView : std::int32_t
    {
        System = 0,
        App = 1,
    };
    enum class AppointmentWeekOfMonth : std::int32_t
    {
        First = 0,
        Second = 1,
        Third = 2,
    ...
    enum class FindAppointmentCalendarsOptions : std::uint32_t
    {
        None = 0,
        IncludeHidden = 0x1,
    };
    enum class RecurrenceType : std::int32_t
    {
        Master = 0,
        Instance = 1,
        ExceptionInstance = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointment>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Details(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Details(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Reminder(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Reminder(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Organizer(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Organizer(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Invitees(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Recurrence(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Recurrence(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_BusyStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_BusyStatus(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AllDay(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllDay(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Sensitivity(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Sensitivity(std::int32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointment2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LocalId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CalendarId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RoamingId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RoamingId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_OriginalStartTime(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_OnlineMeetingLink(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_OnlineMeetingLink(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ReplyTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ReplyTime(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_UserResponse(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UserResponse(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_HasInvitees(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsCanceledMeeting(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsCanceledMeeting(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOrganizedByUser(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsOrganizedByUser(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointment3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DetailsKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DetailsKind(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentCalendar>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DisplayColor(struct struct_Windows_UI_Color*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_SummaryCardView(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SummaryCardView(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall FindAppointmentsAsync(std::int64_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAppointmentsAsyncWithOptions(std::int64_t, std::int64_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindExceptionsFromMasterAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAllInstancesAsync(void*, std::int64_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAllInstancesAsyncWithOptions(void*, std::int64_t, std::int64_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppointmentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppointmentInstanceAsync(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindUnexpandedAppointmentsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindUnexpandedAppointmentsAsyncWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteAppointmentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteAppointmentInstanceAsync(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAppointmentAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentCalendar2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_DisplayColor(struct struct_Windows_UI_Color) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_CanCreateOrUpdateAppointments(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanCreateOrUpdateAppointments(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CanCancelMeetings(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanCancelMeetings(bool) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_CanNotifyInvitees(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_CanNotifyInvitees(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MustNofityInvitees(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_MustNofityInvitees(bool) noexcept = 0;
            virtual std::int32_t __stdcall TryCreateOrUpdateAppointmentAsync(void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryCancelMeetingAsync(void*, void*, void*, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryForwardMeetingAsync(void*, void*, void*, void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentConflictResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Date(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentException>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Appointment(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExceptionProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsDeleted(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentInvitee>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Role(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Response(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Response(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentManagerForUser>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ShowAddAppointmentAsync(void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowAddAppointmentWithPlacementAsync(void*, winrt::Windows::Foundation::Rect, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowReplaceAppointmentAsync(void*, void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowReplaceAppointmentWithPlacementAsync(void*, void*, winrt::Windows::Foundation::Rect, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(void*, void*, winrt::Windows::Foundation::Rect, std::int32_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowRemoveAppointmentAsync(void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowRemoveAppointmentWithPlacementAsync(void*, winrt::Windows::Foundation::Rect, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowRemoveAppointmentWithPlacementAndDateAsync(void*, winrt::Windows::Foundation::Rect, std::int32_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowTimeFrameAsync(std::int64_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowAppointmentDetailsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowAppointmentDetailsWithDateAsync(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowEditNewAppointmentAsync(void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentPropertiesStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Reminder(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_BusyStatus(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Sensitivity(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OriginalStartTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsResponseRequested(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowNewTimeProposal(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AllDay(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Details(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OnlineMeetingLink(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ReplyTime(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Organizer(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UserResponse(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HasInvitees(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsCanceledMeeting(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsOrganizedByUser(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Recurrence(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Uri(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Invitees(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultProperties(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentPropertiesStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ChangeNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoteChangeNumber(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DetailsKind(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentRecurrence>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Unit(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Unit(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Occurrences(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Occurrences(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Until(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Until(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Interval(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Interval(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DaysOfWeek(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DaysOfWeek(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_WeekOfMonth(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_WeekOfMonth(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Month(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Month(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Day(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Day(std::uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentRecurrence2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RecurrenceType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeZone(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TimeZone(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentRecurrence3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CalendarIdentifier(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentStore>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateAppointmentCalendarAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppointmentCalendarAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppointmentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAppointmentInstanceAsync(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAppointmentCalendarsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAppointmentCalendarsAsyncWithOptions(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAppointmentsAsync(std::int64_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAppointmentsAsyncWithOptions(std::int64_t, std::int64_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindConflictAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindConflictAsyncWithInstanceStart(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall MoveAppointmentAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowAddAppointmentAsync(void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowReplaceAppointmentAsync(void*, void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowReplaceAppointmentWithPlacementAndDateAsync(void*, void*, winrt::Windows::Foundation::Rect, std::int32_t, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowRemoveAppointmentAsync(void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall ShowAppointmentDetailsWithDateAsync(void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ShowEditNewAppointmentAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindLocalIdsFromRoamingIdAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentStore2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_StoreChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_StoreChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall CreateAppointmentCalendarInAccountAsync(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IAppointmentStoreChange2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AppointmentCalendar(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::IFindAppointmentsOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_CalendarIds(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FetchProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeHidden(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeHidden(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxCount(std::uint32_t) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_ApplicationModel_Appointments_IAppointmentRecurrence
    {
        ...
        auto Occurrences(winrt::Windows::Foundation::IReference<std::uint32_t> const& value) const;
        ...
        auto Interval(std::uint32_t value) const;
        ...
        auto Month(std::uint32_t value) const;
        [[nodiscard]] auto Day() const;
        auto Day(std::uint32_t value) const;
    };
    ...
    struct consume_Windows_ApplicationModel_Appointments_IFindAppointmentsOptions
    {
        ...
        auto MaxCount(std::uint32_t value) const;
    };
