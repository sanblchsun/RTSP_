...
WINRT_EXPORT namespace winrt::Windows::Phone::PersonalInformation
{
    ...
    enum class ContactQueryResultOrdering : std::int32_t
    {
        SystemDefault = 0,
        GivenNameFamilyName = 1,
        FamilyNameGivenName = 2,
    };
    enum class ContactStoreApplicationAccessMode : std::int32_t
    {
        LimitedReadOnly = 0,
        ReadOnly = 1,
    };
    enum class ContactStoreSystemAccessMode : std::int32_t
    {
        ReadOnly = 0,
        ReadWrite = 1,
    };
    enum class VCardFormat : std::int32_t
    {
        Version2_1 = 0,
        Version3 = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactChangeRecord>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_RevisionNumber(std::uint64_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_FamilyName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_GivenName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_GivenName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_HonorificPrefix(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_HonorificPrefix(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_HonorificSuffix(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_HonorificSuffix(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetDisplayPictureAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetDisplayPictureAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayPicture(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ToVcardAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ToVcardWithOptionsAsync(std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactInformation2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DisplayPictureDate(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DisplayPictureDate(std::int64_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactInformationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ParseVcardAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactQueryOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_OrderBy(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_OrderBy(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactQueryResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetContactCountAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetContactsAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetContactsAsyncInRange(std::uint32_t, std::uint32_t, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactStore>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindContactByRemoteIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindContactByIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteContactAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateContactQueryDefault(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateContactQueryWithOptions(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RevisionNumber(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetChangesAsync(std::uint64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall LoadExtendedPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveExtendedPropertiesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactStore2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateMeContactAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IContactStoreStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateOrOpenAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateOrOpenWithOptionsAsync(std::int32_t, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IKnownContactPropertiesStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HonorificPrefix(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HonorificSuffix(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AdditionalName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Address(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OtherAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Email(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WorkAddress(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WorkTelephone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_JobTitle(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Birthdate(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Anniversary(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Telephone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MobileTelephone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Url(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Notes(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WorkFax(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Children(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SignificantOther(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CompanyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CompanyTelephone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HomeFax(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AlternateTelephone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Manager(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Nickname(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OfficeLocation(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WorkEmail(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_YomiCompanyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_OtherEmail(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AlternateMobileTelephone(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AlternateWorkTelephone(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IStoredContact>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Store(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Id(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoteId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RemoteId(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetExtendedPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall ReplaceExistingContactAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::IStoredContactFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateStoredContact(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateStoredContactFromInformation(void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactQueryResult
    {
        ...
        auto GetContactsAsync(std::uint32_t startIndex, std::uint32_t maxNumberOfItems) const;
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactStore
    {
        ...
        [[nodiscard]] auto RevisionNumber() const;
        auto GetChangesAsync(std::uint64_t baseRevisionNumber) const;
