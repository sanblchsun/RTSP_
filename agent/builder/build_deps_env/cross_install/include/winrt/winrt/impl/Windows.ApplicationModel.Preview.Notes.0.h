...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsScreenLocked(bool*) noexcept = 0;
            virtual std::int32_t __stdcall ShowNote(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ShowNoteRelativeTo(std::int32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ShowNoteWithPlacement(std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall HideNote(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetNotePlacement(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySetNoteSize(std::int32_t, winrt::Windows::Foundation::Size, bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetFocusToNextView() noexcept = 0;
            virtual std::int32_t __stdcall SetNotesThumbnailAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_SystemLockStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SystemLockStateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_NotePlacementChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NotePlacementChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_NoteVisibilityChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NoteVisibilityChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ShowNoteRelativeToWithOptions(std::int32_t, std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall ShowNoteWithPlacementWithOptions(std::int32_t, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetFocusToPreviousView() noexcept = 0;
            virtual std::int32_t __stdcall SetThumbnailImageForTaskSwitcherAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ShowWithFocus(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ShowWithFocus(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetForCurrentApp(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_ApplicationModel_Preview_Notes_INotesWindowManagerPreview
    {
        ...
        auto ShowNote(std::int32_t noteViewId) const;
        auto ShowNoteRelativeTo(std::int32_t noteViewId, std::int32_t anchorNoteViewId) const;
        auto ShowNoteWithPlacement(std::int32_t noteViewId, winrt::Windows::Storage::Streams::IBuffer const& data) const;
        auto HideNote(std::int32_t noteViewId) const;
        auto GetNotePlacement(std::int32_t noteViewId) const;
        auto TrySetNoteSize(std::int32_t noteViewId, winrt::Windows::Foundation::Size const& size) const;
    ...
    {
        auto ShowNoteRelativeTo(std::int32_t noteViewId, std::int32_t anchorNoteViewId, winrt::Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions const& options) const;
        auto ShowNoteWithPlacement(std::int32_t noteViewId, winrt::Windows::Storage::Streams::IBuffer const& data, winrt::Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions const& options) const;
