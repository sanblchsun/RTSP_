...
{
    enum class LocalLocationFinderStatus : std::int32_t
    {
        Success = 0,
        UnknownError = 1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::ILocalCategoriesStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall get_BankAndCreditUnions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EatDrink(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Hospitals(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HotelsAndMotels(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_All(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Parking(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SeeDo(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Shop(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::ILocalLocation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DataAttribution(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::ILocalLocation2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Category(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RatingInfo(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HoursOfOperation(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::ILocalLocationFinderStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindLocalLocationsAsync(void*, void*, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::ILocalLocationHoursOfOperationItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Start(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Span(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::ILocalLocationRatingInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AggregateRating(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RatingCount(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ProviderIdentifier(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::Maps::LocalSearch::IPlaceInfoHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromLocalLocation(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto FindLocalLocationsAsync(param::hstring const& searchTerm, winrt::Windows::Devices::Geolocation::Geocircle const& searchArea, param::hstring const& localCategory, std::uint32_t maxResults) const;
    };
