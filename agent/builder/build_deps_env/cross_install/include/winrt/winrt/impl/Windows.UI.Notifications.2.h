...
WINRT_EXPORT namespace winrt::Windows::UI::Notifications
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NotificationData : winrt::Windows::UI::Notifications::INotificationData
    {
        ...
        NotificationData();
        NotificationData(param::iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, hstring>> const& initialValues, std::uint32_t sequenceNumber);
        ...
        impl::require<ScheduledToastNotification, winrt::Windows::UI::Notifications::IScheduledToastNotification2, winrt::Windows::UI::Notifications::IScheduledToastNotification3, winrt::Windows::UI::Notifications::IScheduledToastNotification4>
    {
        ...
        ScheduledToastNotification(winrt::Windows::Data::Xml::Dom::XmlDocument const& content, winrt::Windows::Foundation::DateTime const& deliveryTime, winrt::Windows::Foundation::TimeSpan const& snoozeInterval, std::uint32_t maximumSnoozeCount);
    };
