...
WINRT_EXPORT namespace winrt::Windows::Devices::Usb
{
    ...
    struct WINRT_IMPL_EMPTY_BASES UsbDevice : winrt::Windows::Devices::Usb::IUsbDevice
    {
        ...
        static auto GetDeviceSelector(std::uint32_t vendorId, std::uint32_t productId, winrt::guid const& winUsbInterfaceClass);
        static auto GetDeviceSelector(winrt::guid const& winUsbInterfaceClass);
        static auto GetDeviceSelector(std::uint32_t vendorId, std::uint32_t productId);
