...
{
    enum class LampArrayEffectCompletionBehavior : std::int32_t
    {
        ClearState = 0,
        KeepState = 1,
    };
    enum class LampArrayEffectStartMode : std::int32_t
    {
        Sequential = 0,
        Simultaneous = 1,
    };
    enum class LampArrayRepetitionMode : std::int32_t
    {
        Occurrences = 0,
        Forever = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayBitmapEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_StartDelay(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StartDelay(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_UpdateInterval(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UpdateInterval(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SuggestedBitmapSize(winrt::Windows::Foundation::Size*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayBitmapEffectFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(void*, std::uint32_t, std::int32_t*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayBitmapRequestedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SinceStarted(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateBitmap(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayBlinkEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AttackDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_AttackDuration(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SustainDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SustainDuration(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DecayDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DecayDuration(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RepetitionDelay(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RepetitionDelay(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_StartDelay(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StartDelay(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Occurrences(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Occurrences(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RepetitionMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RepetitionMode(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayColorRampEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Color(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall put_Color(struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall get_RampDuration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RampDuration(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_StartDelay(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_StartDelay(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CompletionBehavior(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CompletionBehavior(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayCustomEffect>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UpdateInterval(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_UpdateInterval(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall add_UpdateRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_UpdateRequested(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayEffectPlaylist>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall OverrideZIndex(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_EffectStartMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EffectStartMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Occurrences(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Occurrences(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RepetitionMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_RepetitionMode(std::int32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::Effects::ILampArrayEffectPlaylistStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall StartAll(void*) noexcept = 0;
            virtual std::int32_t __stdcall StopAll(void*) noexcept = 0;
            virtual std::int32_t __stdcall PauseAll(void*) noexcept = 0;
        };
    };
    ...
    {
        auto CreateInstance(winrt::Windows::Devices::Lights::LampArray const& lampArray, array_view<std::int32_t const> lampIndexes) const;
    };
    ...
    struct consume_Windows_Devices_Lights_Effects_ILampArrayBlinkEffect
    {
        ...
        auto Occurrences(std::int32_t value) const;
    ...
    struct consume_Windows_Devices_Lights_Effects_ILampArrayEffectPlaylist
    {
        ...
        auto OverrideZIndex(std::int32_t zIndex) const;
        auto Start() const;
        auto Stop() const;
        auto Pause() const;
