...
WINRT_EXPORT namespace winrt::Windows::Web::Http::Headers
{
        ...
        impl::require<HttpContentRangeHeaderValue, winrt::Windows::Foundation::IStringable>
    {
        ...
        explicit HttpContentRangeHeaderValue(std::uint64_t length);
        HttpContentRangeHeaderValue(std::uint64_t from, std::uint64_t to);
        HttpContentRangeHeaderValue(std::uint64_t from, std::uint64_t to, std::uint64_t length);
        static auto Parse(param::hstring const& input);
