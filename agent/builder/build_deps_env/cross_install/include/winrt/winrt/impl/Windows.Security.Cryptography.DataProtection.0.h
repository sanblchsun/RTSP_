...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall ProtectAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UnprotectAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ProtectStreamAsync(void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProviderFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateOverloadExplicit(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
