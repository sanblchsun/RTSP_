...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateForVisual(void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForVisualWithViewportClip(void*, winrt::Windows::Foundation::Rect, void*, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
        };
    };
    template <typename D>
