...
WINRT_EXPORT namespace winrt::Windows::Graphics::Imaging
{
    ...
    struct WINRT_IMPL_EMPTY_BASES SoftwareBitmap : winrt::Windows::Graphics::Imaging::ISoftwareBitmap
    {
        ...
        SoftwareBitmap(winrt::Windows::Graphics::Imaging::BitmapPixelFormat const& format, std::int32_t width, std::int32_t height);
        SoftwareBitmap(winrt::Windows::Graphics::Imaging::BitmapPixelFormat const& format, std::int32_t width, std::int32_t height, winrt::Windows::Graphics::Imaging::BitmapAlphaMode const& alpha);
        ...
        static auto CreateCopyFromBuffer(winrt::Windows::Storage::Streams::IBuffer const& source, winrt::Windows::Graphics::Imaging::BitmapPixelFormat const& format, std::int32_t width, std::int32_t height);
        static auto CreateCopyFromBuffer(winrt::Windows::Storage::Streams::IBuffer const& source, winrt::Windows::Graphics::Imaging::BitmapPixelFormat const& format, std::int32_t width, std::int32_t height, winrt::Windows::Graphics::Imaging::BitmapAlphaMode const& alpha);
