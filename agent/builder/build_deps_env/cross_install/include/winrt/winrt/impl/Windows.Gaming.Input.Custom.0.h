...
{
    enum class GipFirmwareUpdateStatus : std::int32_t
    {
        Completed = 0,
        UpToDate = 1,
        Failed = 2,
    };
    enum class GipMessageClass : std::int32_t
    {
        Command = 0,
        LowLatency = 1,
        StandardLatency = 2,
    };
    enum class XusbDeviceSubtype : std::int32_t
    {
        Unknown = 0,
        Gamepad = 1,
        ArcadePad = 2,
    ...
    enum class XusbDeviceType : std::int32_t
    {
        Unknown = 0,
        Gamepad = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Gaming::Input::Custom::GameControllerVersionInfo>{ using type = struct_category<std::uint16_t, std::uint16_t, std::uint16_t, std::uint16_t>; };
    template <> struct category<winrt::Windows::Gaming::Input::Custom::GipFirmwareUpdateProgress>{ using type = struct_category<double, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::ICustomGameControllerFactory>
    {
        ...
        {
            virtual std::int32_t __stdcall CreateGameController(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall OnGameControllerAdded(void*) noexcept = 0;
            virtual std::int32_t __stdcall OnGameControllerRemoved(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGameControllerFactoryManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RegisterCustomFactoryForGipInterface(void*, winrt::guid) noexcept = 0;
            virtual std::int32_t __stdcall RegisterCustomFactoryForHardwareId(void*, std::uint16_t, std::uint16_t) noexcept = 0;
            virtual std::int32_t __stdcall RegisterCustomFactoryForXusbType(void*, std::int32_t, std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGameControllerFactoryManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryGetFactoryControllerFromGameController(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGameControllerInputSink>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OnInputResumed(std::uint64_t) noexcept = 0;
            virtual std::int32_t __stdcall OnInputSuspended(std::uint64_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGameControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_FirmwareVersionInfo(struct struct_Windows_Gaming_Input_Custom_GameControllerVersionInfo*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_HardwareVersionInfo(struct struct_Windows_Gaming_Input_Custom_GameControllerVersionInfo*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGipFirmwareUpdateResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ExtendedErrorCode(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_FinalComponentId(std::uint32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGipGameControllerInputSink>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OnKeyReceived(std::uint64_t, std::uint8_t, bool) noexcept = 0;
            virtual std::int32_t __stdcall OnMessageReceived(std::uint64_t, std::int32_t, std::uint8_t, std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IGipGameControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SendMessage(std::int32_t, std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall SendReceiveMessage(std::int32_t, std::uint8_t, std::uint32_t, std::uint8_t*, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateFirmwareAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IHidGameControllerInputSink>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OnInputReportReceived(std::uint64_t, std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IHidGameControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetFeatureReport(std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall SendFeatureReport(std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall SendOutputReport(std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IXusbGameControllerInputSink>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OnInputReceived(std::uint64_t, std::uint8_t, std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Custom::IXusbGameControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetVibration(double, double) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Gaming_Input_Custom_IGameControllerFactoryManagerStatics
    {
        ...
        auto RegisterCustomFactoryForHardwareId(winrt::Windows::Gaming::Input::Custom::ICustomGameControllerFactory const& factory, std::uint16_t hardwareVendorId, std::uint16_t hardwareProductId) const;
    ...
    {
        auto OnInputResumed(std::uint64_t timestamp) const;
        auto OnInputSuspended(std::uint64_t timestamp) const;
    };
    ...
    {
        auto OnKeyReceived(std::uint64_t timestamp, std::uint8_t keyCode, bool isPressed) const;
        auto OnMessageReceived(std::uint64_t timestamp, winrt::Windows::Gaming::Input::Custom::GipMessageClass const& messageClass, std::uint8_t messageId, std::uint8_t sequenceId, array_view<std::uint8_t const> messageBuffer) const;
    };
    ...
    {
        auto SendMessage(winrt::Windows::Gaming::Input::Custom::GipMessageClass const& messageClass, std::uint8_t messageId, array_view<std::uint8_t const> messageBuffer) const;
        auto SendReceiveMessage(winrt::Windows::Gaming::Input::Custom::GipMessageClass const& messageClass, std::uint8_t messageId, array_view<std::uint8_t const> requestMessageBuffer, array_view<std::uint8_t> responseMessageBuffer) const;
    ...
    {
        auto OnInputReportReceived(std::uint64_t timestamp, std::uint8_t reportId, array_view<std::uint8_t const> reportBuffer) const;
    };
    ...
    struct consume_Windows_Gaming_Input_Custom_IHidGameControllerProvider
    {
        ...
        auto GetFeatureReport(std::uint8_t reportId, array_view<std::uint8_t> reportBuffer) const;
        auto SendFeatureReport(std::uint8_t reportId, array_view<std::uint8_t const> reportBuffer) const;
        auto SendOutputReport(std::uint8_t reportId, array_view<std::uint8_t const> reportBuffer) const;
    };
    ...
    {
        auto OnInputReceived(std::uint64_t timestamp, std::uint8_t reportId, array_view<std::uint8_t const> inputBuffer) const;
    };
    ...
    struct struct_Windows_Gaming_Input_Custom_GipFirmwareUpdateProgress
    {
        ...
        std::uint32_t CurrentComponentId;
    };
