...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Perception::IPerceptionTimestamp>
    {
        ...
        {
            virtual std::int32_t __stdcall get_TargetTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PredictionAmount(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::IPerceptionTimestamp2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SystemRelativeTargetTime(std::int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::IPerceptionTimestampHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromHistoricalTargetTime(std::int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Perception::IPerceptionTimestampHelperStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromSystemRelativeTargetTime(std::int64_t, void**) noexcept = 0;
        };
    };
    template <typename D>
