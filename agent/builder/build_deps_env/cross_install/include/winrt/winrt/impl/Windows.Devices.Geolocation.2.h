...
WINRT_EXPORT namespace winrt::Windows::Devices::Geolocation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES GeoboundingBox : winrt::Windows::Devices::Geolocation::IGeoboundingBox
    {
        ...
        GeoboundingBox(winrt::Windows::Devices::Geolocation::BasicGeoposition const& northwestCorner, winrt::Windows::Devices::Geolocation::BasicGeoposition const& southeastCorner, winrt::Windows::Devices::Geolocation::AltitudeReferenceSystem const& altitudeReferenceSystem, std::uint32_t spatialReferenceId);
        ...
        static auto TryCompute(param::iterable<winrt::Windows::Devices::Geolocation::BasicGeoposition> const& positions, winrt::Windows::Devices::Geolocation::AltitudeReferenceSystem const& altitudeRefSystem, std::uint32_t spatialReferenceId);
    };
    struct WINRT_IMPL_EMPTY_BASES Geocircle : winrt::Windows::Devices::Geolocation::IGeocircle
    {
        ...
        Geocircle(winrt::Windows::Devices::Geolocation::BasicGeoposition const& position, double radius, winrt::Windows::Devices::Geolocation::AltitudeReferenceSystem const& altitudeReferenceSystem, std::uint32_t spatialReferenceId);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES Geopath : winrt::Windows::Devices::Geolocation::IGeopath
    {
        ...
        Geopath(param::iterable<winrt::Windows::Devices::Geolocation::BasicGeoposition> const& positions, winrt::Windows::Devices::Geolocation::AltitudeReferenceSystem const& altitudeReferenceSystem, std::uint32_t spatialReferenceId);
    };
    struct WINRT_IMPL_EMPTY_BASES Geopoint : winrt::Windows::Devices::Geolocation::IGeopoint
    {
        ...
        Geopoint(winrt::Windows::Devices::Geolocation::BasicGeoposition const& position, winrt::Windows::Devices::Geolocation::AltitudeReferenceSystem const& altitudeReferenceSystem, std::uint32_t spatialReferenceId);
    };
