...
{
    enum class GraphicsTrustStatus : std::int32_t
    {
        TrustNotRequired = 0,
        TrustEstablished = 1,
    ...
    enum class HdcpProtection : std::int32_t
    {
        Off = 0,
        On = 1,
        OnWithTypeEnforcement = 2,
    };
    enum class HdcpSetProtectionResult : std::int32_t
    {
        Success = 0,
        TimedOut = 1,
        NotSupported = 2,
    ...
    enum class ProtectionCapabilityResult : std::int32_t
    {
        NotSupported = 0,
        Maybe = 1,
        Probably = 2,
    };
    enum class RenewalStatus : std::int32_t
    {
        NotStarted = 0,
        UpdatesInProgress = 1,
        UserCancelled = 2,
    ...
    enum class RevocationAndRenewalReasons : std::uint32_t
    {
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Protection::IComponentLoadFailedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Completion(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Protection::IComponentRenewalStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RenewSystemComponentsAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Protection::IHdcpSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsEffectiveProtectionAtLeast(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetEffectiveProtection(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetDesiredMinProtectionAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_ProtectionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ProtectionChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Protection::IMediaProtectionManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_ServiceRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ServiceRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_RebootNeeded(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_RebootNeeded(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_ComponentLoadFailed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ComponentLoadFailed(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Protection::IMediaProtectionPMPServerFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreatePMPServer(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Protection::IMediaProtectionServiceCompletion>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Complete(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Protection::IMediaProtectionServiceRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ProtectionSystem(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall get_Type(winrt::guid*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Media::Protection::IProtectionCapabilities>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsTypeSupported(void*, void*, std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Protection::IRevocationAndRenewalItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HeaderHash(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PublicKeyHash(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Name(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RenewalId(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Protection::IServiceRequestedEventArgs2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_MediaPlaybackItem(void**) noexcept = 0;
        };
    };
