...
{
    enum class NavigationCacheMode : std::int32_t
    {
        Disabled = 0,
        Required = 1,
        Enabled = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Xaml::Navigation::IFrameNavigationOptions>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsNavigationStackEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsNavigationStackEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_TransitionInfoOverride(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TransitionInfoOverride(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_NavigationMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SourcePageType(struct struct_Windows_UI_Xaml_Interop_TypeName*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_NavigationTransitionInfo(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Xaml::Navigation::IPageStackEntryFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(struct struct_Windows_UI_Xaml_Interop_TypeName, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Xaml::Navigation::IPageStackEntryStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SourcePageTypeProperty(void**) noexcept = 0;
        };
    };
