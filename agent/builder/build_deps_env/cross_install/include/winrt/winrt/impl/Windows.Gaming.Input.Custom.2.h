...
WINRT_EXPORT namespace winrt::Windows::Gaming::Input::Custom
{
    ...
    struct GameControllerFactoryManager
    {
        ...
        static auto RegisterCustomFactoryForHardwareId(winrt::Windows::Gaming::Input::Custom::ICustomGameControllerFactory const& factory, std::uint16_t hardwareVendorId, std::uint16_t hardwareProductId);
