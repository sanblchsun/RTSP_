...
{
    enum class GeofenceMonitorStatus : std::int32_t
    {
        Ready = 0,
        Initializing = 1,
        NoData = 2,
    ...
    enum class GeofenceRemovalReason : std::int32_t
    {
        Used = 0,
        Expired = 1,
    };
    enum class GeofenceState : std::uint32_t
    {
        None = 0,
        Entered = 0x1,
        Exited = 0x2,
    ...
    enum class MonitoredGeofenceStates : std::uint32_t
    {
        None = 0,
        Entered = 0x1,
        Exited = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Geolocation::Geofencing::IGeofence>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DwellTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Id(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MonitoredStates(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Geoshape(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SingleUse(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Geolocation::Geofencing::IGeofenceFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithMonitorStates(void*, void*, std::uint32_t, bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithMonitorStatesAndDwellTime(void*, void*, std::uint32_t, bool, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithMonitorStatesDwellTimeStartTimeAndDuration(void*, void*, std::uint32_t, bool, std::int64_t, std::int64_t, std::int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Geolocation::Geofencing::IGeofenceMonitor>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Geofences(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LastKnownGeoposition(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_GeofenceStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GeofenceStateChanged(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Geolocation::Geofencing::IGeofenceStateChangeReport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NewState(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Geofence(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Geoposition(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RemovalReason(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
