...
WINRT_EXPORT namespace winrt::Windows::Devices::Lights::Effects
{
        ...
        impl::require<LampArrayBitmapEffect, winrt::Windows::Devices::Lights::Effects::ILampArrayEffect>
    {
        ...
        LampArrayBitmapEffect(winrt::Windows::Devices::Lights::LampArray const& lampArray, array_view<std::int32_t const> lampIndexes);
    };
        ...
        impl::require<LampArrayBlinkEffect, winrt::Windows::Devices::Lights::Effects::ILampArrayEffect>
    {
        ...
        LampArrayBlinkEffect(winrt::Windows::Devices::Lights::LampArray const& lampArray, array_view<std::int32_t const> lampIndexes);
    };
        ...
        impl::require<LampArrayColorRampEffect, winrt::Windows::Devices::Lights::Effects::ILampArrayEffect>
    {
        ...
        LampArrayColorRampEffect(winrt::Windows::Devices::Lights::LampArray const& lampArray, array_view<std::int32_t const> lampIndexes);
    };
        ...
        impl::require<LampArrayCustomEffect, winrt::Windows::Devices::Lights::Effects::ILampArrayEffect>
    {
        ...
        LampArrayCustomEffect(winrt::Windows::Devices::Lights::LampArray const& lampArray, array_view<std::int32_t const> lampIndexes);
    };
        ...
        impl::require<LampArraySolidEffect, winrt::Windows::Devices::Lights::Effects::ILampArrayEffect>
    {
        ...
        LampArraySolidEffect(winrt::Windows::Devices::Lights::LampArray const& lampArray, array_view<std::int32_t const> lampIndexes);
    };
