...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Embedded::DeviceLockdown::IDeviceLockdownProfileStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetSupportedLockdownProfiles(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentLockdownProfile(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall ApplyLockdownProfileAsync(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetLockdownProfileInformation(winrt::guid, void**) noexcept = 0;
        };
    };
    template <typename D>
