...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarCancelMeetingRequest>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AppointmentCalendarLocalId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AppointmentLocalId(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_NotifyInvitees(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarCreateOrUpdateAppointmentRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_NotifyInvitees(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ChangedProperties(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Appointments::DataProvider::IAppointmentDataProviderConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_SyncRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SyncRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CreateOrUpdateAppointmentRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CreateOrUpdateAppointmentRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CancelMeetingRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CancelMeetingRequested(winrt::event_token) noexcept = 0;
