...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Background::IBluetoothLEAdvertisementWatcherTriggerDetails>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Error(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Advertisements(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Background::IGattCharacteristicNotificationTriggerDetails2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ValueChangedEvents(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Background::IGattServiceProviderConnectionStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AllServices(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Background::IRfcommConnectionTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Incoming(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoteDevice(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Background::IRfcommInboundConnectionInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SdpRecord(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SdpRecord(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalServiceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LocalServiceId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ServiceCapabilities(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ServiceCapabilities(std::uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Background::IRfcommOutboundConnectionInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RemoteServiceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RemoteServiceId(void*) noexcept = 0;
        };
    };
    template <typename D>
