...
WINRT_EXPORT namespace winrt::Windows::Media::MediaProperties
{
        ...
        impl::require<AudioEncodingProperties, winrt::Windows::Media::MediaProperties::IAudioEncodingPropertiesWithFormatUserData, winrt::Windows::Media::MediaProperties::IAudioEncodingProperties2, winrt::Windows::Media::MediaProperties::IAudioEncodingProperties3>
    {
        ...
        static auto CreateAac(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitrate);
        static auto CreateAacAdts(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitrate);
        static auto CreateMp3(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitrate);
        static auto CreatePcm(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitsPerSample);
        static auto CreateWma(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitrate);
        static auto CreateAlac(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitsPerSample);
        static auto CreateFlac(std::uint32_t sampleRate, std::uint32_t channelCount, std::uint32_t bitsPerSample);
    };
        ...
        impl::require<TimedMetadataEncodingProperties, winrt::Windows::Media::MediaProperties::ITimedMetadataEncodingProperties>
    {
        ...
        static auto CreateSsa(array_view<std::uint8_t const> formatUserData);
        static auto CreateVobSub(array_view<std::uint8_t const> formatUserData);
    };
        ...
        impl::require<VideoEncodingProperties, winrt::Windows::Media::MediaProperties::IVideoEncodingProperties2, winrt::Windows::Media::MediaProperties::IVideoEncodingProperties3, winrt::Windows::Media::MediaProperties::IVideoEncodingProperties4, winrt::Windows::Media::MediaProperties::IVideoEncodingProperties5>
    {
        ...
        static auto CreateUncompressed(param::hstring const& subtype, std::uint32_t width, std::uint32_t height);
