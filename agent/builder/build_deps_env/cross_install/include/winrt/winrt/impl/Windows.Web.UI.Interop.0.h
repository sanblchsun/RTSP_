...
{
    enum class WebViewControlAcceleratorKeyRoutingStage : std::int32_t
    {
        Tunneling = 0,
        Bubbling = 1,
    };
    enum class WebViewControlMoveFocusReason : std::int32_t
    {
        Programmatic = 0,
        Next = 1,
        Previous = 2,
    };
    enum class WebViewControlProcessCapabilityState : std::int32_t
    {
        Default = 0,
        Disabled = 1,
        Enabled = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Web::UI::Interop::IWebViewControlAcceleratorKeyPressedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_RoutingStage(std::int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Web::UI::Interop::IWebViewControlProcess>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsPrivateNetworkClientServerCapabilityEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall CreateWebViewControlAsync(std::int64_t, winrt::Windows::Foundation::Rect, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetWebViewControls(void**) noexcept = 0;
            virtual std::int32_t __stdcall Terminate() noexcept = 0;
            virtual std::int32_t __stdcall add_ProcessExited(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ProcessExited(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::UI::Interop::IWebViewControlProcessFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithOptions(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::UI::Interop::IWebViewControlProcessOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_EnterpriseId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PrivateNetworkClientServerCapability(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PrivateNetworkClientServerCapability(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Web::UI::Interop::IWebViewControlSite>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Scale(double) noexcept = 0;
            virtual std::int32_t __stdcall get_Scale(double*) noexcept = 0;
    ...
    struct consume_Windows_Web_UI_Interop_IWebViewControlProcess
    {
        ...
        auto CreateWebViewControlAsync(std::int64_t hostWindowHandle, winrt::Windows::Foundation::Rect const& bounds) const;
