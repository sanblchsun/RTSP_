...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Management::Update::IPreviewBuildsManager>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ArePreviewBuildsAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ArePreviewBuildsAllowed(bool) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentState(void**) noexcept = 0;
