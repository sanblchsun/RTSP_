...
WINRT_EXPORT namespace winrt::Windows::Media::Core
{
        ...
        impl::require<MediaStreamSample, winrt::Windows::Media::Core::IMediaStreamSample2>
    {
        ...
        static auto CreateFromStreamAsync(winrt::Windows::Storage::Streams::IInputStream const& stream, std::uint32_t count, winrt::Windows::Foundation::TimeSpan const& timestamp);
