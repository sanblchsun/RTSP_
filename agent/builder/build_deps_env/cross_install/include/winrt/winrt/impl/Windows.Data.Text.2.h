...
WINRT_EXPORT namespace winrt::Windows::Data::Text
{
    ...
    struct UnicodeCharacters
    {
        ...
        static auto GetCodepointFromSurrogatePair(std::uint32_t highSurrogate, std::uint32_t lowSurrogate);
        static auto GetSurrogatePairFromCodepoint(std::uint32_t codepoint, char16_t& highSurrogate, char16_t& lowSurrogate);
        static auto IsHighSurrogate(std::uint32_t codepoint);
        static auto IsLowSurrogate(std::uint32_t codepoint);
        static auto IsSupplementary(std::uint32_t codepoint);
        static auto IsNoncharacter(std::uint32_t codepoint);
        static auto IsWhitespace(std::uint32_t codepoint);
        static auto IsAlphabetic(std::uint32_t codepoint);
        static auto IsCased(std::uint32_t codepoint);
        static auto IsUppercase(std::uint32_t codepoint);
        static auto IsLowercase(std::uint32_t codepoint);
        static auto IsIdStart(std::uint32_t codepoint);
        static auto IsIdContinue(std::uint32_t codepoint);
        static auto IsGraphemeBase(std::uint32_t codepoint);
        static auto IsGraphemeExtend(std::uint32_t codepoint);
        static auto GetNumericType(std::uint32_t codepoint);
        static auto GetGeneralCategory(std::uint32_t codepoint);
    };
