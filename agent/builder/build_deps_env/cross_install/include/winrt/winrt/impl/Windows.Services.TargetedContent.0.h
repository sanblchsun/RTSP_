...
{
    enum class TargetedContentAppInstallationState : std::int32_t
    {
        NotApplicable = 0,
        NotInstalled = 1,
        Installed = 2,
    };
    enum class TargetedContentAvailability : std::int32_t
    {
        None = 0,
        Partial = 1,
        All = 2,
    };
    enum class TargetedContentInteraction : std::int32_t
    {
        Impression = 0,
        ClickThrough = 1,
        Hover = 2,
    ...
    enum class TargetedContentObjectKind : std::int32_t
    {
        Collection = 0,
        Item = 1,
        Value = 2,
    };
    enum class TargetedContentValueKind : std::int32_t
    {
        String = 0,
        Uri = 1,
        Number = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentAction>
    {
        ...
        {
            virtual std::int32_t __stdcall InvokeAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentChangedEventArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_HasPreviousContentExpired(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentCollection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ReportInteraction(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReportCustomInteraction(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Path(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Properties(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Collections(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentContainer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SelectSingleObject(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentItemState>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ShouldDisplay(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_AppInstallationState(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentObject>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ObjectKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Collection(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentSubscription>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Id(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetContentContainerAsync(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentSubscriptionOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SubscriptionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowPartialContentAvailability(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowPartialContentAvailability(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_CloudQueryParameters(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalFilters(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentSubscriptionStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall GetAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetOptions(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Services::TargetedContent::ITargetedContentValue>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ValueKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Path(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_String(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Uri(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Number(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_Boolean(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_File(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ImageFile(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Action(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Strings(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Uris(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Numbers(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Booleans(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Files(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ImageFiles(void**) noexcept = 0;
