...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall AssociateNetworkAccountAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall ImportVcardToSystemAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AssociateSocialNetworkAccountAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Phone::PersonalInformation::Provisioning::IMessagePartnerProvisioningManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ImportSmsToSystemAsync(bool, bool, void*, void*, void*, std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ImportMmsToSystemAsync(bool, bool, void*, void*, void*, std::int64_t, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
