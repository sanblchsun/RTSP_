...
{
    enum class XamlEventIndex : std::int32_t
    {
    ...
    enum class XamlPropertyIndex : std::int32_t
    {
    ...
    enum class XamlTypeIndex : std::int32_t
    {
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Xaml::Core::Direct::IXamlDirect>
    {
        ...
        {
            virtual std::int32_t __stdcall GetObject(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetXamlDirectObject(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateInstance(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetObjectProperty(void*, std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetXamlDirectObjectProperty(void*, std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetBooleanProperty(void*, std::int32_t, bool) noexcept = 0;
            virtual std::int32_t __stdcall SetDoubleProperty(void*, std::int32_t, double) noexcept = 0;
            virtual std::int32_t __stdcall SetInt32Property(void*, std::int32_t, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetStringProperty(void*, std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetDateTimeProperty(void*, std::int32_t, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall SetPointProperty(void*, std::int32_t, winrt::Windows::Foundation::Point) noexcept = 0;
            virtual std::int32_t __stdcall SetRectProperty(void*, std::int32_t, winrt::Windows::Foundation::Rect) noexcept = 0;
            virtual std::int32_t __stdcall SetSizeProperty(void*, std::int32_t, winrt::Windows::Foundation::Size) noexcept = 0;
            virtual std::int32_t __stdcall SetTimeSpanProperty(void*, std::int32_t, std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall SetColorProperty(void*, std::int32_t, struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall SetCornerRadiusProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_CornerRadius) noexcept = 0;
            virtual std::int32_t __stdcall SetDurationProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Duration) noexcept = 0;
            virtual std::int32_t __stdcall SetGridLengthProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_GridLength) noexcept = 0;
            virtual std::int32_t __stdcall SetThicknessProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Thickness) noexcept = 0;
            virtual std::int32_t __stdcall SetMatrixProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Media_Matrix) noexcept = 0;
            virtual std::int32_t __stdcall SetMatrix3DProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D) noexcept = 0;
            virtual std::int32_t __stdcall SetEnumProperty(void*, std::int32_t, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetObjectProperty(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetXamlDirectObjectProperty(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetBooleanProperty(void*, std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetDoubleProperty(void*, std::int32_t, double*) noexcept = 0;
            virtual std::int32_t __stdcall GetInt32Property(void*, std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetStringProperty(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetDateTimeProperty(void*, std::int32_t, std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetPointProperty(void*, std::int32_t, winrt::Windows::Foundation::Point*) noexcept = 0;
            virtual std::int32_t __stdcall GetRectProperty(void*, std::int32_t, winrt::Windows::Foundation::Rect*) noexcept = 0;
            virtual std::int32_t __stdcall GetSizeProperty(void*, std::int32_t, winrt::Windows::Foundation::Size*) noexcept = 0;
            virtual std::int32_t __stdcall GetTimeSpanProperty(void*, std::int32_t, std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetColorProperty(void*, std::int32_t, struct struct_Windows_UI_Color*) noexcept = 0;
            virtual std::int32_t __stdcall GetCornerRadiusProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_CornerRadius*) noexcept = 0;
            virtual std::int32_t __stdcall GetDurationProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Duration*) noexcept = 0;
            virtual std::int32_t __stdcall GetGridLengthProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_GridLength*) noexcept = 0;
            virtual std::int32_t __stdcall GetThicknessProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Thickness*) noexcept = 0;
            virtual std::int32_t __stdcall GetMatrixProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Media_Matrix*) noexcept = 0;
            virtual std::int32_t __stdcall GetMatrix3DProperty(void*, std::int32_t, struct struct_Windows_UI_Xaml_Media_Media3D_Matrix3D*) noexcept = 0;
            virtual std::int32_t __stdcall GetEnumProperty(void*, std::int32_t, std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ClearProperty(void*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetCollectionCount(void*, std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetXamlDirectObjectFromCollectionAt(void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall AddToCollection(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall InsertIntoCollectionAt(void*, std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveFromCollection(void*, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveFromCollectionAt(void*, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall ClearCollection(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddEventHandler(void*, std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall AddEventHandler_HandledEventsToo(void*, std::int32_t, void*, bool) noexcept = 0;
            virtual std::int32_t __stdcall RemoveEventHandler(void*, std::int32_t, void*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Xaml_Core_Direct_IXamlDirect
    {
        ...
        auto SetInt32Property(winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Windows::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, std::int32_t value) const;
        ...
        auto SetEnumProperty(winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Windows::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, std::uint32_t value) const;
        ...
        auto GetXamlDirectObjectFromCollectionAt(winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, std::uint32_t index) const;
        ...
        auto InsertIntoCollectionAt(winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, std::uint32_t index, winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        ...
        auto RemoveFromCollectionAt(winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, std::uint32_t index) const;
