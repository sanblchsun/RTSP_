...
WINRT_EXPORT namespace winrt::Windows::Networking::Vpn
{
    ...
    struct WINRT_IMPL_EMPTY_BASES VpnInterfaceId : winrt::Windows::Networking::Vpn::IVpnInterfaceId
    {
        ...
        explicit VpnInterfaceId(array_view<std::uint8_t const> address);
    };
        ...
        impl::require<VpnPacketBuffer, winrt::Windows::Networking::Vpn::IVpnPacketBuffer2, winrt::Windows::Networking::Vpn::IVpnPacketBuffer3>
    {
        ...
        VpnPacketBuffer(winrt::Windows::Networking::Vpn::VpnPacketBuffer const& parentBuffer, std::uint32_t offset, std::uint32_t length);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES VpnRoute : winrt::Windows::Networking::Vpn::IVpnRoute
    {
        ...
        VpnRoute(winrt::Windows::Networking::HostName const& address, std::uint8_t prefixSize);
    };
