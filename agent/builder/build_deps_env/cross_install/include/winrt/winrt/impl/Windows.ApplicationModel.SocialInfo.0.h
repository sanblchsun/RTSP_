...
{
    enum class SocialFeedItemStyle : std::int32_t
    {
        Default = 0,
        Photo = 1,
    };
    enum class SocialFeedKind : std::int32_t
    {
        HomeFeed = 0,
        ContactFeed = 1,
        Dashboard = 2,
    };
    enum class SocialFeedUpdateMode : std::int32_t
    {
        Append = 0,
        Replace = 1,
    };
    enum class SocialItemBadgeStyle : std::int32_t
    {
        Hidden = 0,
        Visible = 1,
        VisibleWithCount = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::SocialInfo::ISocialFeedChildItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_PrimaryContent(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SecondaryContent(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Timestamp(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Timestamp(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_TargetUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TargetUri(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Thumbnails(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SharedItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SharedItem(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::SocialInfo::ISocialFeedItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SharedItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SharedItem(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_BadgeStyle(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_BadgeStyle(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_BadgeCountValue(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_BadgeCountValue(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RemoteId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RemoteId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ChildItem(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ChildItem(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::SocialInfo::ISocialFeedSharedItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_OriginalSource(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::SocialInfo::ISocialItemThumbnail>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_BitmapSize(struct struct_Windows_Graphics_Imaging_BitmapSize*) noexcept = 0;
            virtual std::int32_t __stdcall put_BitmapSize(struct struct_Windows_Graphics_Imaging_BitmapSize) noexcept = 0;
            virtual std::int32_t __stdcall SetImageAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_ApplicationModel_SocialInfo_ISocialFeedItem
    {
        ...
        auto BadgeCountValue(std::int32_t value) const;
