...
WINRT_EXPORT namespace winrt::Windows::Media::Protection::PlayReady
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NDCustomData : winrt::Windows::Media::Protection::PlayReady::INDCustomData
    {
        ...
        NDCustomData(array_view<std::uint8_t const> customDataTypeIDBytes, array_view<std::uint8_t const> customDataBytes);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES NDLicenseFetchDescriptor : winrt::Windows::Media::Protection::PlayReady::INDLicenseFetchDescriptor
    {
        ...
        NDLicenseFetchDescriptor(winrt::Windows::Media::Protection::PlayReady::NDContentIDType const& contentIDType, array_view<std::uint8_t const> contentIDBytes, winrt::Windows::Media::Protection::PlayReady::INDCustomData const& licenseFetchChallengeCustomData);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES NDTCPMessenger : winrt::Windows::Media::Protection::PlayReady::INDMessenger
    {
        ...
        NDTCPMessenger(param::hstring const& remoteHostName, std::uint32_t remoteHostPort);
    };
        ...
        impl::require<PlayReadyContentHeader, winrt::Windows::Media::Protection::PlayReady::IPlayReadyContentHeader2>
    {
        ...
        PlayReadyContentHeader(array_view<std::uint8_t const> headerBytes, winrt::Windows::Foundation::Uri const& licenseAcquisitionUrl, winrt::Windows::Foundation::Uri const& licenseAcquisitionUserInterfaceUrl, param::hstring const& customAttributes, winrt::guid const& domainServiceId);
        ...
        explicit PlayReadyContentHeader(array_view<std::uint8_t const> headerBytes);
    ...
    struct WINRT_IMPL_EMPTY_BASES PlayReadySecureStopIterable : winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Media::Protection::PlayReady::IPlayReadySecureStopServiceRequest>
    {
        ...
        explicit PlayReadySecureStopIterable(array_view<std::uint8_t const> publisherCertBytes);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES PlayReadySecureStopServiceRequest : winrt::Windows::Media::Protection::PlayReady::IPlayReadySecureStopServiceRequest
    {
        ...
        explicit PlayReadySecureStopServiceRequest(array_view<std::uint8_t const> publisherCertBytes);
        PlayReadySecureStopServiceRequest(winrt::guid const& sessionID, array_view<std::uint8_t const> publisherCertBytes);
    };
