...
{
    enum class MdmAlertDataType : std::int32_t
    {
        String = 0,
        Base64 = 1,
        Boolean = 2,
    ...
    enum class MdmAlertMark : std::int32_t
    {
        None = 0,
        Fatal = 1,
        Critical = 2,
    ...
    enum class MdmSessionState : std::int32_t
    {
        NotStarted = 0,
        Starting = 1,
        Connecting = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Management::IMdmAlert>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Mark(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Mark(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Source(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Source(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::uint32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Management::IMdmSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Alerts(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall StartWithAlertsAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::IMdmSessionManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SessionIds(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryCreateSession(void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteSessionById(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetSessionById(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
