...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::IQuickLink>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SupportedDataFormats(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SupportedFileTypes(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::IShareOperation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_QuickLinkId(void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveThisQuickLink() noexcept = 0;
            virtual std::int32_t __stdcall ReportStarted() noexcept = 0;
            virtual std::int32_t __stdcall ReportDataRetrieved() noexcept = 0;
            virtual std::int32_t __stdcall ReportSubmittedBackgroundTask() noexcept = 0;
            virtual std::int32_t __stdcall ReportCompletedWithQuickLink(void*) noexcept = 0;
