...
{
    enum class SceneLightingEffectReflectanceModel : std::int32_t
    {
        BlinnPhong = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Composition::Effects::ISceneLightingEffect>
    {
        ...
        {
            virtual std::int32_t __stdcall get_AmbientAmount(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_AmbientAmount(float) noexcept = 0;
            virtual std::int32_t __stdcall get_DiffuseAmount(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_DiffuseAmount(float) noexcept = 0;
            virtual std::int32_t __stdcall get_NormalMapSource(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_NormalMapSource(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SpecularAmount(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_SpecularAmount(float) noexcept = 0;
            virtual std::int32_t __stdcall get_SpecularShine(float*) noexcept = 0;
            virtual std::int32_t __stdcall put_SpecularShine(float) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Composition::Effects::ISceneLightingEffect2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ReflectanceModel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ReflectanceModel(std::int32_t) noexcept = 0;
        };
    };
    template <typename D>
