...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Management_Core_IApplicationDataManagerStatics<D>::CreateForPackageFamily(param::hstring const& packageFamilyName) const
    {
        ...
        consume_general<winrt::Windows::Management::Core::IApplicationDataManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Core::IApplicationDataManagerStatics>::CreateForPackageFamily, *(void**)(&packageFamilyName), &applicationData);
    ...
    {
        std::int32_t __stdcall CreateForPackageFamily(void* packageFamilyName, void** applicationData) noexcept final try
        {
