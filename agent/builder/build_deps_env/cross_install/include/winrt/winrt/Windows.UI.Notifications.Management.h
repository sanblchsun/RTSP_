...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::RequestAccessAsync, &operation);
    ...
    template <typename D> auto consume_Windows_UI_Notifications_Management_IUserNotificationListener<D>::GetAccessStatus() const
    {
        ...
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::GetAccessStatus, reinterpret_cast<std::int32_t*>(&result));
        return result;
    }
    template <typename D> auto consume_Windows_UI_Notifications_Management_IUserNotificationListener<D>::NotificationChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Notifications::Management::UserNotificationListener, winrt::Windows::UI::Notifications::UserNotificationChangedEventArgs> const& handler) const
    {
        ...
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::add_NotificationChanged, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::remove_NotificationChanged, impl::bind_in(token));
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::GetNotificationsAsync, static_cast<std::uint32_t>(kinds), &operation);
    ...
    template <typename D> auto consume_Windows_UI_Notifications_Management_IUserNotificationListener<D>::GetNotification(std::uint32_t notificationId) const
    {
        void* result{};
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::GetNotification, notificationId, &result);
    ...
    {
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::ClearNotifications);
    }
    template <typename D> auto consume_Windows_UI_Notifications_Management_IUserNotificationListener<D>::RemoveNotification(std::uint32_t notificationId) const
    {
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListener, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListener>::RemoveNotification, notificationId);
    }
    template <typename D> auto consume_Windows_UI_Notifications_Management_IUserNotificationListenerStatics<D>::Current() const
    {
        void* value{};
        consume_general<winrt::Windows::UI::Notifications::Management::IUserNotificationListenerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Notifications::Management::IUserNotificationListenerStatics>::get_Current, &value);
    ...
    struct produce<D, winrt::Windows::UI::Notifications::Management::IUserNotificationListener> : produce_base<D, winrt::Windows::UI::Notifications::Management::IUserNotificationListener>
    {
        ...
        std::int32_t __stdcall GetAccessStatus(std::int32_t* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall add_NotificationChanged(void* handler, winrt::event_token* token) noexcept final try
        {
        ...
        std::int32_t __stdcall remove_NotificationChanged(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            this->shim().NotificationChanged(*reinterpret_cast<winrt::event_token const*>(&token));
            return 0;
        }
        std::int32_t __stdcall GetNotificationsAsync(std::uint32_t kinds, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall GetNotification(std::uint32_t notificationId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ClearNotifications() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall RemoveNotification(std::uint32_t notificationId) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
