...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* retval{};
        consume_general<winrt::Windows::Devices::Radios::IRadio, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadio>::SetStateAsync, static_cast<std::int32_t>(value), &retval);
    ...
    template <typename D> auto consume_Windows_Devices_Radios_IRadio<D>::StateChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Radios::Radio, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        ...
        consume_general<winrt::Windows::Devices::Radios::IRadio, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadio>::add_StateChanged, *(void**)(&handler), put_abi(eventCookie));
        return eventCookie;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::Devices::Radios::IRadio, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadio>::remove_StateChanged, impl::bind_in(eventCookie));
    }
    template <typename D> auto consume_Windows_Devices_Radios_IRadio<D>::State() const
    {
        ...
        consume_general<winrt::Windows::Devices::Radios::IRadio, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadio>::get_State, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    template <typename D> auto consume_Windows_Devices_Radios_IRadio<D>::Name() const
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Radios::IRadio, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadio>::get_Name, &value);
    ...
    template <typename D> auto consume_Windows_Devices_Radios_IRadio<D>::Kind() const
    {
        ...
        consume_general<winrt::Windows::Devices::Radios::IRadio, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadio>::get_Kind, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    template <typename D> auto consume_Windows_Devices_Radios_IRadioStatics<D>::GetRadiosAsync() const
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Radios::IRadioStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadioStatics>::GetRadiosAsync, &value);
    ...
    {
        void* deviceSelector{};
        consume_general<winrt::Windows::Devices::Radios::IRadioStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadioStatics>::GetDeviceSelector, &deviceSelector);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Radios::IRadioStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadioStatics>::FromIdAsync, *(void**)(&deviceId), &value);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Radios::IRadioStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Radios::IRadioStatics>::RequestAccessAsync, &value);
    ...
    {
        std::int32_t __stdcall SetStateAsync(std::int32_t value, void** retval) noexcept final try
        {
            clear_abi(retval);
        ...
        std::int32_t __stdcall add_StateChanged(void* handler, winrt::event_token* eventCookie) noexcept final try
        {
    ...
    {
        std::int32_t __stdcall GetRadiosAsync(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
