...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingMode() const
    {
        ...
        consume_general<winrt::Windows::Phone::System::Power::IPowerManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::System::Power::IPowerManagerStatics>::get_PowerSavingMode, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    template <typename D> auto consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingModeChanged(winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& changeHandler) const
    {
        ...
        consume_general<winrt::Windows::Phone::System::Power::IPowerManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::System::Power::IPowerManagerStatics>::add_PowerSavingModeChanged, *(void**)(&changeHandler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::Phone::System::Power::IPowerManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::System::Power::IPowerManagerStatics>::remove_PowerSavingModeChanged, impl::bind_in(token));
    }
    template <typename D> auto consume_Windows_Phone_System_Power_IPowerManagerStatics2<D>::PowerSavingModeEnabled() const
    {
        bool value{};
        consume_general<winrt::Windows::Phone::System::Power::IPowerManagerStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::System::Power::IPowerManagerStatics2>::get_PowerSavingModeEnabled, &value);
        return value;
    }
    ...
    {
        std::int32_t __stdcall get_PowerSavingMode(std::int32_t* value) noexcept final try
        {
        ...
        std::int32_t __stdcall add_PowerSavingModeChanged(void* changeHandler, winrt::event_token* token) noexcept final try
        {
        ...
        std::int32_t __stdcall remove_PowerSavingModeChanged(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_PowerSavingModeEnabled(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
