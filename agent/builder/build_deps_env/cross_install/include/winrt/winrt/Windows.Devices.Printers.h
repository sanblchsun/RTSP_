...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Printers::IPrint3DDevice, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IPrint3DDevice>::get_PrintSchema, &value);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::Devices::Printers::IPrint3DDeviceStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IPrint3DDeviceStatics>::FromIdAsync, *(void**)(&deviceId), &operation);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Devices::Printers::IPrint3DDeviceStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IPrint3DDeviceStatics>::GetDeviceSelector, &result);
        return hstring{ result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Devices_Printers_IPrintSchema<D>::GetDefaultPrintTicketAsync() const
    {
        void* operation{};
        consume_general<winrt::Windows::Devices::Printers::IPrintSchema, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IPrintSchema>::GetDefaultPrintTicketAsync, &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::Devices::Printers::IPrintSchema, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IPrintSchema>::GetCapabilitiesAsync, *(void**)(&constrainTicket), &operation);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::Streams::IRandomAccessStreamWithContentType>{ operation, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::Devices::Printers::IPrintSchema, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IPrintSchema>::MergeAndValidateWithDefaultPrintTicketAsync, *(void**)(&deltaTicket), &operation);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::Streams::IRandomAccessStreamWithContentType>{ operation, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall get_PrintSchema(void** value) noexcept final try
        {
            clear_abi(value);
    ...
    {
        std::int32_t __stdcall GetDefaultPrintTicketAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall GetCapabilitiesAsync(void* constrainTicket, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall MergeAndValidateWithDefaultPrintTicketAsync(void* deltaTicket, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
