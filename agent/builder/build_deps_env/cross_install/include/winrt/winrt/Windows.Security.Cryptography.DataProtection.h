...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider>::ProtectAsync, *(void**)(&data), &value);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider>::UnprotectAsync, *(void**)(&data), &value);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::Streams::IBuffer>{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider>::ProtectStreamAsync, *(void**)(&src), *(void**)(&dest), &value);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProvider>::UnprotectStreamAsync, *(void**)(&src), *(void**)(&dest), &value);
        return winrt::Windows::Foundation::IAsyncAction{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProviderFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Cryptography::DataProtection::IDataProtectionProviderFactory>::CreateOverloadExplicit, *(void**)(&protectionDescriptor), &value);
    ...
    {
        std::int32_t __stdcall ProtectAsync(void* data, void** value) noexcept final try
        {
            clear_abi(value);
        ...
        std::int32_t __stdcall UnprotectAsync(void* data, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ProtectStreamAsync(void* src, void* dest, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall UnprotectStreamAsync(void* src, void* dest, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall CreateOverloadExplicit(void* protectionDescriptor, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
