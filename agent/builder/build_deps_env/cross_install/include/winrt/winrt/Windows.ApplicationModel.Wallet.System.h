...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>::GetItemsAsync, &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>::DeleteAsync, *(void**)(&item), &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>::ImportItemAsync, *(void**)(&stream), &operation);
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Wallet_System_IWalletItemSystemStore<D>::GetAppStatusForItem(winrt::Windows::ApplicationModel::Wallet::WalletItem const& item) const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>::GetAppStatusForItem, *(void**)(&item), reinterpret_cast<std::int32_t*>(&result));
        return result;
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>::LaunchAppForItemAsync, *(void**)(&item), &operation);
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Wallet_System_IWalletItemSystemStore2<D>::ItemsChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::Wallet::System::WalletItemSystemStore, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore2>::add_ItemsChanged, *(void**)(&handler), put_abi(cookie));
        return cookie;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore2>::remove_ItemsChanged, impl::bind_in(cookie));
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Wallet::System::IWalletManagerSystemStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Wallet::System::IWalletManagerSystemStatics>::RequestStoreAsync, &operation);
    ...
    struct produce<D, winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore> : produce_base<D, winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore>
    {
        ...
        std::int32_t __stdcall DeleteAsync(void* item, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall GetAppStatusForItem(void* item, std::int32_t* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall LaunchAppForItemAsync(void* item, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
