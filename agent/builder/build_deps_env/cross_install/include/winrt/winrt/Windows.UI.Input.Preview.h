...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::UI::Input::Preview::IInputActivationListenerPreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Input::Preview::IInputActivationListenerPreviewStatics>::CreateForApplicationWindow, *(void**)(&window), &result);
    ...
    {
        std::int32_t __stdcall CreateForApplicationWindow(void* window, void** result) noexcept final try
        {
            clear_abi(result);
