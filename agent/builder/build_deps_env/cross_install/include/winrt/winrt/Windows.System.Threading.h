...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolStatics>::RunAsync, *(void**)(&handler), &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolStatics>::RunWithPriorityAsync, *(void**)(&handler), static_cast<std::int32_t>(priority), &operation);
        return winrt::Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolStatics>::RunWithPriorityAndOptionsAsync, *(void**)(&handler), static_cast<std::int32_t>(priority), static_cast<std::uint32_t>(options), &operation);
        return winrt::Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Threading_IThreadPoolTimer<D>::Period() const
    {
        winrt::Windows::Foundation::TimeSpan value{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimer>::get_Period, put_abi(value));
        return value;
    }
    template <typename D> auto consume_Windows_System_Threading_IThreadPoolTimer<D>::Delay() const
    {
        winrt::Windows::Foundation::TimeSpan value{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimer>::get_Delay, put_abi(value));
        return value;
    }
    template <typename D> auto consume_Windows_System_Threading_IThreadPoolTimer<D>::Cancel() const
    {
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimer>::Cancel);
    }
    ...
    {
        void* timer{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreatePeriodicTimer, *(void**)(&handler), impl::bind_in(period), &timer);
    ...
    {
        void* timer{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreateTimer, *(void**)(&handler), impl::bind_in(delay), &timer);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ timer, take_ownership_from_abi };
    }
    ...
    {
        void* timer{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreatePeriodicTimerWithCompletion, *(void**)(&handler), impl::bind_in(period), *(void**)(&destroyed), &timer);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ timer, take_ownership_from_abi };
    }
    ...
    {
        void* timer{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreateTimerWithCompletion, *(void**)(&handler), impl::bind_in(delay), *(void**)(&destroyed), &timer);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ timer, take_ownership_from_abi };
    }
    template <typename H> struct delegate<winrt::Windows::System::Threading::TimerDestroyedHandler, H> final : implements_delegate<winrt::Windows::System::Threading::TimerDestroyedHandler, H>
    {
        ...
        std::int32_t __stdcall Invoke(void* timer) noexcept final try
        {
    ...
    {
        std::int32_t __stdcall RunAsync(void* handler, void** operation) noexcept final try
        {
            clear_abi(operation);
        ...
        std::int32_t __stdcall RunWithPriorityAsync(void* handler, std::int32_t priority, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall RunWithPriorityAndOptionsAsync(void* handler, std::int32_t priority, std::uint32_t options, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall CreatePeriodicTimer(void* handler, std::int64_t period, void** timer) noexcept final try
        {
            clear_abi(timer);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall CreateTimer(void* handler, std::int64_t delay, void** timer) noexcept final try
        {
            clear_abi(timer);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall CreatePeriodicTimerWithCompletion(void* handler, std::int64_t period, void* destroyed, void** timer) noexcept final try
        {
            clear_abi(timer);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall CreateTimerWithCompletion(void* handler, std::int64_t delay, void* destroyed, void** timer) noexcept final try
        {
            clear_abi(timer);
            typename D::abi_guard guard(this->shim());
