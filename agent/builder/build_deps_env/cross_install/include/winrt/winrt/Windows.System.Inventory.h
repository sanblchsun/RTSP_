...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::System::Inventory::IInstalledDesktopApp, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Inventory::IInstalledDesktopApp>::get_Id, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Inventory_IInstalledDesktopApp<D>::DisplayName() const
    {
        void* value{};
        consume_general<winrt::Windows::System::Inventory::IInstalledDesktopApp, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Inventory::IInstalledDesktopApp>::get_DisplayName, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Inventory_IInstalledDesktopApp<D>::Publisher() const
    {
        void* value{};
        consume_general<winrt::Windows::System::Inventory::IInstalledDesktopApp, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Inventory::IInstalledDesktopApp>::get_Publisher, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Inventory_IInstalledDesktopApp<D>::DisplayVersion() const
    {
        void* value{};
        consume_general<winrt::Windows::System::Inventory::IInstalledDesktopApp, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Inventory::IInstalledDesktopApp>::get_DisplayVersion, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Inventory_IInstalledDesktopAppStatics<D>::GetInventoryAsync() const
    {
        void* operation{};
        consume_general<winrt::Windows::System::Inventory::IInstalledDesktopAppStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Inventory::IInstalledDesktopAppStatics>::GetInventoryAsync, &operation);
    ...
    {
        std::int32_t __stdcall GetInventoryAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
