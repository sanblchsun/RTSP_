...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Power::IBattery, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBattery>::get_DeviceId, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Devices_Power_IBattery<D>::GetReport() const
    {
        void* result{};
        consume_general<winrt::Windows::Devices::Power::IBattery, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBattery>::GetReport, &result);
    ...
    template <typename D> auto consume_Windows_Devices_Power_IBattery<D>::ReportUpdated(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Power::Battery, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        ...
        consume_general<winrt::Windows::Devices::Power::IBattery, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBattery>::add_ReportUpdated, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Power::IBatteryReport, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryReport>::get_ChargeRateInMilliwatts, &value);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Power::IBatteryReport, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryReport>::get_DesignCapacityInMilliwattHours, &value);
        return winrt::Windows::Foundation::IReference<std::int32_t>{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Devices_Power_IBatteryReport<D>::FullChargeCapacityInMilliwattHours() const
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Power::IBatteryReport, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryReport>::get_FullChargeCapacityInMilliwattHours, &value);
        return winrt::Windows::Foundation::IReference<std::int32_t>{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Devices_Power_IBatteryReport<D>::RemainingCapacityInMilliwattHours() const
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Power::IBatteryReport, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryReport>::get_RemainingCapacityInMilliwattHours, &value);
        return winrt::Windows::Foundation::IReference<std::int32_t>{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Devices_Power_IBatteryReport<D>::Status() const
    {
        ...
        consume_general<winrt::Windows::Devices::Power::IBatteryReport, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryReport>::get_Status, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    template <typename D> auto consume_Windows_Devices_Power_IBatteryStatics<D>::AggregateBattery() const
    {
        void* result{};
        consume_general<winrt::Windows::Devices::Power::IBatteryStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryStatics>::get_AggregateBattery, &result);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Devices::Power::IBatteryStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryStatics>::FromIdAsync, *(void**)(&deviceId), &result);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Devices::Power::IBatteryStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Power::IBatteryStatics>::GetDeviceSelector, &result);
    ...
    struct produce<D, winrt::Windows::Devices::Power::IBattery> : produce_base<D, winrt::Windows::Devices::Power::IBattery>
    {
        ...
        std::int32_t __stdcall GetReport(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall add_ReportUpdated(void* handler, winrt::event_token* token) noexcept final try
        {
    ...
    {
        std::int32_t __stdcall get_ChargeRateInMilliwatts(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Foundation::IReference<std::int32_t>>(this->shim().ChargeRateInMilliwatts());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall get_DesignCapacityInMilliwattHours(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Foundation::IReference<std::int32_t>>(this->shim().DesignCapacityInMilliwattHours());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall get_FullChargeCapacityInMilliwattHours(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Foundation::IReference<std::int32_t>>(this->shim().FullChargeCapacityInMilliwattHours());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall get_RemainingCapacityInMilliwattHours(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Foundation::IReference<std::int32_t>>(this->shim().RemainingCapacityInMilliwattHours());
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        std::int32_t __stdcall get_AggregateBattery(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
