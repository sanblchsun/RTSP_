...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* action{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics>::AddLicenseAsync, *(void**)(&license), &action);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics>::GetSatisfactionInfosAsync, *(void**)(&contentIds), *(void**)(&keyIds), &operation);
    ...
    {
        void* action{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseManagerStatics2>::RefreshLicensesAsync, static_cast<std::int32_t>(refreshOption), &action);
        return winrt::Windows::Foundation::IAsyncAction{ action, take_ownership_from_abi };
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_SatisfiedByDevice, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_SatisfiedByOpenLicense, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_SatisfiedByTrial, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_SatisfiedByPass, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_SatisfiedByInstallMedia, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_SatisfiedBySignedInUser, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionInfo>::get_IsSatisfied, &value);
        return value;
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult>::get_LicenseSatisfactionInfos, &value);
    ...
    {
        winrt::hresult value{};
        consume_general<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Store::LicenseManagement::ILicenseSatisfactionResult>::get_ExtendedError, put_abi(value));
        return value;
    }
    ...
    {
        std::int32_t __stdcall AddLicenseAsync(void* license, void** action) noexcept final try
        {
            clear_abi(action);
        ...
        std::int32_t __stdcall GetSatisfactionInfosAsync(void* contentIds, void* keyIds, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall RefreshLicensesAsync(std::int32_t refreshOption, void** action) noexcept final try
        {
            clear_abi(action);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_SatisfiedByDevice(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_SatisfiedByOpenLicense(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_SatisfiedByTrial(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_SatisfiedByPass(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_SatisfiedByInstallMedia(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_SatisfiedBySignedInUser(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_IsSatisfied(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_LicenseSatisfactionInfos(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
