...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs>::get_Handled, &value);
        return value;
    }
    template <typename D> auto consume_Windows_Phone_UI_Input_IBackPressedEventArgs<D>::Handled(bool value) const
    {
        consume_general<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs>::put_Handled, value);
    }
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics<D>::BackPressed(winrt::Windows::Foundation::EventHandler<winrt::Windows::Phone::UI::Input::BackPressedEventArgs> const& handler) const
    {
        ...
        consume_general<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>::add_BackPressed, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>::remove_BackPressed, impl::bind_in(token));
    }
    ...
    {
        winrt::event_token token{};
        consume_general<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>::add_CameraHalfPressed, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>::remove_CameraHalfPressed, impl::bind_in(token));
    }
    ...
    {
        winrt::event_token token{};
        consume_general<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>::add_CameraPressed, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>::remove_CameraPressed, impl::bind_in(token));
    }
    ...
    {
        winrt::event_token token{};
        consume_general<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>::add_CameraReleased, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>::remove_CameraReleased, impl::bind_in(token));
    }
    ...
    {
        std::int32_t __stdcall add_BackPressed(void* handler, winrt::event_token* token) noexcept final try
        {
        ...
        std::int32_t __stdcall remove_BackPressed(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall add_CameraHalfPressed(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall remove_CameraHalfPressed(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            this->shim().CameraHalfPressed(*reinterpret_cast<winrt::event_token const*>(&token));
            return 0;
        }
        std::int32_t __stdcall add_CameraPressed(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall remove_CameraPressed(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            this->shim().CameraPressed(*reinterpret_cast<winrt::event_token const*>(&token));
            return 0;
        }
        std::int32_t __stdcall add_CameraReleased(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall remove_CameraReleased(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
