...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs>::get_Frame, &value);
    ...
    template <typename D> auto consume_Windows_Media_Capture_Core_IVariablePhotoCapturedEventArgs<D>::CaptureTimeOffset() const
    {
        ...
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs>::get_CaptureTimeOffset, put_abi(value));
        return value;
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs>::get_UsedFrameControllerIndex, &value);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs>::get_CapturedFrameControlValues, &value);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture>::StartAsync, &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture>::StopAsync, &operation);
        return winrt::Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Media_Capture_Core_IVariablePhotoSequenceCapture<D>::FinishAsync() const
    {
        void* operation{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture>::FinishAsync, &operation);
        return winrt::Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Media_Capture_Core_IVariablePhotoSequenceCapture<D>::PhotoCaptured(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Capture::Core::VariablePhotoSequenceCapture, winrt::Windows::Media::Capture::Core::VariablePhotoCapturedEventArgs> const& handler) const
    {
        ...
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture>::add_PhotoCaptured, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        winrt::event_token token{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture>::add_Stopped, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture2>::UpdateSettingsAsync, &operation);
        return winrt::Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs> : produce_base<D, winrt::Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs>
    {
        ...
        std::int32_t __stdcall get_UsedFrameControllerIndex(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Foundation::IReference<std::uint32_t>>(this->shim().UsedFrameControllerIndex());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall get_CapturedFrameControlValues(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall UpdateSettingsAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
