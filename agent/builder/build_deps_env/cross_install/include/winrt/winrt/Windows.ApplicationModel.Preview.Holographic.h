...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool result{};
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics>::IsCurrentViewPresentedOnHolographicDisplay, &result);
        return result;
    }
    ...
    {
        bool result{};
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics>::IsHolographicActivation, *(void**)(&activatedEventArgs), &result);
        return result;
    }
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview>::SetPlacementOverride, *(void**)(&coordinateSystem), impl::bind_in(topCenterPosition), impl::bind_in(normal));
    }
    template <typename D> auto consume_Windows_ApplicationModel_Preview_Holographic_IHolographicKeyboardPlacementOverridePreview<D>::SetPlacementOverride(winrt::Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem, winrt::Windows::Foundation::Numerics::float3 const& topCenterPosition, winrt::Windows::Foundation::Numerics::float3 const& normal, winrt::Windows::Foundation::Numerics::float2 const& maxSize) const
    {
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview>::SetPlacementOverrideWithMaxSize, *(void**)(&coordinateSystem), impl::bind_in(topCenterPosition), impl::bind_in(normal), impl::bind_in(maxSize));
    }
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview>::ResetPlacementOverride);
    }
    ...
    {
        void* result{};
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreviewStatics>::GetForCurrentView, &result);
    ...
    {
        std::int32_t __stdcall IsCurrentViewPresentedOnHolographicDisplay(bool* result) noexcept final try
        {
        ...
        std::int32_t __stdcall IsHolographicActivation(void* activatedEventArgs, bool* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall SetPlacementOverride(void* coordinateSystem, winrt::Windows::Foundation::Numerics::float3 topCenterPosition, winrt::Windows::Foundation::Numerics::float3 normal) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall SetPlacementOverrideWithMaxSize(void* coordinateSystem, winrt::Windows::Foundation::Numerics::float3 topCenterPosition, winrt::Windows::Foundation::Numerics::float3 normal, winrt::Windows::Foundation::Numerics::float2 maxSize) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ResetPlacementOverride() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
