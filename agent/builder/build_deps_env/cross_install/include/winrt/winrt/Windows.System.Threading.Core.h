...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItem, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItem>::RunAsync, &operation);
    ...
    {
        void* workItem{};
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory>::CreateWorkItem, *(void**)(&handler), &workItem);
    ...
    {
        void* WorkItem{};
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory>::CreateWorkItemWithPriority, *(void**)(&handler), static_cast<std::int32_t>(priority), &WorkItem);
        return winrt::Windows::System::Threading::Core::PreallocatedWorkItem{ WorkItem, take_ownership_from_abi };
    }
    ...
    {
        void* WorkItem{};
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory>::CreateWorkItemWithPriorityAndOptions, *(void**)(&handler), static_cast<std::int32_t>(priority), static_cast<std::uint32_t>(options), &WorkItem);
        return winrt::Windows::System::Threading::Core::PreallocatedWorkItem{ WorkItem, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Threading_Core_ISignalNotifier<D>::Enable() const
    {
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifier, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifier>::Enable);
    }
    template <typename D> auto consume_Windows_System_Threading_Core_ISignalNotifier<D>::Terminate() const
    {
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifier, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifier>::Terminate);
    }
    ...
    {
        void* signalNotifier{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToEvent, *(void**)(&name), *(void**)(&handler), &signalNotifier);
    ...
    {
        void* signalNotifier{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToEventWithTimeout, *(void**)(&name), *(void**)(&handler), impl::bind_in(timeout), &signalNotifier);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToSemaphore, *(void**)(&name), *(void**)(&handler), &signalNotifier);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToSemaphoreWithTimeout, *(void**)(&name), *(void**)(&handler), impl::bind_in(timeout), &signalNotifier);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ signalNotifier, take_ownership_from_abi };
    }
    template <typename H> struct delegate<winrt::Windows::System::Threading::Core::SignalHandler, H> final : implements_delegate<winrt::Windows::System::Threading::Core::SignalHandler, H>
    {
        ...
        std::int32_t __stdcall Invoke(void* signalNotifier, bool timedOut) noexcept final try
        {
    ...
    {
        std::int32_t __stdcall RunAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
    ...
    {
        std::int32_t __stdcall CreateWorkItem(void* handler, void** workItem) noexcept final try
        {
            clear_abi(workItem);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall CreateWorkItemWithPriority(void* handler, std::int32_t priority, void** WorkItem) noexcept final try
        {
            clear_abi(WorkItem);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall CreateWorkItemWithPriorityAndOptions(void* handler, std::int32_t priority, std::uint32_t options, void** WorkItem) noexcept final try
        {
            clear_abi(WorkItem);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall AttachToEvent(void* name, void* handler, void** signalNotifier) noexcept final try
        {
        ...
        std::int32_t __stdcall AttachToEventWithTimeout(void* name, void* handler, std::int64_t timeout, void** signalNotifier) noexcept final try
        {
            clear_abi(signalNotifier);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall AttachToSemaphore(void* name, void* handler, void** signalNotifier) noexcept final try
        {
            clear_abi(signalNotifier);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall AttachToSemaphoreWithTimeout(void* name, void* handler, std::int64_t timeout, void** signalNotifier) noexcept final try
        {
            clear_abi(signalNotifier);
            typename D::abi_guard guard(this->shim());
