...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics>::AssociateNetworkAccountAsync, *(void**)(&store), *(void**)(&networkName), *(void**)(&networkAccountId), &result);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics>::ImportVcardToSystemAsync, *(void**)(&stream), &result);
        return winrt::Windows::Foundation::IAsyncAction{ result, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::PersonalInformation::Provisioning::IContactPartnerProvisioningManagerStatics2>::AssociateSocialNetworkAccountAsync, *(void**)(&store), *(void**)(&networkName), *(void**)(&networkAccountId), &result);
        return winrt::Windows::Foundation::IAsyncAction{ result, take_ownership_from_abi };
    }
    ...
    {
        void* action{};
        consume_general<winrt::Windows::Phone::PersonalInformation::Provisioning::IMessagePartnerProvisioningManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::PersonalInformation::Provisioning::IMessagePartnerProvisioningManagerStatics>::ImportSmsToSystemAsync, incoming, read, *(void**)(&body), *(void**)(&sender), *(void**)(&recipients), impl::bind_in(deliveryTime), &action);
    ...
    {
        void* action{};
        consume_general<winrt::Windows::Phone::PersonalInformation::Provisioning::IMessagePartnerProvisioningManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Phone::PersonalInformation::Provisioning::IMessagePartnerProvisioningManagerStatics>::ImportMmsToSystemAsync, incoming, read, *(void**)(&subject), *(void**)(&sender), *(void**)(&recipients), impl::bind_in(deliveryTime), *(void**)(&attachments), &action);
        return winrt::Windows::Foundation::IAsyncAction{ action, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall AssociateNetworkAccountAsync(void* store, void* networkName, void* networkAccountId, void** result) noexcept final try
        {
            clear_abi(result);
        ...
        std::int32_t __stdcall ImportVcardToSystemAsync(void* stream, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall AssociateSocialNetworkAccountAsync(void* store, void* networkName, void* networkAccountId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall ImportSmsToSystemAsync(bool incoming, bool read, void* body, void* sender, void* recipients, std::int64_t deliveryTime, void** action) noexcept final try
        {
            clear_abi(action);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ImportMmsToSystemAsync(bool incoming, bool read, void* subject, void* sender, void* recipients, std::int64_t deliveryTime, void* attachments, void** action) noexcept final try
        {
            clear_abi(action);
            typename D::abi_guard guard(this->shim());
