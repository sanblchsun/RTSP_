...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::Hide, *(void**)(&subtree));
    }
    ...
    {
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::ShowMemoryUsage, *(void**)(&subtree));
    }
    ...
    {
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::ShowOverdraw, *(void**)(&subtree), static_cast<std::uint32_t>(contentKinds));
    }
    ...
    {
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::ShowRedraw, *(void**)(&subtree));
    }
    template <typename D> auto consume_Windows_UI_Composition_Diagnostics_ICompositionDebugSettings<D>::HeatMaps() const
    {
        void* value{};
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettings>::get_HeatMaps, &value);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>::TryGetSettings, *(void**)(&compositor), &result);
    ...
    {
        std::int32_t __stdcall Hide(void* subtree) noexcept final try
        {
        ...
        std::int32_t __stdcall ShowMemoryUsage(void* subtree) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ShowOverdraw(void* subtree, std::uint32_t contentKinds) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ShowRedraw(void* subtree) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_HeatMaps(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall TryGetSettings(void* compositor, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
