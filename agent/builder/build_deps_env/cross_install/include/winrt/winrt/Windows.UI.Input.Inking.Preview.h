...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics>::CreateForVisual, *(void**)(&inputPanelVisual), impl::bind_in(inputPanelRect), &result);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics>::CreateForVisualWithViewportClip, *(void**)(&inputPanelVisual), impl::bind_in(inputPanelRect), *(void**)(&viewportVisual), impl::bind_in(viewportRect), &result);
        return winrt::Windows::UI::Input::Inking::Preview::PalmRejectionDelayZonePreview{ result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall CreateForVisual(void* inputPanelVisual, winrt::Windows::Foundation::Rect inputPanelRect, void** result) noexcept final try
        {
            clear_abi(result);
        ...
        std::int32_t __stdcall CreateForVisualWithViewportClip(void* inputPanelVisual, winrt::Windows::Foundation::Rect inputPanelRect, void* viewportVisual, winrt::Windows::Foundation::Rect viewportRect, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
