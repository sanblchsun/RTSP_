...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionRevokedEventArgs<D>::Reason() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionRevokedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionRevokedEventArgs>::get_Reason, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    template <typename D> auto consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionSession<D>::Reason() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::get_Reason, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::put_Reason, static_cast<std::int32_t>(value));
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::get_Description, &value);
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::put_Description, *(void**)(&value));
    }
    ...
    {
        std::uint32_t value{};
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::get_PercentProgress, &value);
        return value;
    }
    template <typename D> auto consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionSession<D>::PercentProgress(std::uint32_t value) const
    {
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::put_PercentProgress, value);
    }
    template <typename D> auto consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionSession<D>::Revoked(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Foundation::IInspectable, winrt::Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionRevokedEventArgs> const& handler) const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::add_Revoked, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::remove_Revoked, impl::bind_in(token));
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>::RequestExtensionAsync, &operation);
    ...
    struct produce<D, winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession> : produce_base<D, winrt::Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>
    {
        ...
        std::int32_t __stdcall put_Reason(std::int32_t value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_PercentProgress(std::uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<std::uint32_t>(this->shim().PercentProgress());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall put_PercentProgress(std::uint32_t value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall add_Revoked(void* handler, winrt::event_token* token) noexcept final try
        {
        ...
        std::int32_t __stdcall remove_Revoked(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            this->shim().Revoked(*reinterpret_cast<winrt::event_token const*>(&token));
            return 0;
        }
        std::int32_t __stdcall RequestExtensionAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
