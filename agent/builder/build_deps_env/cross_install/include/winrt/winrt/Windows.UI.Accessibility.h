...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderPositionChangedEventArgs<D>::ScreenPositionInRawPixels() const
    {
        ...
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs>::get_ScreenPositionInRawPixels, put_abi(value));
        return value;
    }
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderPositionChangedEventArgs<D>::IsReadingText() const
    {
        bool value{};
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs>::get_IsReadingText, &value);
        return value;
    }
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderService<D>::CurrentScreenReaderPosition() const
    {
        void* value{};
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderService, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderService>::get_CurrentScreenReaderPosition, &value);
    ...
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderService<D>::ScreenReaderPositionChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Accessibility::ScreenReaderService, winrt::Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs> const& handler) const
    {
        ...
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderService, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderService>::add_ScreenReaderPositionChanged, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::UI::Accessibility::IScreenReaderService, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderService>::remove_ScreenReaderPositionChanged, impl::bind_in(token));
    }
    ...
    {
        std::int32_t __stdcall get_ScreenPositionInRawPixels(winrt::Windows::Foundation::Rect* value) noexcept final try
        {
        ...
        std::int32_t __stdcall get_IsReadingText(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_CurrentScreenReaderPosition(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall add_ScreenReaderPositionChanged(void* handler, winrt::event_token* token) noexcept final try
        {
        ...
        std::int32_t __stdcall remove_ScreenReaderPositionChanged(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
